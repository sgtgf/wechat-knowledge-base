...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_000_851fc14eb8bc.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_001_d5ab44ca6425.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_002_f40441721133.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_003_16e149435de1.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_004_b022c7db096c.png)

由图4(a)中电路原理图可知，电场耦合传感器可等效为一阶RC电路，其传递函数为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_005_663285cc71fe.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_006_ee0090a26042.png)

当转折频率较大，即(Cm+Cs)Rms<1，且被测电压频率上限小于ωh时，式(4)中的传递函数可表示为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_007_5739df00d67b.png)

此种状态传感器工作在微分模式。

当转折频率较小，即(Cm+Cs)Rms 》1，且被测电压频率下限大于ωh时，式(4)中的传递函数可表示为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_008_9cd241d8319d.png)

此时，传感器不需外加积分器即可实现被测电压信号的成比例输出，称为自积分模式。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_009_2705187da2f2.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_010_7d4d746a1443.png)

混合积分电路原理图如图6所示，由自积分模式下的自积分电路和正相有源积分电路构成，高通滤波器滤除运算放大器引入的偏置电压。其中，有源积分电路传递函数为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_011_b5c0ceaff20b.png)

高通滤波器传递函数为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_012_29a04f3cd332.png)

自积分电路的传递函数由式(4)给出。混合积分电路的各部分频率特性曲线如图7所示，为保证混合积分电路的正常工作，各部分转折频率应相互对应，即：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_013_3e795b07b52f.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_014_f82d279170ee.png)

1）0≤ω<ωm1时的频率特性。

当被测电压信号的频率小于转折频率ωm1，即RfCfs\=RhChs<<1时，自积分电路工作在微分环节，其传递函数由式(6)给出。有源积分电路工作在比例环节，式(8)中传递函数可化简为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_015_042ede527af9.png)

此时高通滤波器呈微分特性，其传递函数可化简为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_016_2c079f2086ee.png)

自积分电路、有源积分电路和高通滤波电路通过级联的方式共同作用，则根据式(6)、(12)、(13)，电场耦合电压传感器的传递函数为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_017_9c272c2adb69.png)

将式(10)、(11)中的转折频率等效关系代入式(14)中，电场耦合电压传感器的传递函数可化简为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_018_17b3f75e3db8.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_019_6200130089e5.png)

此时高通滤波器工作在比例环节，且比例系数为1，所以根据式(6)和(16)，得出电场耦合电压传感器的传递函数为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_020_b85aeea59255.png)

将式(11)中转折频率之间的等效关系代入到式(17)中可化简得：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_021_942e774a4be7.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_022_98ea9171b99d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_023_83b56580732e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_024_a16c5e33fe5f.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_025_b1840b01fd64.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_026_9bfcfa41ea29.png)

3.2传感器电路拓扑参数设计

本实验中处理电路参数以传感器的灵敏度0.005，处理电路带宽下限小于1Hz，带宽上限充分利用传感器的自然频带为目的来设计。原理图如图6所示，其中运算放大器型号为ADA4817，带宽1050MHz，偏置电流2pA，常用供电±5V。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_027_a56023e64072.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_028_c69fa302daa2.png)

根据以上公式分析可得混合积分器中各元件参数，如表2所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_029_1eedcb7c39b7.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_030_7b01abb7f868.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_031_e1adef39a2c4.png)

由图13可知，电场耦合电压传感器的输入电容计算公式为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_032_cd9087c8ab14.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_033_607ebc7a224a.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_034_793ae8442c9a.png)

经过上文分析，电场耦合电压传感器对直流信号不敏感，测量低频信号时误差大，因此在测量脉宽较长的脉冲信号时，低频测量的不准确性会造成波形的下垂。根据式(4)、(8)—(11)，电场耦合电压传感器的传递函数可化简为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_035_c615a04ea56f.png)

经拉普拉斯反变换，其时域下的阶跃响应为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_036_6771ff4d658f.png)

将表2中给出的参数值，代入式(24)中，则传感器阶跃响应曲线如图17所示。由图可知，在200μs内，电场耦合电压传感器下垂程度小于0.12%。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_037_f57abad351b6.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_038_72bcefd1f4c7.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_039_80acae3f6714.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_040_78a753accf37.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_041_2518a5dcd898.png)

在上文分析中提到，电场耦合电压传感器对直流信号不敏感，容易出现下垂效应，故图22中采用多脉冲实验进行验证，脉冲宽度为20μs。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_042_d7a77cf8570d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_043_b74321583432.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_044_318ead5d55de.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信：18126115420，并备注单位+姓名+研发方向。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_045_3ade3c3d8599.jpg)![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\用于_SiC_MOSFET_开关电压测量的非接触式电场耦合电压传感器_images\img_046_84aa944feb13.jpg)