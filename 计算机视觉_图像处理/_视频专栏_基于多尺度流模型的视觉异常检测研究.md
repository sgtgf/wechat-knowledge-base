# 【视频专栏】基于多尺度流模型的视觉异常检测研究

原创 自动化学报 自动化学报 2024-11-21 17:10 北京

> 原文地址: [https://mp.weixin.qq.com/s/vi\_g099z2q0EoBDvIXF2JQ](https://mp.weixin.qq.com/s/vi_g099z2q0EoBDvIXF2JQ)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_000_f76a7fe84cb4.png)

点击上方**蓝字**关注我们

  

毛国君, 吴星臻, 邢树礼. [基于多尺度流模型的视觉异常检测研究](http://www.aas.net.cn/cn/article/doi/10.16383/j.aas.c230476). 自动化学报, 2024, 50(3): 640−648
...
      异常检测(Anomaly detection, AD)是计算机视觉中的一个热门研究领域\[1\]. 异常检测算法已经在诸多场景中得到应用, 如工业异常检测\[2\]、医学图像检查\[3\]、道路交通监测\[4\]和安全检测\[5\]等. 有监督的异常检测工作通常需要标注大量的正常数据和异常数据\[6\]. 但在实际应用中, 异常数据的产生概率通常较低, 这导致有监督方法在实际应用中难以高效地实施. 相比较, 无监督异常检测方法效率更高, 近年得到更多的关注.
...
本文的其余部分安排如下: 第1节介绍相关工作; 第2节介绍本文模型及其主要功能部件; 第3节完成实验及结果分析; 第4节对本文工作进行总结.
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_002_51820040135e.svg)
...
**毛国君**，福建理工大学计算机科学与数学学院教授. 主要研究方向为人工智能, 大数据, 数据挖掘和分布式计算. 本文通信作者.

  

**吴星臻**，福建理工大学计算机科学与数学学院硕士研究生. 主要研究方向为计算机视觉, 图像处理和异常检测.

  

**邢树礼**，福建理工大学计算机科学与数学学院讲师. 主要研究方向为计算机视觉, 图像处理和大数据分析.

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_001_51820040135e.svg)
...
[![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_003_1bb52a8adeef.jpg)](http://www.aas.net.cn/)

[![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_004_8059e67d1866.jpg)](http://www.ieee-jas.net/)

  

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_005_409e145c41f9.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_009_409e145c41f9.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_007_e7e64a650744.jpg)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_006_409e145c41f9.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_008_409e145c41f9.gif)

**长按二维码｜关注我们**

**IEEE/CAA Journal of Automatica Sinica (JAS)**

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_011_409e145c41f9.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_010_409e145c41f9.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_012_d1e21947407a.jpg)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_014_409e145c41f9.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_基于多尺度流模型的视觉异常检测研究_images\img_013_409e145c41f9.gif)
