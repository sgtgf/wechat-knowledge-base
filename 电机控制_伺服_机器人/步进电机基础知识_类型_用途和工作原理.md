...
> 原文地址: [https://mp.weixin.qq.com/s/wHV7HePc1UHwuAGyKhR6iQ](https://mp.weixin.qq.com/s/wHV7HePc1UHwuAGyKhR6iQ)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAyfEVOKwibgd74PBxR3giapVx6DHv1QTce5djqHFuBqHTGaYa5UVuePWibg/640?wx_fmt=png&from=appmsg&wxfrom=13&tp=wxpic)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAyt3T0wSWQqEJ1paqLvq0RcWicic6wY2WjwPgowkiboNNLFAVue5FDATI6w/640?wx_fmt=png&from=appmsg&wxfrom=13&wx_lazy=1&tp=wxpic)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAytdpq28ypZ31xiaYHhFGIgibCpibnEuBV6vff3RrE4VQvkHS7945WCX0bg/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAyJVP8IGOIVQicEP6VE6Xk7aiaQuQ5Ds3icakWAB0I5ADDPfkNxn4U8bWsQ/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAyKwrf4L5rdDcPChKtIQfoDS1yGtugHe4xsjcxCxBvic4xRpjEjD6Iaug/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic)

图5: 两相定子绕组（左）和三相定子绕组（右）

![图片](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAyBwwVpwfz6yzCeO9tXQtkibfcXMPBoDyBnnlGSGnicibibkb2Q6suMkYPYg/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAymxK70CgCmKaPAgArlibB8LaCWltdWmvvDsaSaOjU2yib0pQzEGXqFbtg/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic)
...
![Direction of the magnetic field based on the direction of the coil current](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAy9icutRVFKibjcgxOAe97m1pF3Cn6ZCH6D6aq4hfgcPvicy0W3kHZtldxg/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic "根据线圈电流方向控制磁场方向")
...
![Unipolar Stepper Motor driving circuit](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAyRX3RMGzShiaVibWAHJ6RveiaR4Z95AVp41ibxgz92sIsIV1PfBULjFG5OA/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic "Unipolar Stepper Motor driving circuit")
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAy2m3bNBeQXamcS8S0iaDIGApibtXibtdgOWRy0TsbTZvu68KwzRoqPKzlg/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAy4Pkz9fUQzf2txhtAP54zgQgZvAC80RXtEgS9KnV9xwIPveicL4vMu3w/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic)

图11: 波动模式步进

-   全步模式：两相始终同时通电。图12显示了该驱动模式的步进步骤。其步骤与波动模式类似，最大的区别在于，全步模式下，由于电机中流动的电流更多，产生的磁场也更强，因此扭矩也更大。

![图片](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAyIrU9QibfuCZlgSkCjLLcxAibQNzWguDOEbIItClQ8SRx7uqmLticR3XtA/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic)

图12: 全步模式步进

-   半步模式是波动模式和全步模式的组合（请参见图12）。这种模式可以将步距减小一倍（旋转45°，而不是90°）。其唯一的缺点是电机产生的扭矩不是恒定的，当两相都通电时扭矩较高，只有一相通电时扭矩较小。

![图片](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAyX883ubHSNXicmpKfnkc3C5vK6mN4cMxdObJyHaibxyrl8X90OSynjrew/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic)
...
![图片](https://mmbiz.qpic.cn/mmbiz_png/xML2GYBfTflJrFCj8trwyEwQEyqzThAyT1SE5Jia8KVd2JPia0Yj6YgTJJhsX4KNIGibLQ1OF5kmIOmVslk9JyibcQ/640?wx_fmt=png&from=appmsg&wxfrom=5&wx_lazy=1&tp=wxpic)
