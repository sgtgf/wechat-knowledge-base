...
![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_000_963021f778e2.jpg)
...
![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_001_3f95e26f77d7.png)
...
![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_002_79e88004b5ed.png)
...
![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_003_a91933398148.png)

  

表2 与其他文献算法平均偏差率(%)比较

![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_004_6ba5e3bdaa94.png)
...
![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_005_f3ea8ea712f2.png)

**作者简介**

![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_006_f3ea8ea712f2.png)

![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_007_2bf53cc07349.jpg)

项前，东华大学机械工程学院副教授.主要研究方向为计算机集成制造系统,计算智能.

E-mail: xqsir@dhu.edu.cn

![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_008_7fc0a4b8be64.jpg)

周亚云，东华大学机械工程学院硕士研究生.主要研究方向为计算机集成制造系统.本文通信作者.

E-mail: zhouyayun@mail.dhu.edu.cn

![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_009_069f5d2990f4.jpg)
...
![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_010_38f1bd095a08.png)

![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_011_f4fbb41a6d27.jpg)

JAS《自动化学报》（英文版）

![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_012_38f1bd095a08.png)

![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_013_f4186a1518ff.jpg)

自动化学报服务号

![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_014_38f1bd095a08.png)

![](资源约束项目的改进差分进化参数控制及双向调度算法_images/img_015_1fca1081689e.jpg)
