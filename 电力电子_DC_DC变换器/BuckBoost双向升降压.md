...
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_000_6b3264ce5c5b.png)
...
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_001_d001214f8cfa.png)  
反馈点电压是0.9V，所以根据分压选择合适的电阻  
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_002_1fed77194edd.png)  
电流检测电阻RCS放在输入端或输出端，高进RISET ，如果不需要输入输出电流限制，CSN短接到VCC，CSP短接到GND  
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_003_fd7ebda47ca2.png)  
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_004_88129de03fad.png)

次级输出电流限制引脚OLIM  
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_005_fdef34454e3f.png)  
...
封装：  
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_006_878ab9e4fc7d.png)  
静电防护范围:  
...
给出了导通电阻  
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_007_88ff90906bb1.png)  
反馈点的电压为0.9V，范围在0.885-0.915V之间

有输入电流限制保护：

![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_008_700cc6d65955.png)

温度超过150度会停止工作，低于130度会重新恢复

![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_009_bb6c859e3238.png)

BST引脚接的这几个自举电容，原理上应该先想办法给电容充电，这样MOS管导通后，MOS管S脚电位抬高后，电容可以仍然给MOS管的G脚开启电压

原理是相同的，这在后面自己设计一个BuckBoost 控制系统 有借鉴作用：  
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_010_e872ea01bec9.png)

## PCB布线

1.  将输入去耦电容放置在尽可能靠近JW 3651（VIN引脚和PGND）的地方，以消除输入引脚处的噪声。输入电容和GND形成的环路面积必须最小化  
    ![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_011_e03314ac53c7.png)
    
2.  将电流检测电阻RCS尽可能靠近电流设置电阻RISET，以获得更好的电流精度，这个走线就是开尔文走线，由于采样电阻的阻值很小，焊料的电阻不能被忽略。开尔文走线可以提高测量精度。  
    ![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_012_15c4a0e4e982.png)
...
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_013_c17c297df950.png)  
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_014_a310a2812ecb.png)

![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_015_aeb174d264cd.png)

## 热阻的介绍

热阻，英文Thermal Resistance，指的是当有热量在物体上传输时，在物体两端温度差与热源的功率之间的比值，单位是℃/W或者是K/W。

![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_016_5dd748bf988e.png)  
...
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_017_3bd9ff840281.png)  
...
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_018_5735eeb47731.png)  
热设计和EMC问题一样，最好在前期就解决掉，不然后期整改很麻烦。设计前期考虑结构、PCB堆叠、布局、摆件等，后期考虑散热材料等方式，所以  
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_019_91545e199bf3.png)

## 原理图和 PCB设计

![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_020_0832b14a4390.png)  
![在这里插入图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_021_0486542e0906.png)

## 焊接测试

![请添加图片描述](D:\电脑文件\公众号知识库\电力电子_DC_DC变换器\BuckBoost双向升降压_images\img_022_a974d0980829.jpg)
