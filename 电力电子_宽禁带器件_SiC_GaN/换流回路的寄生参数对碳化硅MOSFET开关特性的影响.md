...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_000_e269b28c788d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_001_9ba20e9b2370.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_002_4bf90b1816cd.png)

1）电流过冲

碳化硅MOSFET开通过程中的电流过冲是由于电流上升阶段中，换流回路寄生电感引起的电压降落ΔuDS在换流回路负载电感的寄生电容CP产生了充电电流，该充电电流流过碳化硅MOSFET，导致其开通过程中出现一个较大的电流过冲，即

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_003_4bdf65c102b6.png)

式中uL为负载电感两端的电压。此阶段近似有

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_004_ca180c00ef19.png)

故式(1)的电流过冲可进一步表示为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_005_21539b1983f9.png)

考虑到碳化硅MOSFET寄生电容的非线性特性，式(3)中的CGD应取t2时刻对应uDS下的电容值。同时式中的UGP可表示为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_006_5f04445c8f7d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_007_47a22e72e6d9.png)

由图4计算开通电流谐振频率为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_008_039f43f6e071.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_009_dfbf77fce9d1.png)

式中的iCP可表示为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_010_0d89cc729957.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_011_88c6f625df45.png)

图5中COFF由下式可得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_012_d63ceb64309f.png)

图5所示的等效电路由4个独立储能元件组成，谐振频率有3个。其回路总电抗为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_013_c6dc8acf4e43.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_014_af42075f8c0f.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_015_cb8c7cdc555f.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_016_c05d4c6839c5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_017_0c7fc7ab8c06.png)

由图7(a)、图8(a)可得，LSBD和LSER对碳化硅MOSFET开通电流过冲几乎无影响，与式(3)相符。事实上，换流回路串联寄生电感LSER增大会使得电流的上升速率减小，但由于电流过冲阶段的持续时间为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_018_622e04f55a28.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_019_91670169bac1.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_020_e87bc6042f9d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_021_6072fcf01659.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_022_d534ba3c67d5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_023_8d577cd9f1c1.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_024_430bcf0fe652.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_025_e96df602c2d0.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_026_bb1fe5f29820.png)

由图15可得，开通电流的振荡频率随LSER的增大而减小，但几乎不受LSBD的影响。与式(5)的分析结果一致。关断电压的振荡频率随LSER或LSBD的增大均减小，对应式(16)中串联谐振的情况。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_027_ad700783dadc.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_028_2e17755765cf.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_029_bc01acdaaa5f.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_030_318ead5d55de.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信：18126115420，并备注单位+姓名+研发方向。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_031_3ade3c3d8599.jpg)![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\换流回路的寄生参数对碳化硅MOSFET开关特性的影响_images\img_032_84aa944feb13.jpg)