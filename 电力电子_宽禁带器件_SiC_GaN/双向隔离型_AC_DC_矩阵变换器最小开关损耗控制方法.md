...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_000_640358736546.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_001_5cd4d3532eef.png)

根据图 2，各变量的关系为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_002_6690cc26db82.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_003_00eacd129aaa.png)

图中，ϕ1 和ϕ4 分别为前级电路第一段和第二段移相角，ϕ2 和ϕ5 分别为后级第一段和 第二段移相角，ϕ3 为前后级间移相角。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_004_a6b95ad4736a.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_005_f71df85db7f0.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_006_a2794017d8f1.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_007_b1d9c58345f3.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_008_8e90572195bf.png)

为了方便计算，引入辅助函数 x(t)和 y(t)，表达式如式（2）、式（3）所示，利用等效分解的方式表示 uf、ug 和电感电流大小。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_009_ec118a96b107.png)

首先，将电压uf、ug 进行分解，如图 7b 和图7c 所示，其关系为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_010_41527c2152a9.png)

结合式（1），利用叠加原理将各部分电压分别作用在 L上所产生的电流进行加合，即可得到电感电流表达式为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_011_0bae018c40a8.png)

当设定时间 t\=0 s 时，即可得到电感电流的初始值 iL0。  

根据图4d，将各时段的电感电流进行积分，可以得到一个控制周期内各相电流平均值表达式，即

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_012_64c916ff6fa0.png)

式中，ωs 为控制角频率。  

网侧电流参考值为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_013_38b6694141a3.png)

保证功率因数为 1，将网侧电流平均值代入网侧电流参考值公式（8）中，即可得到网侧电流幅值为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_014_582ff2417d5e.png)

根据三相交流功率定义P\=3UIcosϕ，可计算在网侧单位功率因数运行时交流侧功率为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_015_0bd4665eccce.png)

由电力电子器件损耗定义可知

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_016_d371bc88aa13.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_017_4541d7402ad2.png)

考虑到基于双线电压调制策略中各段线电压变化的周期性，每个扇区内，线电压的变化模式不同， 但在整个周期内（两个扇区），线电压呈现出周期性变化的趋势。可以使用两扇区内电力电子器件的平均开关损耗代替整个工频周期的开关损耗。开关损耗数学模型为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_018_27fcee70f9a5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_019_e0054e8f4243.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_020_aac446e45744.png)

首先选取合适的初始点、设置迭代次数以及迭代规则。约束函数表达式为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_021_6fe893387b70.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_022_099c26cec796.png)

为了确保每次迭代朝着目标函数减小的方向移 动，同时避免过大的步长导致目标函数值增大在计算过程中需满足

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_023_936d5fe64d29.png)

其中

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_024_cd86ea980e73.png)

式中，ρ∈(0, 1)；σ∈(0, 2)；m为非负整数；mk为m第 k次迭代且满足不等式（10）成立时的最小值；α为中间变量，α为第 k次迭代时的值。  

更新后 Qk的雅可比矩阵，以及最小二乘乘子μk、λk、 ∇f为目标函数的梯度为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_025_4aa75d49878c.png)

若 ‖nk‖ ≤ε1且‖hk‖1+‖gk‖1≤ε2，则终止程序并输出二次规划问题的最优移相比点 Mk。  

基于 SQP 算法，可以得到开关损耗最小时对应的最优移相角ϕ1、ϕ2、ϕ3。表 1 为 Ui\=110 V 时上述 算法求解出的最优移相角组合。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_026_0dbdec6b3737.png)

3.仿真验证  

利用Matlab/Simulink 搭建BIMC系统模型，对所提出的最小开关损耗控制方法进行仿真测试。在网侧电压 Ui\=110 V，直流侧电压 Uo\=180 V 的电压等级下。系统模型的关键电气参数见表 2。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_027_72b9cf1c867f.png)

设定功率为 800 W，图 9 显示网侧 a 相电压和电流相位基本相同，直流侧电压平稳；对a 相电流进行FFT分析，THD为1.33%。  

由此证明，所提出的控制方法能够实现网侧电流为正弦，功率因数接近 1，具有较好的稳态性能。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_028_40bb0ff001ab.png)

表 3 为所提方法与对照方法（方法 1、方法 2、 方法 3，定义如图 4 所示）的移相角取值，以及通态损耗、开关损耗理论计算值与仿真值。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_029_1662ad05ed4c.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_030_bb1db4876c82.png)

4.实验验证

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_031_1ee53a5afa22.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_032_c99e243e8b33.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_033_c59b012feee1.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_034_c4639bed9860.png)
...
![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_035_87bc5c918a7e.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请加微信：18126115420，并备注单位+姓名+研发方向。

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_036_1d9920047bbd.jpg)

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_037_ce0741cdf907.jpg)

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\双向隔离型_AC_DC_矩阵变换器最小开关损耗控制方法_images\img_038_7d6b070fe0c8.jpg)