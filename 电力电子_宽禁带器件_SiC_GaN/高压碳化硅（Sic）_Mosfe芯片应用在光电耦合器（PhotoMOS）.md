# 高压碳化硅（Sic） Mosfe芯片应用在光电耦合器（PhotoMOS）


> 原文地址: [https://mp.weixin.qq.com/s/fwuOF0SwdFdbcbrck9bvCw](https://mp.weixin.qq.com/s/fwuOF0SwdFdbcbrck9bvCw)
...
PhotoMOS是指在输入元件中采用LED，在输出元件中采用MOSFET的光电耦合器。由于提高了机器的可靠性，并实现了小型化，因此应用于各个领域。
...
与可控硅输出的SSD(可控硅光电耦合器)相比 可对微小的模拟信号进行控制
...
1.工业控制    2.FA/OA 设备     3.医疗系统     4.高速检测机     5.安全系统
