...
**■**[在线阅读](https://ieeexplore.ieee.org/document/10032066)    ****■****[PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10032066)
G. Ma, Y. Li, J. Yang and B. Wu, "Cyber-physical Modeling Technique based Dynamic Aggregation of Wind Farm Considering LVRT Characteristic," in CES Transactions on Electrical Machines and Systems, vol. 7, no. 2, pp. 229-236, June 2023, doi: 10.30941/CESTEMS.2023.00024.
**摘 要**
随着风电渗透率的不断提高，大型一体化风电机组给电网带来稳定和安全风险。在大型风电场的综合建模中，考虑低电压穿越(LVRT)特性是至关重要的。然而，在聚合方法中，近似忽略行为是必不可少的，这导致了聚合过程中不可避免的错误。此外，实际中参数的缺乏也给风电场的建模带来了新的挑战。针对这些问题，提出了一种新的信息物理建模方法。该方法不仅克服了黑箱风电场下的聚集问题，而且根据运行数据准确地实现了聚集误差拟合。仿真结果表明，该方法能够准确地模拟风电场在各种情况下的动态行为，无论是LVRT模式还是正常模式。 
**Abstract**
...
**Bing Wu** was born in Tangshan, Hebei Province, in 1999. She received the B.S. degree in electrical engineering and automation from Jilin Institute of Chemical Technology, Jilin, China, in 2021. She is currently pursuing the M.S. degree in electric engineering at Shenyang University of Technology, Shenyang, China. Her main research interests include wind energy, distributed control, and smart grid.
★
