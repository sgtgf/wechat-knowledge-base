...
**■**[在线‍阅读](https://ieeexplore.ieee.org/document/10818788)    ****■****[PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10818788)
...
**摘 要**
本文提出了一种新型轴向磁通永磁机（AFPMM）的设计、分析、改进和成功测试。采用一种著名的准三维解析方法，初步设计了具有四层定子绕组的双面AFPM发电机。然后，利用软件对所设计的样机进行仿真。结果表明，需要改进技术来改善转矩脉动的性能和感应电压的三次谐波与基次谐波的比值。因此，提出了一种新的改进技术，该技术将定子绕组的各层进行相对移位。虽然该方法显著改善了三次谐波问题，但其设计仍然存在较大的转矩脉动，因此提出将该方法与传统的移磁技术相结合。实验结果表明，该组合能较好地解决三次谐波和转矩脉动问题。最后，制作了样机并进行了测试。结果表明，测试结果与数值计算结果吻合较好。 
**Abstract**
...
**作者信息**
**Mahmoud-Reza Kheiri**，于1996年出生于伊朗伊斯法罕。于2018年在伊朗阿拉克科技大学 （Arak University of Technology）获得电气工程学士学位，并于2021年在伊朗伊斯法罕大学（University of Isfahan）获得电气工程硕士学位。研究兴趣包括电机的设计、分析和数值建模。
**Arash Kiyoumarsi** ，于1972年出生于伊朗的沙赫尔库尔德。他于1995年从伊朗石油科技大学（Petroleum University of Technology·）获得电子工程学士学位。于1998年和2004年从伊朗伊斯法罕理工大学（Isfahan University of Technology）获得电气工程硕士和博士学位。目前是伊朗伊斯法罕大学（University of Isfahan）电气工程系的副教授，研究方向为电磁学和电机的有限元分析以及内置永磁同步电机的设计与分析。
**Hasan Zamani**，于2007年和2010年在伊朗设拉子的设拉兹大学（Shiraz University）获得电气工程学士和硕士学位，并于2016年在伊朗德黑兰的阿米尔卡比尔理工大学（Amirkabir University of Technology）获得电气工程博士学位。目前是伊斯法罕大学（University of Isfahan）电气工程系的助理教授。研究兴趣包括波与物质相互作用、周期结构中的波传播以及散射。
★
