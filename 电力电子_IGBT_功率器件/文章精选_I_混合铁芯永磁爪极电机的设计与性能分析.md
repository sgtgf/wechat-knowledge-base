...
**■**[在线阅读](https://ieeexplore.ieee.org/document/10075353)    ****■****[PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10075353)
C. Liu, Z. Chao, S. Wang and Y. Wang, "Design and Performance Analysis of Permanent Magnet Claw Pole Machine with Hybrid Cores," in CES Transactions on Electrical Machines and Systems, vol. 7, no. 3, pp. 275-283, September 2023, doi: 10.30941/CESTEMS.2023.00027.
**摘 要**
永磁爪极电机(PMCPM)是一种特殊的横向磁通永磁电机。与其它电机相比，具有转矩密度大、高速运转效率高等优点。但由于其复杂的不规则结构，使用硅片的制造工艺较为复杂。软磁复合材料(SMC)采用粉末冶金技术制造，可以制造出各种形状的定子铁芯结构，因此更容易制造出各种不规则形状的定子铁芯。但SMC原材料价格相对昂贵，且SMC的机械强度较弱。本文提出了一种混合核PMCPM。采用硅片-SMC复合磁芯和非晶合金-SMC复合磁芯，可大大提高PMCPM的转矩能力，使其在更宽的工作频率下具有更高的效率。同时，它的机械强度得到了提高，可以设计为大扭矩直接驱动应用，因为它是一个模块化的机器。此外，还提出了三种方法来降低混合磁芯在PMCPM中的附加涡流损耗。 
**Abstract**
