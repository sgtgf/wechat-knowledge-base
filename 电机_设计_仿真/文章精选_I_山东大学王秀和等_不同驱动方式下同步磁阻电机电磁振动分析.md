# 文章精选 I 山东大学王秀和等：不同驱动方式下同步磁阻电机电磁振动分析

原创 CES TEMS编辑部 CES电机与系统学报 2025-11-17 07:00 北京
...
Tiansa Chen1; Xiuhe Wang1; Lingling Sun1; Jinyang Xu2; Jihao Wang2; Jinjun Huang3  

1.Shandong University, Jinan, China

2.State Grid Shandong Electric Power Research Institute, Jinan, China

3.DC Technical Center of State Grid Corporation of China, Jinan, China
...
正弦波驱动和方波驱动是两种常见的电机控制策略。本研究构建了一种能够预测这两种驱动方式下同步磁阻电机（SynRMs）电磁力波分布的数学模型，并对比分析了不同驱动方式下电磁力引起的振动现象。研究旨在为同步磁阻电机电磁力波分布预测提供有效工具，同时探究驱动方式对其振动特性的影响。研究以一台 4 极 36 槽、功率 5.5kW 的同步磁阻电机为研究对象，基于磁动势 - 磁导法，结合电机特殊的转子结构及方波驱动下的电流谐波特性，建立了气隙磁通分布函数。同时采用麦克斯韦应力张量法，分析气隙磁通密度与电磁激励力波的关联，进而预测径向电磁力波的时空分布特征。通过有限元仿真计算该同步磁阻电机的模态特性与振动响应，对比分析两种驱动方式下的电机振动特性；此外，采用一台 6 极 36 槽同步磁阻电机进行补充对比验证。最终通过实验验证了仿真结果的有效性。  
