...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_000_4b49224957fe.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_001_459439f14a75.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_002_505fec180e31.png)

式中：ugj(j\=A，B，C)——网侧电压；uik和 iik（ k\=A，B，C）——输出级输出电压和电流；ifk—— Lf电感电流。 

根据式（1），电流在 d、q旋转坐标轴下的微分方程为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_003_89504ed0c0de.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_004_587e1a3d01cc.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_005_03b407dade5f.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_006_5288be6177a0.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_007_f95e6f195ed6.png)

式中：pˉ、qˉ——平均有功功率和平均无功功率；Pc2、Ps2、Qc2、Qs2——二倍频有功和无功功率波动分量。 

由式（4）可看出，SST输出级瞬时功率中产生二倍频波动分量，导致输出有功和无功双频振荡，可由正负序分量计算得出，如式（5）所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_008_87ef585c3474.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_009_606746da553c.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_010_e1713a3313ad.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_011_ff937ff4afae.png)

由于 SST输出级输出电压稳定值 uik与 VSG模块输出电压基准值 u\*kj近似相等，在不考虑电容影响的情况下，根据同步机定子电气方程，由式（2）可得 VSG控制模块电压基准值 与电网正序电压、电流分量基准值的关系，如式（7）所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_012_383cebf51368.png)

式中：u\*kd、u\*kq——VSG控制模块电压基准值在 d、q轴下的分量。将式（7）转换为正序电流基准值表达式并通过拉普拉斯变换至复频域，如式（8）所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_013_0920b595d6bb.png)

式中：s——微分算子；R——逆变器到电网的总电阻。 

根据拉普拉斯终值定理，式（8）可化简并转换至时域，如式（9）所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_014_b35e0f8808f4.png)

将负序电流基准值设定为零，根据式（5）和式（9）可得二倍频功率波动分量，如式（10）所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_015_a14ce8c9c4b4.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_016_4b5446f488d6.png)

由式（11）可知，有功功率恒定控制的负序电流基准值和电流平衡控制的正序电流基准值相互关联，利用式（9）推算出负序电流基准值，如式（12）所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_017_8f0d13c8381e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_018_56d597c93464.png)

由式（13）可知，无功功率恒定控制的负序电流基准值和电流平衡控制的正序电流基准值相互关联，利用式（9）推算出负序电流基准值，如式（14）所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_019_6fd3675d82f0.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_020_e050e27db9ea.png)

当 H\=0时，实现电流平衡控制；当 H\=\-1时，实现有功恒定控制；当 H\=1时，实现无功恒定控制，如式（15）所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_021_348de88ca121.png)

为实现对输出电流的调节，进而快速跟踪正负序电流基准值，设计基于 PI的正负序电流调节模块，如式（16）所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_022_4e0cb18f6ceb.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_023_db6ff66c4081.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_024_e73493b9e857.png)

5.1基于传统VSG的SST输出级控制  

如图 8所示，0~0.3s，电网电压三相平衡，SST输出级正常工作；0.3~0.9s，电网电压三相不平衡，A相电压升高 20%，B相电压保持不变，C相电压降低 20%；0.6s处加入中点电位平衡控制。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_025_73002419d48d.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_026_403710d7003f.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_027_8757c646f19e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_028_7363c3347f4e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_029_5b9f96b58046.png)
...
![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_030_962985d7941d.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请加微信：18126115420，并备注单位+姓名+研发方向。

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_031_d7f014f12731.jpg)

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_032_3b8765cc3cbd.jpg)

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\不平衡电压条件下VSG_SST控制策略_images\img_033_c1edddb625cd.jpg)