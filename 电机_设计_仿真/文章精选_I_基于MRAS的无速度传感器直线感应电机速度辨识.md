# 文章精选 I 基于MRAS的无速度传感器直线感应电机速度辨识

原创 CES TEMS编辑部 CES电机与系统学报 2024-03-04 07:00 北京
...
**■**[在线阅读](https://ieeexplore.ieee.org/document/10181099)    ****■****[PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10181099)

X. Tu, X. Hou, J. Zhao, S. Yan and Y. Xiong, "Speed Identification of Speed Sensorless Linear Induction Motor Based on MRAS," in CES Transactions on Electrical Machines and Systems, vol. 7, no. 3, pp. 294-300, September 2023, doi: 10.30941/CESTEMS.2023.00032.
...
在直线感应电机控制系统中，光栅速度传感器易受强磁场干扰。更重要的是，它可能会降低电机集成度，提高器件成本。为此，本文研究了一种替代光栅速度传感器的速度辨识方法。这种直线感应电动机速度辨识方法主要采用模型参考自适应方法（简称MRAS）和Popov超稳定理论。本文的研究内容可分为四个部分。首先推导了基于模型参考自适应系统结构的电机数学模型。其次，利用Popov超稳定理论求解估计速度的自适应律，保证了系统的稳定性。第三，在MATLAB环境下建立了基于模型参考自适应的直线感应电机转速辨识控制系统的仿真模型。最后进行了仿真试验和分析。仿真结果表明，转速辨识控制系统在空载运行和负载运行时都能很好地跟踪直线感应电动机的实际转速，保证了系统在全转速范围内的稳定性。  
