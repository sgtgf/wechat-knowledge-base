# 文章精选 I 傅科电流及减振处理对AMDT支架振动特性的影响

原创 CES TEMS编辑部 CES电机与系统学报 2024-03-18 07:00 北京
...
Kammeugue Noubissi Romaric1; Daosheng Liu1; Boxue Du2

1. Jiangxi University of Science and Technology, Ganzhou, China

2. Tianjin University, Tianjin, China

**■**[在线阅读](https://ieeexplore.ieee.org/document/10106621)    ****■****[PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10106621)

K. N. Romaric, D. Liu and B. Du, "Impact of the Foucault Current and its Vibration Noise Reduction on Bracket Features for AMDT," in CES Transactions on Electrical Machines and Systems, vol. 7, no. 3, pp. 330-340, September 2023, doi: 10.30941/CESTEMS.2023.00028.
...
本文探讨了福柯电流对支架振动的影响。为了确定福柯电流对支架振动的影响，在线圈被支架封闭并暴露在空气中的条件下进行了噪声测量。结果表明，支架增加了一次噪声21分贝。在整个模态计算过程中，线圈的常频远离100 Hz的激励频率，而支架的常频72.924 Hz接近100 Hz,这同样说明了噪声水平的上升。为了计算由福柯电流引起的托架振动，采用有限元法在频域内计算涡流密度、电磁力和托架响应。理论分析表明，计算结果是正确的，仿真结果有效地分析了涡流和电磁力对支架振动的影响。根据仿真结果及变压器的主要振动特性和噪声水平，提出了在变压器顶部支架上施加重物（应力）来降低振动幅值和噪声水平的方法。为了验证该技术的实用性和应用价值，对实验结果进行了分析，并与仿真结果、主要振动特性和噪声水平进行了比较。  
