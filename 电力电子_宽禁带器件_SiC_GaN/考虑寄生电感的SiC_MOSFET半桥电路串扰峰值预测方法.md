...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_000_24f325393745.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_001_7350f402c8ae.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_002_82224d1c6a79.png)

式中：gfs ——跨导；Vg \- on ——导通驱动电压。

idH 的快速变化会在寄生电感 LsH 和 LdH 上产生感应电压，使 vdsH 上升，此阶段 vdsH 的表达式，为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_003_317fae873a2d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_004_809c29eeff17.png)

根据基尔霍夫电压定律，此阶段的回路方程为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_005_b8ab22d08aa0.png)

且有：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_006_a95ddf850245.png)

可得到此阶段的串扰微分方程如式（5）所示。 vgs 是导致器件误导通的直接原因，因此串扰由 vgs 表示，即：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_007_3fa0919a8c43.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_008_f85c91e8645b.png)

vds1 的表达式，为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_009_4681dac41ac9.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_010_c918c36f7e3c.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_011_93b4feebaa0f.png)

式中：Rds\- on ——SiC MOSFET 导通状态漏源极电阻。

此阶段无 LsH 的影响，vdsH的上升为CdsH和CgdH 继续充电，使 vgsH 正向增加。此阶段的简化等效电路如图 5 所示，其中 dvgdH(t)/dt \> 0 。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_012_1dbd60c276fa.png)

根据基尔霍夫电压定律，此阶段的回路方程为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_013_6080f099826b.png)

可得到此阶段的串扰微分方程为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_014_55e44b7dc5de.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_015_42bd9fb2af69.png)

此阶段无 LsH 的影响，CgdH的部分放电电流流过CgsH ，使vgsH负向增加。此阶段的简化等效电路如 6 所示。其中dvgdH(t)/dt < 0 。串扰的微分方程与式（10）一致。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_016_11344bba1b69.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_017_049108e9f1dc.png)

此阶段无 CgdH 的影响，LsH 上感应电压的方向为下正上负，为 CgsH 正向充电，使 vgsH 正向增加。此阶段的简化等效电路如图 7 所示。其中 didH(t)/dt < 0 。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_018_8e8b1c5520c0.png)

根据基尔霍夫电压定律，此阶段的回路方程为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_019_1444f58a46cb.png)

可得到此阶段的串扰微分方程为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_020_268af0df9468.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_021_99688a033d9e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_022_115c58586f70.png)

此外，Vmiller 的表达式如式，为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_023_b8348f229a22.png)

因此，vdsH的时域表达式为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_024_d0083c95d29f.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_025_d9dec7e31b54.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_026_a46a2a05c394.png)

假设 idL 在电流下降阶段斜率的绝对值为 a3 ，如式（12）所示。

综上，可获得各阶段 didH /dt 的表达式为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_027_bd45e1c4b79f.png)

2.5 t的建模

由 于 串 扰 问 题 发 生 在 t1—t2、t2—t3、t3—t4、t7—t8、t8—t9 、t9—t10阶段，因此要确定每个阶段的时间间隔，可由式（22）确定，即：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_028_bef1e256db88.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_029_5c0aabe02258.png)

通过数据拟合得到式（15）中的系数p1~p7 ，如表2所示。其中，相关系数R2 \= 0.994 ，表明拟合精度较高。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_030_7553df2d763b.png)

根据SiC MOSFET和驱动板的数据表以及实验设置可获得的参数如表3所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_031_d327be3a3883.png)

通过数据拟合得到 Irr 的表达式为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_032_0838aaeea972.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_033_51a06cd31a14.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_034_dd57f0e7642b.png)

根据文献［10］中所述算法可知，当不考虑寄生电感LsH时，各阶段的vgsH如表 6 所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_035_c610ffd7c103.png)

3.2 算法的实验验证

为了验证算法的正确性，根据图 1 搭建实验平台，如图 8所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_036_a7c9c90f7438.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_037_15e72e247ffe.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_038_c5131ec77ff5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_039_738f1369b323.png)
...
![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_040_24def2a8f5ae.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信：18126115420，并备注单位+姓名+研发方向。

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_041_a7ecee98ead9.png)![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\考虑寄生电感的SiC_MOSFET半桥电路串扰峰值预测方法_images\img_042_9bbc7b9b15a2.png)