...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_000_7474bf5f875e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_001_593d74edce15.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_002_533d4cbfa0c2.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_003_794136e59498.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_004_b963903f9b16.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_005_df727dfd7bdb.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_006_c601f9288de0.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_007_3c296d28336e.png)

  
其中，iD 和 iC 表达式为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_008_a46370bc6487.png)

  
当 iD=iC=50%iload 时，负载电流 iload 为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_009_19f8f7fbd05e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_010_35b879df70e9.png)

3\. 混合并联器件的非理想开关特性分析

图 8 给出 了 考虑 线 路 寄生 参 数 影 响 的 SiC/Si⁃HP 双脉 冲 测 试 等 效 电 路 示 意 图 。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_011_2659192b5b4b.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_012_1e194e727045.png)

其中 tfr 是 SiC MOSFET 开关 过 程 中 的 电 压 上 升 或下降时间，从而有流过 CGC 的电流为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_013_b7d8531854cb.png)

  
电容 CGE 的电压变化量 ΔuGE 为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_014_e7a096cdfcbc.png)

其中，s 为拉普拉斯算子。

由式（6）求其 拉 普 拉 斯 反 变 换 ，可得 其 在 时 域上的表达式为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_015_2747fa426049.png)

  
其中：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_016_3e46432e3592.png)

  
从而有电压变化最大值为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_017_f6a1300d192a.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_018_05490df9955a.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_019_84270dcd9173.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_020_e0c0af7b8674.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_021_5a9b378afcf5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_022_57ae8c5bcd85.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_023_30a1108a5753.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_024_e02dfbb6f793.png)
...
![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_025_6e67a7a43c84.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信：18126115420，并备注单位+姓名+研发方向。

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_026_0fc2146c10d8.png)![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\Si_SiC_混合并联功率器件开关模式优化及特性分析_images\img_027_3a3df320c8e4.png)