# 文章精选 I 香港科技大学陈子峰等：基于惯性锁相环的开关磁阻电机增强型无传感器控制及转速范围扩展

原创 CES TEMS编辑部 CES电机与系统学报 2025-07-17 07:00 北京
...
Zifeng Chen1,2; Xijian Lin1; Huayu Ji1; Zehua Li1; Hang Zhao1; Dianxun Xiao1,2,3
...
开关磁阻电机（SRM）的无传感器控制通常采用结合低速脉冲注入方法和高速模型法的混合模式。然而，脉冲注入将产生噪音和扭矩波动。本文提出了一种基于增强模型的无传感器方法，使得开关磁阻电机在无注入条件下可拓展其最低运行范围。本方法采用了一种基于定子磁链观测器的惯性锁相环（IPLL）用于位置估计。与传统的锁相环方案相比，IPLL 提供了更强的抗干扰能力，从而减少了低速下的磁通模型误差。实验结果验证了该模型法实现扩展低速无传感器运行的可行性。  
