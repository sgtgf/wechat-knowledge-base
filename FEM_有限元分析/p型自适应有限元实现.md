...
![](p型自适应有限元实现_images/img_000_1cce4d9bb467.png)
...
![](p型自适应有限元实现_images/img_001_4ae3144e0f81.png)
...
![](p型自适应有限元实现_images/img_002_91711f1b83d2.png)

![](p型自适应有限元实现_images/img_003_41a1a379f3f3.png)

1阶叠层基函数与一次导数、二次导数的表达式：

![](p型自适应有限元实现_images/img_004_bb419a5d8405.png)

2阶基函数则添加：

![](p型自适应有限元实现_images/img_005_3c227b204743.png)

对于3阶基函数，的第四个基函数为：

![](p型自适应有限元实现_images/img_006_2dd9f0ebe96f.png)    

![](p型自适应有限元实现_images/img_007_d112fde9b90d.png)

![](p型自适应有限元实现_images/img_008_42a362e5adea.png)

N阶基函数的通式表示为：

![](p型自适应有限元实现_images/img_009_0a348e584e86.png)

![](p型自适应有限元实现_images/img_010_08b39b160cfd.png)

![](p型自适应有限元实现_images/img_011_a37b7746c53d.png)

对于初始网格的阶数选定，均为1阶，然后选择误差较大的一半进行加1，直到所有网格精度均满足要求。

退出自适应迭代标准：选择连续两次迭代变化结果，二者数值结果的误差变化量小于给定范围，即可满足要求，公式如下：

![](p型自适应有限元实现_images/img_012_c2c35d286532.png)

**2.测试结果**

_Eg1：模型参数_

![](p型自适应有限元实现_images/img_013_41e0332543e2.png)

自适应最终结果如下：

![](p型自适应有限元实现_images/img_014_947a125a53c2.png)

单元残差与单元阶数如下：    

![](p型自适应有限元实现_images/img_015_3af09b4d1d92.png)

_Eg2:介电常数为0的情况_

     ![](p型自适应有限元实现_images/img_016_c4df211e4c17.png)

自适应结果下的电场如下：

![](p型自适应有限元实现_images/img_017_50c8b736503b.png)

单元误差与单元阶数如下：

![](p型自适应有限元实现_images/img_018_08ffb8738717.png)

_Eg3:设计一个电导率变化的模型，中间存在相对高导的区域，结果如下：_ 

  ![](p型自适应有限元实现_images/img_019_f1530cfd207e.png)

自适应结果下的电场如下：

![](p型自适应有限元实现_images/img_020_ebe23652dde4.png)

单元误差与单元阶数如下：

              ![](p型自适应有限元实现_images/img_021_768d8d74bed0.png)
