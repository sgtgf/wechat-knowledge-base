...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_000_4bd7c694478d.jpg)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_001_93ec666c94e1.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_002_8fecdae5e15d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_003_916b6b08518c.png)

**２ 现有无源吸收电路**

无源吸收电路主要有四种拓扑形式，如图 ４ 所示。每一种吸收电路都并联在SiC MOSFET的漏源极两端，以达到吸收关断电压尖峰的目的。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_004_f964abdaac08.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_005_84e7bc158c64.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_006_da76a15ea260.png)

**３.２  RC参数对于抑制效果的影响**

如图6(ａ)所示，SiC MOSFET的关断电压Uds为有阻尼衰减的阶跃响应。根据图５(ｂ)给出的LC谐振回路等效图，可以得出加入RC吸收电路后，系统的振荡频率 Fosc为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_007_4a5da00fd0dd.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_008_b776bbebe237.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_009_a998b40e5bcf.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_010_0f950a4da745.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_011_ffaed01b32d5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_012_3a75f74883ec.png)

总损耗是系统效率的集中体现，其变化趋势和缓冲电阻热损耗类似，如图11所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_013_47d4f2b683ad.png)

在确定Rs取值后，可根据对于电压超调量和总开关损耗的要求，对Cs进行折中取值。显然，一味增大R,C 取值对于提升系统效率是不利的。 于是，在公式(４)的基础上对于RC取值有进一步约束：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_014_9707db5aadd7.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_015_dfbb162f8f55.png)

图13所 示 为 加 入RC吸 收 电 路 前 后 SiC MOSFET的关断暂态电压波形图. 显然，RC吸收电路的加入将超调量由330V降低到了180V，有效提升了SiC MOSFET开关暂态瞬间的可靠性。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_016_6a1e309bb5ff.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_017_318ead5d55de.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信，并备注单位+姓名+研发方向。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_018_3ade3c3d8599.jpg)![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\应用于弹载电源SiC_MOSFET的RC吸收电路的设计与优化_images\img_019_84aa944feb13.jpg)