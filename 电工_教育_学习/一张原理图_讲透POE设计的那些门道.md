...
![图片](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_000_95bc093f9a5b.gif)点击上方名片关注了解更多![图片](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_001_cd041b89bb60.gif)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_002_4291bf7c6196.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_003_2265700d1bef.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_004_40ddf2223c8f.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_005_5a078c5469f3.png)

  

**2、分级阶段**：确认是PoE设备后，询问需要多大的功率，便于系统对咱们的电源进行管理。

![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_006_d85052a09a41.png)

  

**3、供电阶段**：PSE和PD成功“握手”并确认功率需求后，稳定的电力供应就开始了。在整个供电过程中，PSE会持续监控每个端口的状态，提供欠压和过流保护，确保连接设备的安全稳定运行。

![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_007_649dced38946.png)

**4、断开检测**：设备断开后自动停止供电。

![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_008_f0d2d99c7ff7.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_009_69ddc705fe3c.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_010_7b2044dc00dd.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_011_6263e0048464.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_012_c876beac7b7b.png)

**VDD和VSS之间还要加0.1μF的旁路电容。**

![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_013_c3304200df82.png)

**输入电容选择：**  

IEEE标准要求输入电容不能超过120nF，否则检测会失败。这点要特别注意，很多人在这里栽跟头。

![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_014_e489ec55ce80.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_015_df7e68312434.png)

容值选择有个参考范围：

![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_016_0735fd2d3f9e.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_017_eac3075c20d5.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_018_d0b0922b8d3e.png)

**电流检测：**  

在初级FET的源极要加电流检测电阻，通常小于1欧姆，封装至少1206。还要为斜坡补偿留出位置，通常是一个电阻串联一个电容接到CS引脚。

![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_019_74851bf6e2e2.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_020_fcf8193eb04d.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_021_305d8ad248a9.png)

**有源钳位正向拓扑：**  

这是最复杂的设计，两个MOS管要精确同步工作。栅极驱动电路特别重要，在12V输出设计中两个MOS管都需要栅极钳位。

![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_022_095deb02c877.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_023_38cd0ebcbf63.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_024_00f60f52551a.png)
...
![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_025_6ecd90968898.jpg)

加群/投稿/招聘/推广/宣传/技术咨询 请加微信：woniu26a

![](D:\电脑文件\公众号知识库\电工_教育_学习\一张原理图_讲透POE设计的那些门道_images\img_026_be4e708e55ba.jpg)
