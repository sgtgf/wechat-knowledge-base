...
![](基于文本引导的注意力图像转发预测排序网络_images/img_000_5cce2c5478d5.jpg)
...
![](基于文本引导的注意力图像转发预测排序网络_images/img_001_b3ccab2ee151.png)

_用于图像转发预测的注意多方面排序网络学习纵览_

  

![](基于文本引导的注意力图像转发预测排序网络_images/img_002_a39f4f87e83b.png)

_文本引导的多模融合网络_

  

![](基于文本引导的注意力图像转发预测排序网络_images/img_003_e1640963bc8d.png)
...
![](基于文本引导的注意力图像转发预测排序网络_images/img_004_d21ff475019b.jpg)
...
![](基于文本引导的注意力图像转发预测排序网络_images/img_005_d35aa36d4ca7.jpg)
...
![](基于文本引导的注意力图像转发预测排序网络_images/img_006_896db9ecbb6a.jpg)
...
![](基于文本引导的注意力图像转发预测排序网络_images/img_007_a34c55cb7d5a.jpg)
...
![](基于文本引导的注意力图像转发预测排序网络_images/img_008_c2bd406b51bb.jpg)

![](基于文本引导的注意力图像转发预测排序网络_images/img_009_0bf80b3ac1e5.jpg)

  

![](基于文本引导的注意力图像转发预测排序网络_images/img_010_dd52cfb48c15.gif)

![](基于文本引导的注意力图像转发预测排序网络_images/img_011_dd52cfb48c15.gif)

![](基于文本引导的注意力图像转发预测排序网络_images/img_012_e1b1cbf3bf75.jpg)

![](基于文本引导的注意力图像转发预测排序网络_images/img_013_dd52cfb48c15.gif)

![](基于文本引导的注意力图像转发预测排序网络_images/img_014_dd52cfb48c15.gif)

**长按二维码｜关注我们**

**IEEE/CAA Journal of Automatica Sinica (JAS)**

![](基于文本引导的注意力图像转发预测排序网络_images/img_015_dd52cfb48c15.gif)

![](基于文本引导的注意力图像转发预测排序网络_images/img_016_dd52cfb48c15.gif)

![](基于文本引导的注意力图像转发预测排序网络_images/img_017_d13847bf8591.jpg)

![](基于文本引导的注意力图像转发预测排序网络_images/img_018_dd52cfb48c15.gif)

![](基于文本引导的注意力图像转发预测排序网络_images/img_019_dd52cfb48c15.gif)

**长按二维码｜关注我们**

**《自动化学报》服务号**

![](基于文本引导的注意力图像转发预测排序网络_images/img_020_dd52cfb48c15.gif)

![](基于文本引导的注意力图像转发预测排序网络_images/img_021_dd52cfb48c15.gif)

![](基于文本引导的注意力图像转发预测排序网络_images/img_022_18a554fc6edf.jpg)

![](基于文本引导的注意力图像转发预测排序网络_images/img_023_dd52cfb48c15.gif)

![](基于文本引导的注意力图像转发预测排序网络_images/img_024_dd52cfb48c15.gif)
