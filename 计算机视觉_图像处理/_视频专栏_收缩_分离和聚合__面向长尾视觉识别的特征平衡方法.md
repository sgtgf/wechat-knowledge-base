# 【视频专栏】收缩、分离和聚合: 面向长尾视觉识别的特征平衡方法

原创 自动化学报 自动化学报 2025-02-27 17:00 北京

> 原文地址: [https://mp.weixin.qq.com/s/Gp3U3jafl62huDwIoquITQ](https://mp.weixin.qq.com/s/Gp3U3jafl62huDwIoquITQ)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_收缩_分离和聚合__面向长尾视觉识别的特征平衡方法_images\img_000_f76a7fe84cb4.png)

v点击上方**蓝字**关注我们

  

杨佳鑫, 于淼淼, 李虹颖, 李硕豪, 范灵毓, 张军. [收缩、分离和聚合: 面向长尾视觉识别的特征平衡方法](http://www.aas.net.cn/cn/article/doi/10.16383/j.aas.c230288). 自动化学报, 2024, 50(5): 898-910
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_收缩_分离和聚合__面向长尾视觉识别的特征平衡方法_images\img_001_9446b627c358.jpg)
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_收缩_分离和聚合__面向长尾视觉识别的特征平衡方法_images\img_002_4897b29943a2.jpg)
...
在第2.2节的长尾问题分析中, 本文通过理论推导发现长尾识别精度不高的另一个重要原因: 训练集中样本数量不同导致模型分类器权重偏差. 为更好地评估分类器权重的偏差, 对模型的分类器权重计算L2范数. 如图3所示, 将模型分类器权重的L2范数可视化, 发现基线方法BS\[12\]训练得到的L2范数存在类别偏差, 主要表现为尾部类相关的分类器权重L2范数过小.

  

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_收缩_分离和聚合__面向长尾视觉识别的特征平衡方法_images\img_003_f3e867b73bd9.jpg)

  

图 3  基于类别的分类器权重_L2_范数

Fig. 3  Class-based classifier weight _L2_ norm
...
1) 提出特征平衡因子, 该模块能显著平衡特征在空间的分布. 通过提高尾部类特征的L2范数, 使得尾部类分布在特征空间的最外层, 同时保持头部特征在空间的中心位置, 扩展了样本特征的类间距.
...
**杨佳鑫**，国防科技大学系统工程学院硕士研究生. 主要研究方向为长尾识别技术.

  

**于淼淼**，国防科技大学系统工程学院博士研究生. 主要研究方向为人脸伪造检测.

  

**李虹颖**，国防科技大学系统工程学院硕士研究生. 主要研究方向为对抗攻击.

  

**李硕豪**，国防科技大学系统工程学院副教授. 主要研究方向为场景图生成.

  

**范灵毓**，中国人民解放军96962部队工程师. 主要研究方向为伪装目标检测与分析.

  

**张  军**，国防科技大学系统工程学院教授. 主要研究方向为视觉数据计算与分析. 本文通信作者.

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_收缩_分离和聚合__面向长尾视觉识别的特征平衡方法_images\img_004_51820040135e.svg)
...
[》基于自组织递归小波神经网络的污水处理过程多变量控制](https://mp.weixin.qq.com/s?__biz=MzI2NjA3MzM5MA==&mid=2650003738&idx=1&sn=839dd5673821c09e521f344d595bc836&scene=21#wechat_redirect)
...
[![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_收缩_分离和聚合__面向长尾视觉识别的特征平衡方法_images\img_005_9312e2f23a26.jpg)](http://www.aas.net.cn/)

  

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_收缩_分离和聚合__面向长尾视觉识别的特征平衡方法_images\img_006_409e145c41f9.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_收缩_分离和聚合__面向长尾视觉识别的特征平衡方法_images\img_007_409e145c41f9.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_收缩_分离和聚合__面向长尾视觉识别的特征平衡方法_images\img_008_d1e21947407a.jpg)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_收缩_分离和聚合__面向长尾视觉识别的特征平衡方法_images\img_009_409e145c41f9.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\_视频专栏_收缩_分离和聚合__面向长尾视觉识别的特征平衡方法_images\img_010_409e145c41f9.gif)
