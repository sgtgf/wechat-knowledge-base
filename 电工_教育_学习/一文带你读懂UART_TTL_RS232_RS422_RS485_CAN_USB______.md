...
> 原文地址: [https://mp.weixin.qq.com/s/GhhUMlY9BOmENr6eByCXkA](https://mp.weixin.qq.com/s/GhhUMlY9BOmENr6eByCXkA)

![](https://mmbiz.qpic.cn/mmbiz/cZV2hRpuAPiaJQXWGyC9wrUzIicibgXayrgibTYarT3A1yzttbtaO0JlV21wMqroGYT3QtPq2C7HMYsvicSB2p7dTBg/640?wx_fmt=gif&wxfrom=5&wx_lazy=1 "音符")点击上方名片关注了解更多![](https://mmbiz.qpic.cn/mmbiz/cZV2hRpuAPiaJQXWGyC9wrUzIicibgXayrgibTYarT3A1yzttbtaO0JlV21wMqroGYT3QtPq2C7HMYsvicSB2p7dTBg/640?wx_fmt=gif&wxfrom=5&wx_lazy=1 "音符")

  

原文链接：[UART、I2C、SPI、TTL、RS232、RS422、RS485、CAN、USB、SD卡、1-WIRE、Ethernet (qq.com)](https://mp.weixin.qq.com/s?__biz=Mzk0NjI3NzMwOQ==&mid=2247486091&idx=1&sn=fa08cc7e12507da09e15843fdfdb81dd&scene=21#wechat_redirect)  
...
UART是**异步**，**全双工**串口总线。它比同步串口复杂很多。有两根线，一根TXD用于发送，一根RXD用于接收。
...
I2C总线是一种**同步**、**半双工**双向的两线式串口总线。它由两条总线组成：串行时钟线SCL和串行数据线SDA。
...
SPI总线是**同步、全双工**双向的4线式串行接口总线。它是由“单个主设备+多个从设备”构成的系统。
...
声明：文章由微信公众号硬件笔记本于 2021-05-31 08:21首次发表
