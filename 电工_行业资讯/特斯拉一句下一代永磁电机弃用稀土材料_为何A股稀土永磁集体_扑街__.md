# 特斯拉一句下一代永磁电机弃用稀土材料，为何A股稀土永磁集体“扑街”？

原创 电机新视界 2023-03-08 11:06 上海

> 原文地址: [https://mp.weixin.qq.com/s/4xW5MbmHjOCSMGgl5YlRDg](https://mp.weixin.qq.com/s/4xW5MbmHjOCSMGgl5YlRDg)
...
本周三特斯拉召开一场发布会，把A股好几个板块带崩了！当地时间3月1日，特斯拉召开投资者大会，除了提到怎样用10万亿美元“改造地球”，特斯拉负责动力总成工程的副总裁Colin Campbell介绍，特斯拉的下一代平台将减少75%的碳化硅。
...
**特斯拉发布会展示的PPT显示，ModelY现行使用的电机中，三种稀土元素分别使用了500g、10g和10g，但未来特斯拉计划，将三种稀土元素的用量都降至0g。**
...
消息一出，稀土永磁板块今日大跌超2%，华宏科技、金力永磁、立忠集团等跌超7%，宁波韵升、广晟有色等跌超6%。
...
千亿巨头北方稀土盘中一度跳水，收盘跌超4%，成交金额30亿元，总市值较昨日减少57亿元。截至去年9月30日，北方稀土最新股东户数为57.14万户。
...
据证券时报，广晟有色方面表示，目前行业最先进的晶界渗透技术仅可以减少镝、铽等中重稀土的添加量约50%~70%，特斯拉所谓的不使用稀土仅是简短的一条新闻，并未说明其替代产品或者解决方案，同时行业内也没有其他可替代稀土的重大技术性突破。

  

金力永磁在互动平台回应称：钕铁硼稀土永磁技术从上世纪八十年代发明到现在将近四十年，正处于大规模应用而方兴未艾的发展阶段。将密切关注新技术路线的发展，并视技术的成熟度和市场的需求做出及时的布局跟进与响应。目前公司新能源汽车主要客户的订单和需求未发生变化，公司经营正常。

  

而中金公司研报认为，从目前的技术应用角度以及已公开的研究角度来说，永磁电机完全去稀土化难以在中短期实现。钕铁硼稀土永磁技术从上世纪八十年代发明到现在将近四十年，凭借其优异的磁性能，目前正处于大规模应用而方兴未艾的发展阶段，钕铁硼仍是电能与机械能相互转换不可或缺的元件。

  

从电机类型上看，并不是所有电机都需要稀土元素，它一般在直流电机中使用。交流感应电机可以无需稀土，但往往具有扭矩密度和功率密度低、体积较大等缺点。

据《华尔街见闻》报道，特斯拉最初在其车辆中使用的交流感应电机，但在Model 3上市时采用了新的永磁直流电机，并最终在其他车型上也使用这一款电机。

  

有学者在研究永磁辅助同步磁阻电机（PMaSynRM）。该电机不使用磁铁，因此可以不适用稀土，取而代之的是一个与旋转磁场对齐的具有气隙的钢转子。

也有团队在研究稀土的替代品。据彭博等外媒报道，去年10月，剑桥大学的一个团队和来自奥地利的合作者发现了一种制造新型磁性材料铁-镍（tetrataenite）的新方法，这可能成为稀土永磁的替代品。

  

电机是汽车的核心系统，关系到汽车的最高车速、加速时间、爬坡能力等整车性能。当前新能源汽车普遍采用的是永磁电机，具有能量密度大、运行可靠、调速性能任等特点。

  

稀土具有优异的磁、光、电等性能，应用领域十分广泛。永磁电机是稀土下游最大的应用领域。永磁电机下游需求最大的风电领域，占比约20%，其次是新能源汽车，占比约为15%。

  

若马斯克所言不虚，**在完全不使用稀土材料的前提下，其大概率永磁电机主用的材料便是铁氧体永磁体材料。虽说成本上的确有下降，但铁氧体永磁体体积较大，且磁性能不如钕铁硼、钐钴材料，有悖于新能源车降重增续航的趋势。**

  

具体用什么代替，特斯拉暂未公布，让我们拭目以待。
