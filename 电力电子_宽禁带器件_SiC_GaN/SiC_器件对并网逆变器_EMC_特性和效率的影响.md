...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_000_e45bab1d9bf1.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_001_2d1bca552da7.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_002_5f2ab8faeaf5.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_003_d7400b6de1d7.png)

![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_004_c03c3866e45d.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_005_ba8731e605ef.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_006_a779f65334b2.png)

根据图 3（b）中的 EMC 理论模 型 ，以 接地 点 G为参考点，根据结点电压法可得矩阵方程为

![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_007_ce3741380893.png)

式中：uU、uV 和 uW 分别为三相逆变器桥臂中点 对地的电压；Zf 为桥臂中点与接地点之间的阻抗，表示为

![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_008_a5b1c0e12c4d.png)

根据共模电压的定义和测量的寄生元件参数，为 简化模型，假设寄生参 数三相对称 分布 ，取 值 为参 数总 和 的 平 均 ，解 方 程 （2），可 以 得 到 EMC 解 析模型中共模电压为

![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_009_3c90fc36b74b.png)

式中：KCM（s）为寄生参数包括等效阻尼电阻对于共模电压的影响；uPU+uPV+uPW 为 共模噪声源对于逆变器共模电压的影响。

![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_010_4d9729a67b28.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_011_2bdecf19514e.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_012_cea42c8f1fdf.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_013_e716489432b5.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_014_ae7e75c3919a.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_015_10ba85f2a73b.png)

图 10 为 SiC 器件双脉冲测试， 分别测试了沟道 栅 SiC 器 件 和 平 面 栅 SiC 器 件 在 不 同 驱 动 电 阻下开通过程。 

![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_016_2944c2812b04.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_017_61b5c4be460f.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_018_ecdc795522da.png)
...
![](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_019_4809583329ad.png)
...
![图片](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_020_98dde421a5f5.jpg)
...
![图片](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_021_84b8b7bc4579.jpg)

![图片](SiC_器件对并网逆变器_EMC_特性和效率的影响_images/img_022_05333b5cc08e.png)