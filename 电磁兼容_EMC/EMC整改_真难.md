...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_002_2ee4c49b4bf9.png)其中，f是信号的频率，单位为Hz；A是电流环路的面积，单位为m²；I是电流环中的电流幅值，单位为A；R是测量点距离环路的距离，单位为m。
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_003_405664301252.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_004_08db8f87bbea.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_005_ea3cf3c3b71d.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_006_e355c48f05ac.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_007_6bc4bb07fd69.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_008_506577562cc9.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_009_c90cc01b31f1.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_010_2f55521f3c32.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_011_4ac2e99b45ff.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_012_9e6824486ba4.png)

缓冲电阻Rs的作用是对寄生LC振荡电路的振荡过程施加足够的抑制能力，其取值取决于意欲施加的抑制强度和L、C寄生元件的参数，可由下式予以确定 ：

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_013_6f29972622b8.png)其中，ξ是抑制因子。通常，ξ的取值在0.5（轻微抑制）到1（重度抑制）之间。寄生参数Lp和Cp的值通常是未知的，但可通过下述方法进行测量 ：
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_014_320d5c1b03ef.png)RC缓冲电路中的串联电容Cs需要足够大，以便让抑制电阻能在电路谐振期间表现出稳定的谐振抑制效果。如果这个电容的值太大，它在每个开关周期中的充电和放电过程就会导致过大的功率消耗。所以，Cs的取值通常以电路寄生电容的值的3~4倍为宜。
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_015_f3c6085016f5.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_016_792b3aecbf42.png)

  

测试所用的板子有两个版本，一个具有完整的地铜箔层，一个没有。板上设置了多种可选配置，如LC输入滤波器，不同的输入电容放置位置，可选的Rboot、RC缓冲电路和输出端LC滤波器。具有这些不同选项的PCB设计显示在下图中。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_017_b2960cd3edde.png)

  

测试设备的配置如下图所示。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_018_1f83a7b4c0c5.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_019_6d18466bdea7.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_020_98cf1dc0cb9d.png)

  

我们首先通过测量输入线上的共模电流来对辐射噪声做一次常规的检查。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_021_d1423fe5dea8.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_022_8457c074067d.jpg)

  

假如将同样的测试在背面为地线层的板子上进行，我们将看到这种拥有地线层的大型CIN回路带来的辐射要远低于单面板上的结果，开关切换所带来的振铃信号也要低一些。参见下图。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_023_c387f4d786e6.jpg)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_024_60f9d7e97445.png)

开关切换过程中的过冲和振铃信号的幅度都降低了大约50%，辐射的强度下降了大约10dB，频带宽度扩展到了300MHz。

  

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_025_53eda2accc1c.jpg)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_026_c64bf4ddb7a4.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_027_925596da32b6.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_028_599a3a438b71.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_029_7213a93f1392.png)

采用了上述的方案以后，单面板上的开关切换波形上的过冲已经完全消失，经环形天线检测到的辐射噪声也很低，它在经过FFT运算后得到的波形几乎都在本底噪声水平上。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_030_0fa8acc11583.png)

假如我们在这个时候再用高频电流探头对输入线上的共模电流进行测量，我们将可看到共模噪声已经下降很多。与第一次测量的结果相比，某些频率上的差异多于30dB，说明整个板子的辐射水平已经很低了。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_031_8fd07e5d025f.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_032_a72892a5e5cb.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_033_dfd191c6d098.png)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_034_9ca61e67ab2a.png)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_035_ec478f8ad3ca.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_036_4cd3ec997cae.png)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_037_e1fe636f0be7.png)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_038_5bff71787902.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_039_d2658c448774.png)

为了作为参照，首先在没有Rboot和RC缓冲抑制电路的情况下对输入线上的共模电流进行测试。

开关切换波形显示出5V的过冲，过冲信号的振荡频率为238MHz；输入线上的共模电流显示出明显的高频噪声。参考下图。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_040_288cf4492881.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_041_6e09abab8f21.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_042_387b64c3bbb5.png)RS可由公式进行计算。我们选择ξ = 0.5，于是RS = 9.1Ω，我们选择其为8.2Ω。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_043_3fbce41fcd38.png)CS应为4xCP，所以是330pF。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_044_b2b99b2b407b.png)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_045_7873c848c7f1.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_046_a17f3c4b18b1.png)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_047_e2cb373aba3f.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_048_8b9cc570d175.png)

  

2.确定开关切换回路的VIN和GND节点位置，将不同尺寸的输入电容尽可能靠近这些节点，最小的电容靠节点的位置要最近。由于这个切换回路承载了很高的电流变化率dI/dt，因而需要尽可能地小。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_049_9895afa6fd37.png)

  

3.将输出电容地放在不与输入电容切换路径发生重叠的地方，避免高频噪声串入输出电压中。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_050_0229e8f0773b.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_051_a03133a7880d.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_052_5a6000e7c633.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_053_9a31e1793fa6.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_054_b57ae7ccc884.png)

现在将电缆穿过铁芯就可以对其中的高频电流进行测量了，电流变压器的输出可以接入频谱仪或是示波器（使用50Ω端口）。

为了将测试工具和测试对象隔离开，最好是在电缆上加一个共模线圈，这可通过将引入分析装置的电缆多次穿过一个扣合式的EMI铁芯来实现。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_055_7885ddd44075.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_056_1175a00fa027.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改_真难_images\img_057_a923a7989056.png)
