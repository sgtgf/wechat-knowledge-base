...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_000_69745eb65ba4.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_001_f6de4fd8024f.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_002_392ddc45eb00.png)

式中：Um、Im 为A 相电网相电压、电流幅值；φ为功率因数角；ω为工频角频率。 

MMC 的A 相等效交流出口电压为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_003_def86ac62bb1.png)

式中：Em为电压幅值；δ为MMC 等效交流出口电压相对于电网电压的相角差；m为MMC 交流调制系数；Ud 为MMC直流侧额定工作电压。则MMC-SST 的3 个端口的有功功率为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_004_2ed1e7250d25.png)

式中PMVAC、PMVDC、PLVDC分别为中压交流、中压直流和低压直流端口的有功功率。忽略内部损耗，则有：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_005_f15a811889b4.png)

全桥子模块的负压输出能力使MMC-SST 具备降直流电压运行能力，定义直流调制度为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_006_49552b9b108d.png)

根据文献\[20\]，A 相上下桥臂调制电压满足：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_007_1c5d6705df5a.png)

正常工况下，中压直流母线按额定电压运行， 即mdc=1，此时A 相上桥臂调制电压满足：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_008_8cd5fb0ee1ff.png)

A 相上桥臂调制电压由半桥和全桥子模块组共同构成，可假设：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_009_fa788df2eabf.png)

式中：uapFB、uapHB 分别为A 相上桥臂全桥和半桥子模块组的调制电压参考值；xapFB、xapHB、yapFB、yapHB分别为全桥和半桥子模块调制电压参考值中直流、 交流分量系数。根据式(7)、(8)，可知：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_010_3939de445869.png)

根据半桥与全桥子模块电压调制能力，可知所设系数的选择范围：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_011_362804412b56.png)

A 相上桥臂电流由直流与交流分量组成，为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_012_bc1fd4cebaf9.png)

MMC-SST桥臂功率由MMC 和IBDC 的输出功率共同决定，假设低压直流侧功率由各子模块均匀传输，A 相上桥臂半桥与全桥子模块组功率为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_013_25a3fb319ef4.png)

半桥与全桥子模块组在工频周期内的能量为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_014_08571c5a4b0e.png)

为维持MMC-SST 装置内部能量平衡，需保证各子模块组在工频周期内的能量积累为零，即：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_015_2c1efe281511.png)

根据式(4)、(14)即可确定正常工况下交直流调制系数：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_016_9e3031869df8.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_017_28d5ea7dea83.png)

此时上下桥臂需通过全桥子模块输出负直流电压分量，抵消半桥子模块的正直流电压分量。类似正常工况分析过程，取半桥和全桥子模块组的调制电压为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_018_40fa0b320b5e.png)

根据式(16)、(17)，调制系数满足：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_019_1a1973abd9ce.png)

在故障稳态期间，中压直流线路短路电流被清除，桥臂电流中不含直流分量，A 相上桥臂电流为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_020_f5edfb440ee9.png)

则A 相上桥臂半桥与全桥子模块组的功率为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_021_5a3948f50d5d.png)

A 相上桥臂各子模块在工频周期内的能量为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_022_32ce09487337.png)

为保证A 相上桥臂各子模块电容电压恒定，需保证在工频周期内能量积累为零。即：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_023_fdc672ae704e.png)

故障稳态期间中压直流端口功率为零，故中压交流与低压端口功率满足：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_024_914e43287b8d.png)

联立式(22)、(23)可得交流分量系数：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_025_9f535e473dbe.png)

代入式(10)，可得直流分量系数取值范围为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_026_e53356e43931.png)

由于上下桥臂调制电压中还需实现环流抑制、 虚拟阻抗等控制，则以桥臂调制电压调节裕度最大为原则选取直流分量系数，选定：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_027_3d9ed18761c7.png)

综上所述，中压直流故障稳态时，按照式(24)、(26)选择交直流电压调制系数，能保持MMC-SST能量平衡且可控。此过程中，中压交流与低压端口仍能自由的双向功率交互，维持低压侧不间断供电。  

2. 中压直流故障下不间断运行控制策略  

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_028_3fb2cc97f097.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_029_fb1fb58c5548.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_030_9b68abb5b1db.png)

此时直流短路回路可等效为二阶RLC 串联回路，当电路在过阻尼工况下，电流响应非震荡，可实现短路电流快速抑制。故式(27)中虚拟电阻阻值Rvir可参照经典二阶电路过阻尼状态下选取，即：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_031_60f1fb00fcc0.png)

式中：Leq 为直流短路回路等效电感感值；Ceq 为直流短路回路等效电容容值。直流负反馈限幅受到装置交流调制度限制，因此：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_032_668cbce09601.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_033_628fdee3848d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_034_759b7c54baff.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_035_4f33cadfc412.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_036_19035d756618.png)

在仿真验证基础上，搭建了4.8kVA 的MMC-SST 实验平台进行物理动模实验验证，实验平台如图5 所示，电路参数如表2 所示。实验平台由5电平MMC 换流器和24 个全桥型DAB 模块构成，单个桥臂包含2 个半桥子模块和全桥子模块。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_037_29a06950d89a.png)

实验开始阶段，实验平台处于稳态运行工况， 直流电流约为15A；当中压直流侧发生双极短路故障后，中压直流侧短路电流快速上升。当控制器检测到中压直流电流到达40A 时，装置切换至不间断运行模式，实验结果如图6 所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_038_42157cc8d360.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_039_c413d252980e.png)
...
![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_040_d13bae6d9420.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请加微信：18126115420，并备注单位+姓名+研发方向。

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_041_679cef9c9ac0.jpg)

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_042_f5e7f9276e6a.jpg)

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\一种中压直流短路故障下不间断运行的MMC_SST拓扑及控制_images\img_043_da519108b40a.jpg)