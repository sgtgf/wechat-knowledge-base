...
![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsoAQpj4wWKEt9A6ysW2l857OtVoA09wtDZAJhgibfXlmMtkGlS9xJic7Q/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsGXg8BBp5JFFFFKuM2wA13tibmNX6f4QLKiaZf5r4tc1ibwWqS6cnWQN3A/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsoRBLZZqfrCTuH2oZ3XdNj0FGicBrdDkAVKNdosCfA2s4wstZJXKndtQ/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsM6nPKeicmDEA9U7J72PFADryiavuHZbPia9xbdMCdhaEZyOlAEcFZnWrw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsLpfSertm7ibXiah4sUibaibpljK0plzSOwKCubia05icHKmnQZFbLWdpcoKw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swls2dicSaXoy1tiaVkpM5LialewH0DXoTic7ubCSu5MGkibqb9N5dJlfFgdYLQ/640?wx_fmt=png)

其中t1～t2为导通状态，假设t1～t2内功率器件端电压为u(t)，电流为i(t)，二极管导通压降为VF(t)，则功率器件的导通损耗PssP为

![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swls9uia8YcD5a31xuWDSKs38QgIYyDbrPuHMsicpib9TpWcwKp0CyANL3u1A/640?wx_fmt=png)

根据压降与电流导通电阻Ron的关系，式（1）可表示为

![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swls4icfgMibic3FbKhibXloCw1CTHAg87PFzTJBqzDuyiafcXWJb9ODiaZSLzOw/640?wx_fmt=png)

二极管在t1～t2内的导通损耗PssD为

![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsjCZF7okQtLiaVrCgx6Z9IlLXP0e9wy1EzS8tWhp3IJZJISh8LMjjc4g/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsGWpAGqCkFQRK9mMLzMRsmBvkUcAAt5ukEeGNXwe1fhYOIMjvEpYMsg/640?wx_fmt=png)

IGBT关断时端电压和流过电流的波形大致如图5 所示，图5 中右侧为关断过程。可以看出，t2～t3内电压和电流不同时为0，因此会产生关断损耗Eoff，即

![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsnYRk2zso9Kge78j57ibiaoHO1KicEzwazaKeG8Bwx0ibPAiaib2myeZvFEhw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsYPnQOickRZF8aKeIxDsBp5icgobUMA5CJy5iar9gic1s28NHZbW7oXKNfQ/640?wx_fmt=png)

式中：θ(t)为某一时刻下空间矢量VS与主矢量的夹角，如图6 所示。

三相两电平逆变器共有8 种开关状态（000～111），根据当前的期望电压空间矢量（参考电压 矢量），判断其所处扇区位置，通过两个非零基本电压矢量进行合成。

![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlskhlgzUauNYUgPlDat1ia7djLUG3yDDAXCNpgEMK2ovqpoZRoF9iciaJMg/640?wx_fmt=png)

3.2 SiC 功率器件的优势

基于某款车型数据手册对Si IGBT 和SiC  MOSFET 两种功率器件的损耗进行对比。额定工作条件下，前者在导通压降、开关损耗等方面显著优于后者，二者损耗对比如图7 所示，后者具有更短的开关时间，所以其开关损耗显著降低。

![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swls8tfmTPlVHKU6mUicnySSkyJLdXQ5g9Xuusf1egvFle7qobnVDjQFHgA/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsVw8RVZic36j8ZSqGZwRYhs9GxvUtiasmNwyhMZErFK372l3T0NJTwicvQ/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsnQ7ov83uQbCYqt6V2ibN2c92IO9k9GxvQ0x4sxCoicBnjgb8VGDFl8RA/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsjICeoicolOicLGBWbJvvHa7u8YHRSBGnlzh2lF9W9Ylxl21ria9icJkBKA/640?wx_fmt=png)
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsGRpIFMZnVhIDNMtO0Uib5CEVwRDfKgntCBtvU1cH1Qgg4E0fbO15ib3w/640?wx_fmt=jpeg)
...
![图片](https://mmbiz.qpic.cn/mmbiz_jpg/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsvISudXtRD599cSVlGHs1yEvmVkrqJGOUrBjNv7wo4nrWqicH2NViczcg/640?wx_fmt=jpeg)

![图片](https://mmbiz.qpic.cn/mmbiz_png/aJG5QWxqLsn1fnBUlffcKoKyclM2swlsMJw0LcpVnKvDDMxtxwQNJLFRByuxGJlS3tBGdWsTial9ym1iasZaxnIQ/640?wx_fmt=png)