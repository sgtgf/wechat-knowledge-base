...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_000_004ea212687f.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_001_bf6266879f84.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_002_1a76f30868bb.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_003_2831afc02db2.png)

式中：σ 为材料的应力；E 为材料的弹性模量；αCTE 为热膨胀系数；ΔT 为温度变化值。

模块的杂散电感是模块重要的参数，由于杂散电感的存在，功率器件在关断过程中，会产生电压尖峰，给器件带来较大的电应力。电压尖峰的计算公式为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_004_c552387b1a13.png)

式中：ΔU 为由杂散电感产生的过电压；Lσ 为杂散电感值；di/dt 为电流变化率。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_005_0ba5f4ef3008.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_006_198092dac538.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_007_b0190a408bd6.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_008_550721facbdd.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_009_5dfafc5f6b66.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_010_578bde93830d.png)

通过试验确定了银膏银膜配合运用的工艺方案，流程如图 8 所示。

银烧结工艺中烧结温度、烧结压力和烧结时间形成彼此牵连的三角形关系。为了保证烧结工艺效果，进行了工艺拉偏。表 3 为 9 组试验组合数据。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_011_a04f47282be1.png)

烧结工艺完成后进行推力测试，结果如图 9 所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_012_c3db8e95577e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_013_b7b0e998c6a9.png)

烧结工艺完成后做超声扫描（CSAM）测试，测试显示烧结层的边缘清晰，连接性良好，如图 10 和图 11所示。模块经历 3 次烧结后，最终翘曲度在 80 μm 左右，翘曲水平是比较小的，如图 12 和图 13 所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_014_5b64581076fe.png)

如图 14 所示，模块的整体厚度与理论差异最大在70 μm 左右。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_015_7ea78a505887.png)

通过切片，在扫描电镜（SEM）下查看烧结层的状态，见图 15 和图 16，可以看出烧结层效果不错。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_016_aa6fed874907.png)

**3  模块特性分析**

功率模块试制后，为了确认工艺的有效性，进行了电性能测试。静态测试采用 Keysight B1506A，通过关键静态参数显示，在漏源极 Id 为 350 A 时和 RDS-on 为3.95 mΩ 时，封装能够实现芯片的电流能力，如表 4 所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_017_58a74674b0f2.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_018_4ae6fea74c8e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_019_64f9e8df34b2.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信，并备注单位+姓名+研发方向。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_020_618e494fe538.jpg)![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\全银烧结双面散热_SiC_模块的工艺设计_images\img_021_201f47ec2b4b.jpg)