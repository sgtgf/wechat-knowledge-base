...
原创 自动化学报 2019-12-18 17:48 北京

> 原文地址: [https://mp.weixin.qq.com/s/BjwaYeg6nUD5aiO8QJQFTg](https://mp.weixin.qq.com/s/BjwaYeg6nUD5aiO8QJQFTg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/47ibaBJyUH464geWARSLrpzWEmMPLTAF2ShhOia0mWfXlHOlsgzQkgDA4Nvp3ZMQYuFiccskuibFMT1nkhibDYfJ07g/640?wx_fmt=png)

![](https://mmbiz.qpic.cn/mmbiz_png/47ibaBJyUH464geWARSLrpzWEmMPLTAF2TNrEianEryls3NIs1jOxsq9IlO5C3EfGaTFpyUicjYSN55qLoRx9I6Uw/640?wx_fmt=png)

![](https://mmbiz.qpic.cn/mmbiz_png/47ibaBJyUH464geWARSLrpzWEmMPLTAF261WAzut6semSsJDG859wZvBiclHxmcITG5ULDUSQsSesb726AZXtKnA/640?wx_fmt=png)

![](https://mmbiz.qpic.cn/mmbiz_png/47ibaBJyUH464geWARSLrpzWEmMPLTAF2JCqME3NQrZhRBicudbklqvQyuXcBaHJUeHDqcFibzibBO5PcTicaO8TtpQ/640?wx_fmt=png)

工业上典型的间歇过程

  

本文提出的**鲁棒迭代学习模型预测控制(Robust Model Predictive Iterative Learning Control, RMPILC)**针对非线性间歇过程变参考轨迹跟踪问题，首先采用线性参变(Linear Parameter Varying, LPV)模型准确涵盖原始非线性系统的动态特性。然后将鲁棒H∞控制与传统迭代学习模型预测控制相结合,抑制变参考轨迹带来的跟踪误差波动,通过优化线性矩阵不等式约束下的目标函数求得控制输入。其鲁棒稳定性和迭代收敛性都可以通过不等式条件得到保证。

  

![](https://mmbiz.qpic.cn/mmbiz_png/47ibaBJyUH464geWARSLrpzWEmMPLTAF2eQeCozAkf2TYWl4T2DmJE3wLTX5WgSDt6uicibY0TSWc1hEd4FHtgGog/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png/47ibaBJyUH464geWARSLrpzWEmMPLTAF26YZGlpB9Vlt1wD3PyCQqkWvrpDIBS8QsxyFicFKdVt0sdvn70v80Crw/640?wx_fmt=png)

数值系统RMPILC跟踪曲线

![](https://mmbiz.qpic.cn/mmbiz_png/47ibaBJyUH464geWARSLrpzWEmMPLTAF23PNYxHwMXs2M5rIYMI1nPpbcWbtvG5ENhcfG1mAeFribJITgDPgHzcA/640?wx_fmt=png)

数值系统传统MPILC跟踪曲线

![](https://mmbiz.qpic.cn/mmbiz_png/47ibaBJyUH464geWARSLrpzWEmMPLTAF2cXsvbbSK29XNGE1iaUbNa5fGdG8tlzM5cGn2KvHCVxG9x6ibiaQjS7iayQ/640?wx_fmt=png)

CSTR系统RMPILC跟踪曲线

![](https://mmbiz.qpic.cn/mmbiz_png/47ibaBJyUH464geWARSLrpzWEmMPLTAF2evaLoic0uV5O0Nu8pFKdM8LBnicuSdWPVPN82d3Ncjb959Xp51ISfErw/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png