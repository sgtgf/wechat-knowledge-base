...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_000_9c4e52e309bf.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_001_03183f09c56a.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_002_59b221968645.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_003_c269274eeabd.png)

其中S\_{11}|^2 为反射功率系数，∣S\_{21}|^2为透射功率系数，A为材料内部因介质损耗、磁损耗、表面电阻或多次反射衰减所消耗的功率系数，即吸收率，由此可得吸收率的基本表达式：

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_004_36dd9ac470cd.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_005_27e32f445ead.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_006_5a7ba95096ed.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_007_64bf0e25acf9.png)

这里采用 10log 是因为要表示的是功率的对数。若∣S21∣\=0.01，则|S\_{21}|^2 = 10^{-4}，代入式(4) 得到 SE\=40 dB，表明透射功率被衰减了 40 dB。也可以直接写成:

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_008_fb4b68dbe538.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_009_57f64477f569.png)

 ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_010_e377ab2c1249.png)

则线性幅度为：

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_011_15a597b39dc0.png)

再由此得到反射功率系数：

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_012_d03d8d705bd2.png)

同理，

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_013_17e8932326f6.png)

最后代入上面吸收率公式得到吸收率：

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_014_87d3a151b615.png)

以吸波结构为例，若某S11\=−15 dB，则 ∣S11∣\= 10^{-15/20} ≈0.177，反射功率为 R≈0.031R 。若该结构背后有金属板，可视为 透射率≈0，则吸收率为0.969：即该频点吸收约 96.9% 的入射功率。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_015_63543eff1602.png)

以透波结构为例，若 S11\=−20 dB、S21\=−1 dB，则：

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\S参数在吸波_透波_屏蔽里的作用_images\img_016_52cd364fd9da.png)
