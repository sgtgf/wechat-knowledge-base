...
![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_000_16fbcd70b266.png)
...
![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_002_ba8e1c2f84d2.png)
...
![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_003_fb7a8ab2a6a4.png)

**1.2.2 开通损耗估算方法**

开通损耗ton是指功率器件从关闭状态到导通的过渡过程中的电流上升到正常值的10%开始,到功率器件两端的电压下降到标称值的2%是结束,将这段持续的时间成为ton,在ton的持续时间内所消耗的能量为开通损耗功率Pon 。

![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_004_dba8b4ac68a4.png)

开通损耗平均功率Pon由下面的公式定义： 

![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_005_20ed9a7a7fe5.png)

由式（4）可知,Eon的大小与开关管中的电流和电压有 关,除此之外,还与功率器件的节温有关,在实际应用中,由于难以获得功率器件精确的数学模型,因此常用试验和估算的方法,根据器件手册提供的数据和曲线, 利用插值的方法,可以用式（5）估算。

![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_006_3d0e781fb0c4.png)
...
![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_010_4b545a41a6f2.png)
...
![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_011_7c3553b5396e.png)
...
![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_012_f5c44a62bafa.png)

**2  仿真结果对比分析**

![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_013_41eec091e628.png)
...
![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_014_87db9128fdec.png)

**3.2 试验结果分析**

通道4为功率模块两端的电压,通道2为BOOST 变换器的输入电流。

![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_015_fc3b557e19dd.png)
...
![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_016_3c649884b867.png)
...
![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_017_973365ea1b27.png)

![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_018_5e53c4f72f9d.png)

声明：此文来源网络，是出于传递更多信息之目的。若有来源标注错误或侵犯了您的合法权益，请与我们联系，我们将及时更正、删除，谢谢。

![](Boost变换器中SiC与IGBT模块热损耗对比研究_images/img_019_4de4fbd2d7cd.png)