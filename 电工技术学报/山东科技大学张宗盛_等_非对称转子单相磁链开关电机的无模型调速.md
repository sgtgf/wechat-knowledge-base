...
Zongsheng Zhang1; Congcong Guo2
...
**摘 要**
本文提出一种无模型开环迭代学习控制(ILC)策略，实现了非对称转子单相磁通开关电机(FSM)的速度控制。基于所提出的绕组控制方法，非对称转子使电机在正旋转时产生连续的正转矩，在负旋转时产生相对较小的阻力转矩。根据硬件电路的特点，提出了初始迭代系数和变量迭代系数的优化方案，形成了无模型策略。进行了一系列样机实验，验证了所提ILC策略的有效性和实用性。     
**Abstract**
...
**郭聪聪**，1988年9月生，2011年于曲阜师范大学获学士学位，2017年于山东科技大学获硕士学位，目前就职于青岛职业技术学院，其研究兴趣包括永磁电机及计算机软件设计等。
★
