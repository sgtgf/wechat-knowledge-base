...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_000_47718515ab53.jpg)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_001_30005782b973.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_002_7fd91a587041.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_008_038cd8cad75a.png)

相应地，MOSFET在线性区域的最大电流由公式 7 给出。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_009_490e85c9babc.png)

对这个VGS 公式进行变换，可以得出米勒平坦区域的近似值是漏极电流的函数，如公式 8 中所示。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_010_159975830c7d.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_011_bb0de056dff1.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_012_59a479f9e917.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_013_b9d7f0bbc98d.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_014_ebd067ffaba3.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_015_0887028ae625.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_016_c9011a03f38b.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_017_e89dca922067.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_018_b36f75299101.png)

在 t2 期间，漏极电压为 VDS,off，电流从 0A 上升为负载电流 IL，而在 t3 阶段内，漏极电压从 VDS,off 降至接近0V。同样，可以使用波形的线性近似，按照公式13 所示估算各个阶段中的功率损耗分量。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_019_19273a907f56.png)

总开关损耗是两个损耗分量之和，下面的公式 14 列出了简单的表达式：

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_020_dffa30a33a91.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_021_44d346059e94.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_022_0146d6216957.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_023_e0ce0261693f.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_028_4adb0c93d5aa.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_029_f0ff5f4384f6.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_030_bcbd6e3985d6.png)

在此电路中，RGATE 允许调整 MOSFET 开通速度。在关断过程中，反向并联二极管会对电阻器进行分流。DOFF 只有在栅极电流高于公式 19 所示的结果时起作用。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_031_ecbb68765460.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_032_1275f4619ffd.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_033_5bb51f83fe62.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_034_d80a1816f34f.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_035_0b03b51c6bd2.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_036_b4137757da82.png)

如果 MOSFET 的自然 dv/dt 极限低于谐振电路的最大 dv/dt，则必须考虑使用一个不同 MOSFET 或负栅极偏置电压。如果结果对器件有利，可根据公式 22 重新排列和求解以前的方程来计算最大栅极驱动阻抗。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_037_f346d5159996.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_038_a3a8867d1097.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_039_a157dcc4990f.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_040_162ab6ea6c01.png)

然后可使用 公式 25 估算同步 MOSFET 整流器的总栅极电荷。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_041_c798f0265b2d.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_042_84a064d599f6.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_043_5993a964eb5c.png)

假定 QSR 和 QFW 所用的器件相同，没有外部栅极电阻器，并且与驱动器输出阻抗相比内部栅极电阻可以忽略，则驱动器输出阻抗的近似比值如公式 27 所示。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_044_a99c7ac0455a.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_045_66401c8abf6f.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_046_8812f32ae787.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_047_f6db3611086e.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_048_0e537c096aad.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_049_33720209f5ba.png)

典型应用原理图如图 21 所示，其中包含可选的 PNP 关断电路。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_050_178977743734.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_051_465741a350c4.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_052_f938a084fc56.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_053_932691293a91.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_054_cce36925be18.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_055_0797ac46dd09.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_056_2b16be74b7e7.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_057_77984e2e13ad.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_058_82b014a67d1d.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_059_d00112fb6018.png)

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_060_ebe767fe7dac.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_061_a920567651d6.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_062_c95252a3cfa0.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_063_7562cb489010.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_064_987d2b8143eb.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_065_00681ff34530.png)

对于开关的关断和连续关断时间也应遵循相同的注意事项，总电荷可按 公式 34 所示进行计算。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_066_3e0ab985390b.png)

对于稳态运行，两种电荷必须相等。

通过求解 VC 的方程式，可确定耦合电容器上的电压。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_067_744333ddcf83.png)

这个为人所熟知的关系强调了占空比对耦合电容器电压的依赖性。随着占空比变化，VC 随之改变，且MOSFET 的开通和关断电压相应调节。按照 图 32 的示例，在低占空比周期中，关断过程中的负偏置减小，而在高占空比时，开启电压不足。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_068_a737168261e1.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_069_604518df2e55.png)

考虑到 VC = D⋅VDRV，还可重新排列 公式 37 以获得所需的电容值。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_070_b5463726c925.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_071_826d06173a65.png)

从而得到一个解决方案。代入第二个公式中 RGS 的表达式，最差情况下 D = 0.5，确定 ΔVC = 0.1 × VDRV，可求解并简化第一个公式，计算最小电容值，如 公式 39 所示。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_072_b2b5305cb6dc.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_073_518b9ae1c53b.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_074_8493c9e162ab.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_075_9ab16b2b0362.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_076_ceaa9d49d61b.png)

磁化电感对驱动器的净电流及其方向还有另一种明显的影响。图 34 强调了电路中流动的不同电流分量以及驱动器应提供的电流分量之和 IOUT。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_077_e325f9f9f99c.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_078_53076d99dacf.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_079_2f9056c92a91.png)

此表达式在开关最大开通时间（也就是最大占空比）时具有最大值。在初级侧耦合电容器中，栅极驱动变压器的磁化电流会产生更多纹波电压分量。其影响体现在 公式 44 中，可使用该公式计算初级侧耦合电容值。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_080_52fff0f573fb.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_081_26e959814859.png)

第一个任务是找到分子中的最大伏秒数。图 36 显示了作为转换器占空比的函数的单端和双端栅极驱动变压器的标准化伏秒数。

![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_082_3618d4b29ec9.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\MOSFET和IGBT栅极驱动器电路的基本原理_images\img_001_454474c72cd4.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_084_e4ac56622222.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_085_f30409633243.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_086_3a71875c8a37.png)
...
![](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_087_3d025377aae8.png)
...
![图片](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_088_3e56719deaa6.jpg)
...
![图片](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_089_6acd806d4774.jpg)

![图片](MOSFET和IGBT栅极驱动器电路的基本原理_images/img_090_92b1c9a8ccca.jpg)