...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_000_467ffda5441d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_001_33c6a4a80b4a.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_002_9938aee57b01.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_003_7ae339765aa0.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_004_667a89fe3d58.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_005_82111518fb9b.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_006_3d471118c4b2.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_007_8e4b74611dc8.png)

功率器件在双脉冲测试电路中的开关转换过渡图如图 2-3 所示。开通和关断过程均有 3 个阶段。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_008_a12355e75121.png)

阶段Ⅰ：S2开通延迟。在t0时刻，驱动电压变正，vgs持续上升到阈值电压Vth ，MOSFET 开始导通，此阶段结束。在t0\-t1期间，电流开始上升，由于二极管中仍有电流流动，所以 MOSFET 上的电压保持不变。根据电路电流电压关系可得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_009_21b0b8c2c7d9.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_010_2ac29aff6228.png)

式中，iL为电感电流，iD为二极管电流，Rg为驱动电阻，vdrive为驱动电压。

阶段Ⅱ：iD上升：在t1时刻，vgs达到阈值电压Vth之后，MOSFET 开始工作在饱和区域，电压与电流的关系有式(2-5)所示的关系。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_011_10c03fa7ce73.png)

式中，ich为通道电流。

在t1-t2期间，iD持续上升，当电流上升到主电路电流值时，该阶段结束，二极管电流为 0，可得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_012_0a2352696c69.png)

阶段Ⅲ：vds下降。在t2时刻，电流已经上升到最大值，vgs只与通道电流ich有关。在t2-t3期间，ich没有变化，所以vgs没有变化，vgs处于密勒平台阶段，vds持续下降，电压开始在二极管上积聚。与上述相似，可得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_013_84b609ec3119.png)

当漏源极电压满足式(2-8)时，MOSFET 开始进入线性区域，这一阶段结束

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_014_0fa75979436d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_015_daa36eea6852.png)

当MOSFET 两端电压降至MOSFET 导通电压时，即满足式(2-10)时，这一阶段结束，导通过程完成。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_016_0cbadc088202.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_017_2169f834c622.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_018_3a92c25448b5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_019_a11eedaad07b.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_020_9f8956d0f3a2.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_021_37f61c3af12a.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_022_f072051ce608.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_023_d3e2c4771fd7.png)

这三种开关状态产生了三种电压等级的线电压+Vdc/2，0 和-Vdc/2。T型桥臂在一个基本周期的运行可以分为4个区间，如图3-2 所示。在本研究中，负载电流从逆变器输出端流向负载时，定义为正方向，即I0。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_024_b01792f8f885.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_025_ff33d6dca177.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_026_5f4b4b39bc44.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_027_f25165a1ad90.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_028_978ed3c125f9.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_029_c9dbac5e1a87.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_030_128e40f50c6d.png)

可通过表 3-3 中电压矢量Vref(Vg,V h)的vg 、vh以及Vg+Vh间的逻辑关系进行判断。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_031_32a8b0ca9a92.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_032_c79ffeb3e20e.png)

(4) 电压基本矢量作用时间

通过上述计算，三个基本矢量已知。之后，根据伏秒积平衡理论对三个矢量的作用时间进行计算，可得到下式

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_033_8faa015572b7.png)

其中，V1、V2和V3表示三个基本电压矢量；Vref表示参考矢量电压；d1、d2和d3表示三个基本电压矢量的占空比。在给定的参考矢量Vref (Vg ,Vh )下，通过式(3-4)可解得 60°坐标系下各矢量占空比计算公式如下式

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_034_9a3e58f21c14.png)

式中，v1g、v2g和v3g为gh坐标系下g轴三个基本电压分量。

求解式(3-5)可得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_035_4c9535c27b96.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_036_27b52b2d2ec5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_037_1949f64b925a.png)

考虑到各种条件的影响，开关损耗不能直接获取到。因此，为了对功率器件的开关损耗进行合理的评估，利用第2 章进行的双脉冲测试实验中计算得到功率器件的开关损耗，进而分别构建了三种功率器件的开通损耗和关断损耗模型如图3-8 和图3-9所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_038_51a71563d0e6.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_039_493f502914a3.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_040_7800fa1ba9a2.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_041_9f17ee490696.png)

功率器件两端电压和流过电流的仿真波形如图 3-11 所示，v1和i1为S1两端的电压和流过S1的电流，v3和i3为S3两端的电压和流过S3的电流，v2和i2为S2两端的电压和流过S2的电流，v4和i4为S4两端的电压和流过S4的电流。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_042_7a590c47a064.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_043_9c673fef9fca.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_044_bc69d2ad1608.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_045_56913db3d108.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_046_49a5e765bd1b.png)

式中，Cg2是栅极和 n−漂移层之间的线性电容，Cgdg是 n−漂移层的非线性半导体电容。漏源电容Cds可以简化为 p 基和 n−漂移层之间的非线性 PN 结电容Cds1，可表示

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_047_bd5f3052a3b1.png)

为需要注意的是，输入电容 Ciss、反向传输电容 Crss 和输出电容 Coss 通常由制造商在数据表中给出。则它们与各极间电容间的关系为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_048_4954b1f10173.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_049_653c628d3624.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_050_b5b99a653203.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_051_fcfc605ffb83.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_052_8699df54b9bd.png)

工作模态Ⅰ \[t0≤t＜t1，如图 4-4 a)\]：S3关断延迟。S3的栅极电压VG3移动，S3的输入电容Ciss3开始放电，由图 4-4 a)推导可得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_053_4934bab148e4.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_054_c9a177c7ba3b.png)

工作模态Ⅱ \[t1≤t＜t2，如图 4-4 b)\]：S3关断期间。当Vgd3下降到Vgd3th之后，通道电流ich3由Vgd3控制如下

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_055_166fe47c095c.png)

在此期间，vgs3和ich3继续下降，Ia的变化率受环路电感Lloop的限制，Lloop是S1 -S4的LD和Ls之和，S3正向充电的U1电流等于IA-Ia-ich3 。由图 4-4 b)可得到关键方程：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_056_d7fe1b760b92.png)

S1的Coss1开始反向充电，导致环路电感Lloop和Coss之间出现轻微振荡，可推导出以下等式：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_057_891b485399bf.png)

当IA开始流入S1的反并联二极管时，该过程结束。

工作模态Ⅲ \[t2≤t＜t3，如图 4-4c)\]：死区持续时间。在t2时刻，S1反并联二极管开始导通。由图 4-4 c)可得到关键方程如下：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_058_0a2ce53d52a2.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_059_3ddd3fbcebd7.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_060_24242f4fc11a.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_061_9086b7b9fbf2.png)

在此期间，vgs1继续上升，S1二极管上的电流逐渐转移到场效应晶体管，通道电流ich1也继续上升。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_062_ad90b8c471c7.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_063_530ef4cd73c0.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_064_2ef41fe8504d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_065_6363be8588e7.png)

当IA开始流入S1的反并联二极管时，该过程结束。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_066_374ee0a7fa65.png)

工作模态Ⅱ\[t1≤t＜t2，如图 4-6b)\]：S1关断期间。当IA开始流入S1的反并联二极管时之后，S1通道电流ich1由vgd1控制。由图 4-6 b)可得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_067_705f2fa19f49.png)

在此期间，vgs1继续下降，通道电流ich1也继续下降。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_068_589ba12a47d4.png)

式中，L1是LD1和LS1之和，此过程结束时，IA完全流入S1的反并联二极管。

工作模态Ⅲ \[t2≤t＜t3，如图 4-6c)\]：死区持续时间。t2时刻，IA完全流入S1的反并联二极管，S1的输入电容Ciss1持续放电，由图 4-6c)推导可得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_069_73788ac7b288.png)

当栅源极电压降为 0，此过程结束。

工作模态Ⅳ \[t3≤t＜t4，如图 4-6d)\]：S3开通延迟。t3时刻向S3施加栅极电压VG3后，栅极电流对输入电容Ciss3充电。由图 4-6d)推导可得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_070_ec2b81084e73.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_071_1bd41b2b3c6f.png)

工作模态Ⅵ \[t6≤t＜t7，如图 4-6f)\]：S3开通后的振荡。在这个阶段，S1完全关断，S3完全开通，负载电流流过S3， Lloop与Coss1发生谐振。由图 4-6f)推导可得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_072_ec412355a3bc.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_073_87c6165ea6bf.png)

根据分析模型和 LTspice 仿真得到开通和关断过程的S1漏源电压vds1和S3漏源电压vds3的波形如图4-7所示。从图中可以发现，波形的吻合度很高。开关分析模型的准确性得到了初步的验证。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_074_a26734a8dd49.png)

4.3 基于开关分析模型的损耗分析

对分析模型简化等效电路的损耗分析如下，主要包括S1和S3的导通损耗、开关损耗。S1在开关期间，S1的导通损耗Pcon-F 、S3的导通损耗Pcon-R，可以根据以下等式计算：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_075_afacf634b62d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_076_c4c27bf7d7bc.png)

式中， fs为开关频率，t(ich3=0)表示S3完全关断的时间。

在S1关断过程中，伴随着S3开通的过程。因此，S3关断重叠损耗可以推导如下：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_077_7528caba8068.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_078_273020c59e6f.png)

最后，基于提出的分析模型和已经描述的损耗计算方法，计算出逆变器的损失分解，如图 4-8 所示。结果表明，反向导通损耗占总功率损耗的主导地位，需要仔细优化反向导通时间。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_079_69e612eb5790.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_080_33125a6abbad.png)

式中， △B0.2Io表示脉动电流△Io等于 0.2 倍的Io时的磁通密度变化量，N 表示电感匝数。

因此，铁损即磁芯总损耗为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_081_5db817bf993e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_082_422f43cc0435.png)

电感电阻为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_083_0ecbfc022aad.png)

式中，l表示电感线的长度，S表示电感线横截面积，r表示铜线电导率。

可得铜损为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_084_142f00bf4c28.png)

因此，滤波器的损耗为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_085_838698cf24cf.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_086_262c1a8faa82.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_087_a0207daa536d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_088_df7dd0d13a4b.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_089_e5009aac5f99.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_090_4a36ccc5fa5a.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_091_87358a3f6fa2.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_092_e45547d0a59b.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_093_2d8d92013401.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_094_e86ae12c34fb.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_095_6486b1bfcdff.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_096_44656518ac0a.png)

本文GaN HEMT 的驱动电路选用ANALOG DEVICES 公司的驱动芯片ADuM4121ARIZ。对于GaN HEMT 的驱动电路是根据GaN system 提供的参考电路进行设计的，驱动电路如图5-3 所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_097_1a343f31c674.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_098_d3d4a6bb8705.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_099_ce45e5c2c7fb.png)

2.电压检测电路

电压采样实现原理如图5-5 所示，电路结构与电流采样基本一致，在工作时首先将霍尔采样得到的电压值转换为电流值，以后的工作原理就与电流采样基本相似。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_100_e8b4d592b105.png)

霍尔电压传感器的型号为CHV-25P，采样电压和输出电压的关系为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_101_4c40845d6ada.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_102_9092eda9c169.png)

5.1.4 直流母线电容设计

直流电容的体积通常占整个逆变系统体积的很大一部分。因此，设计和选择合适的直流电容对逆变器的体积功率密度至关重要。本文考虑了两个重要因素，即最小电容和均方根电流额定值。三相T 型3-L 逆变器中直流链路的最小电容可表示为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_103_022c93fea3fe.png)

式中，△PMax是逆变器的最大功率变化，TD是电压控制回路的响应时间（开关周期的5~10 倍），△Vdc是最大允许电压波动。在本文中，△PMax设置为满功率的 30%，△Vdc设置为直流母线电压的 15%。因此，最小直流链路电容为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_104_a2a240fe6659.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_105_d7d4f37e7539.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_106_80c9553423e7.png)

滤波器设计的波特图如图 5-8 所示，从图中可得出LC型滤波器的滤波效果主要是由截止频率和阻尼比决定的。LC 滤波器的截止频率fc的代数关系式：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_107_a0d30d0234f2.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_108_e74d39b45167.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_109_88f807a5ee39.png)

式中，L 为电感值，Io为逆变器输出相电流有效值，φ表示为逆变器功率因数角。

电容基波电流表达式为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_110_8bcf8ae5854c.png)

式中，C 表示电容值，U0表示逆变器输出电压的有效值。

电感和电容的计算公式为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_111_40a1eb7b9787.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_112_427b65844085.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_113_e9502dd1d208.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_114_9ece58ebc7c1.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_115_45a1b3b68cba.png)

图 5-12 给出了 A 相驱动电路的实验波形。其中，S1的驱动波形与S4互补，S2的驱动波形与S3互补。B相和C 相的驱动波形类似。S1和S4驱动电压为 20V，S2和S3的驱动电压为6V。为了防止桥臂直通短路，设置了死区时间为1.2μs。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_116_e58fe5e10eb2.png)

直流电压为 100V 时，逆变器输入侧直流电压Vin和输入电流I1的实验波形如图5-13 所示，根据直流侧输入电压和电流，可以计算得到逆变器输入实际功率。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_117_74f9114cb391.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_118_d283d30e753e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_119_df2b73eda99e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_120_378242d666ae.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_121_a5b2d7867762.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_122_24def2a8f5ae.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信：18126115420，并备注单位+姓名+研发方向。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_123_a7ecee98ead9.png)![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_GaN_器件的_T_型三电平逆变器特性及损耗分析_images\img_124_9bbc7b9b15a2.png)