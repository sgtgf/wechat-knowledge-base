...
原创 自动化学报 2020-04-17 17:30 北京

> 原文地址: [https://mp.weixin.qq.com/s/NHUmZWiXgpXKFyHR\_xXCNA](https://mp.weixin.qq.com/s/NHUmZWiXgpXKFyHR_xXCNA)

  

研究基于多智能体系统的故障估计问题。通过所设计的观测器可以同时估计多智能体系统状态和系统中可能存在的执行器故障和传感器故障。基于LMI，可以计算观测器的参数矩阵，并且计算量不随着智能体数目的增加而改变。

  

刘秀华, 韩建, 魏新江. 基于中间观测器的多智能体系统分布式故障估计. 自动化学报, 2020, 46(1): 142-152.

  

随着工业技术的发展，在实际中被控对象变得日益复杂。多智能体系统是处理这类复杂系统的重要工具。然而，随着系统的复杂化，系统发生故障的概率不断增加。另一方面，现代工业系统对系统可靠性的要求不断提高。相比于集中式系统，分布式系统的故障诊断更加值得重视。因为一旦某个智能体发生故障，故障信息会通过信息交互，影响其邻居智能体的正常运转，进而影响整个系统。

  

关于多智能体系统故障诊断的研究，考虑故障估计问题的相对较少。通过故障估计，可以获得诸如故障的大小、形状等信息。这些信息在设计容错控制器时可以起到非常重要的作用。

  

论文主要研究同时发生执行器故障和传感器故障的多智能体系统的故障估计问题。主要贡献包括：

1）提出了一种新型分布式中间观测器的设计方法，可以应用于观测器匹配条件和严格正实条件不满足的系统。

2）在观测器的设计过程中，同时考虑了集中式输出估计误差和分布式输出估计误差对估计结果的反馈作用。

3）针对具有有向拓扑连接的多智能体系统，只需要求解一个低阶LMI即可计算出观测器的增益矩阵。该LMI的维数和对单个智能体进行故障估计时所需求解的LMI的维数相同。因此，本文方法的计算量不会随着系统中智能体数目的增加而增加。

4）另外，针对具有无向拓扑连接的多智能体系统，利用Laplacian矩阵的对称性，给出一种保守性更小的结论。

  

![](https://mmbiz.qpic.cn/mmbiz_png/47ibaBJyUH44zoCzn4pbfjCO7FQbSjrQPoDIEniaGIKovqstEW4pic3UdcrHZYrl8dNXsYVTnLasia0NZ00lHZQ0eg/640?wx_fmt=png)

图1. 智能体的状态及其估计

  

仿真结果表明，所设计的观测器可以有效地估计系统中存在的故障和系统的状态。

  

![](https://mmbiz.qpic.cn/mmbiz_png/47ibaBJyUH44zoCzn4pbfjCO7FQbSjrQPrrM3neWN96eubUzpxcIyib85EQ3EJgWpApShicMZDMVfFOEoYSZlJqCQ/640?wx_fmt=png)
...
![](https://mmbiz.qpic.cn/mmbiz_png