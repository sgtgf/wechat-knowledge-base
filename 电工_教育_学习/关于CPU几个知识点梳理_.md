...
> 原文地址: [https://mp.weixin.qq.com/s/UCdPMIjiRAZCAUKzluzdvw](https://mp.weixin.qq.com/s/UCdPMIjiRAZCAUKzluzdvw)
...
作为一名工程师，与计算机打交道的日子不计其数，不管你玩硬件还是做软件，你的世界自然都少不了计算机最核心的 —— CPU。
