...
> 原文地址: [https://mp.weixin.qq.com/s/PkE2wm6SjODlo63HdobBNQ](https://mp.weixin.qq.com/s/PkE2wm6SjODlo63HdobBNQ)

![](https://mmbiz.qpic.cn/mmbiz/cZV2hRpuAPiaJQXWGyC9wrUzIicibgXayrgibTYarT3A1yzttbtaO0JlV21wMqroGYT3QtPq2C7HMYsvicSB2p7dTBg/640?wx_fmt=gif&wxfrom=5&wx_lazy=1 "音符")点击上方名片关注了解更多![](https://mmbiz.qpic.cn/mmbiz/cZV2hRpuAPiaJQXWGyC9wrUzIicibgXayrgibTYarT3A1yzttbtaO0JlV21wMqroGYT3QtPq2C7HMYsvicSB2p7dTBg/640?wx_fmt=gif&wxfrom=5&wx_lazy=1 "音符")

  

与历史上的许多其他伟大发明一样，我们今天所知的印刷电路板(PCB) 是建立在整个历史进步的基础之上的。在我们这个世界的小角落，我们可以追溯到 130 多年前 PCB 的历史，当时世界上伟大的工业机器刚刚开始运转。我们将在本博客中介绍的不是完整的历史，而是将 PCB 转变为今天的样子的重要时刻。
...
在计算器中，我们可能有 30 多个晶体管，但在主板上的单个芯片上，您会发现超过一百万个晶体管。重点是，技术和 PCB 设计本身的进步速度令人印象深刻。现在，计算器 PCB 上的所有东西都可以装入当今设计的单个芯片中。这使人们关注 PCB 制造中的几个显着趋势：

-   我们正在将更多功能集成到集成电路 (IC) 和微处理器等高级设备中。
    
-   我们正在将电阻器、电容器等无源元件缩小到微观水平。
    
-   所有这些都导致我们电路板上的组件密度和复杂性增加。  
...
很明显，PCB 的发展直接响应了我们对设备的期望。我们需要更快、更便宜、更强大的产品，而满足这些需求的唯一方法是使制造过程小型化并提高效率。电子产品和 PCB 的这股热潮是从什么时候开始的？在镀金时代的黎明。
...
在此期间，我们还将电力引入家庭，首先从城市开始，然后进入郊区和农村地区。电力现在是煤炭、木材和石油的替代品。想想在严冬时住在纽约，试着用脏煤或成堆的柴火做饭或取暖。电力改变了这一切。
...
在镀金时代，我们看到了电磁学的一些重大发现。我们发明了电动机，它将电能转化为机械能。我们还看到发电机，它通过将机械能转换为电能来做相反的事情。

这也是一个天才发明家的时期，他们仍然对我们今天的电子世界产生影响，包括：

-   托马斯爱迪生 在 1879 年发明了灯泡，在 1889 年发明了电影，以及许多其他创新。
    
-   尼古拉·特斯拉 在 1888 年发明了电动机，在 1895 年发明了交流电源。
    
-   亚历山大·格雷厄姆·贝尔 于 1876 年发明了电话。
    
-   乔治伊士曼的柯达 于 1884 年发明了第一台消费类相机。
    
-   Herman Hollerith 于 1890 年发明了制表机，随后创立了 IBM。  
...
请注意，PCB 的最初想法并不是在镀金时代发明的。然而，如果没有这个时代的制造能力，以及电力的广泛影响，PCB 永远不会成为今天的样子。
...
汉森还在他的专利中描述了通孔应用的概念。在这里，他展示了您可以在两个具有垂直线的层上打一个孔以建立电气连接。

在此期间，我们开始看到爱迪生和其他商业领袖大力推动电动设备进入日常家庭。这种推动的问题是完全缺乏标准化。如果你住在纽约或新泽西，并使用爱迪生的电力发明来照明、取暖或烹饪，如果你在另一个城市使用它们会发生什么？它们无法使用，因为每个城镇都有自己的插座配置。

爱迪生不仅想卖给人们一个灯泡，他还想卖一种服务，这一事实也使这个问题变得更糟。爱迪生可以按月为您提供电力服务；然后你会购买灯泡、电器等。当然，这些服务都不兼容其他竞争方法。
...
最后要注意的是，进步时代标志着第一次世界大战。这场冲突纯粹集中在机械装置和堑壕战上。PCB 概念，甚至是基本的电子产品，还没有用于军事应用，但很快就会使用。

咆哮的二十年代（1920 年代）  

随着第一次世界大战的结束，我们现在正处于咆哮的二十年代，看到美国经济出现了巨大的繁荣。这是历史上第一次住在城市的人多于住在农场的人。我们也开始看到在美国各地引入连锁店和品牌。您可能在两个不同的城镇拥有一两家家族商店，但现在我们拥有走向全国的主要品牌和商店。
...
在这里，我们看到曾经是泥泞的道路正在铺设。人们需要汽油来为他们的车辆提供动力，因此加油站应运而生。您还拥有维修店、配件等。许多人的整个生活方式都源于汽车的发明，今天仍然如此。

也是在这段时间，我们看到了我们今天仍然依赖的现代电器的引入，比如洗衣机、吸尘器和冰箱。这是人们第一次能够在商店购买易腐烂的商品并将其储存以延长保鲜期。
...
由于这次失败，美国国防部意识到他们需要一种更可靠的通信方式。这将电子产品作为替代摩尔斯电码的主要通信手段带到了最前沿。
...
随着第二次世界大战接近尾声，我们看到我们的士兵回家，组建家庭，生下一大堆孩子。提示婴儿潮一代。正是在战后时代，我们看到了对真空吸尘器、洗衣机、电视和收音机等现有电器的大量改进。现在大萧条已经过去，许多消费者终于可以在家中买得起这些设备。
...
冷战时代的到来，标志着美苏之间相当时期的紧张局势。由于资本主义和共产主义之间的差异，这两个巨人几乎相互交战，并使世界处于核毁灭的威胁之中。

为了在这场军备竞赛中保持领先，双方都必须加强沟通能力，以了解敌人在做什么。在这里，我们看到 PCB 被充分发挥其潜力。1956 年，美国陆军公布了“电路组装工艺”的专利。现在，制造商有一种方法既可以固定电子产品，又可以在带有铜迹线的组件之间建立连接。

随着 PCB 开始在制造领域起步，我们发现自己正在参加世界上第一次太空竞赛。俄罗斯在此期间取得了一些惊人的成就，包括：

-   1957 年发射第一颗人造卫星 Sputnik
    
-   1959 年向月球发射第一艘宇宙飞船 Luna 2
...
在这一切中，美国在哪里？主要是落后，通常需要一两年的时间来开发相同的技术。针对这一差距，我们看到美国的太空预算在 1960 年增长了 5 倍。我们还有著名的 1962 年肯尼迪总统演讲，其中一部分值得引述如下：

> _“我们选择去月球！我们选择在这十年去月球做其他事情，不是因为它们容易，而是因为它们很难；因为这个目标将有助于组织和衡量我们最好的精力和技能，因为这个挑战是我们愿意接受的，我们不愿意推迟的，也是我们打算赢得的。” ——美国总统约翰·肯尼迪，1962 年 9 月 12 日_
...
在 1970 年代，我们看到 IC 首次用于电子产品制造。到了这个时候，如果你不使用 PCB 进行连接，你就有大麻烦了。
...
在 90 年代，随着 BGA 的引入，我们看到硅的使用全面展开。现在我们可以在单个芯片上安装更多门，并开始将存储器和片上系统 (SoC) 嵌入在一起。这也是电子产品高度小型化的时期。我们没有看到任何新功能添加到 PCB 中，但整个设计过程开始发生变化和发展，转向 IC。

现在设计人员必须在他们的布局中实施测试设计 (DFT) 策略。弹出一个组件并添加一条蓝线并不容易。工程师必须从未来返工的角度来设计他们的布局。所有这些组件的放置方式是否都可以轻松移除？这是一个巨大的担忧。
...
切入电子和PCB设计的当今时代；我们称之为混合时代。过去，我们有多种设备来满足多种需求。你需要一个计算器；你买了一个计算器。你想玩电子游戏；你买了一个视频游戏机。现在你可以购买一部智能手机并获得 30 种不同层次的内置功能。这可能看起来非常明显，但当你真正看到我们的智能手机可以做的所有事情时，它会非常令人震惊：
...
我们正处于设备整合的时代，但接下来会发生什么？PCBs 已经建立，我们几乎所有的事情都有流程和程序。高速应用正在成为常态。我们还看到只有 25% 的 PCB 设计师年龄在 45 岁以下，而 75% 的人正准备退休。该行业似乎正处于危机时期。

PCB设计的未来会是机器人吗？也许在带有柔性电路的可穿戴设备中？或者我们可能会看到质子用光子学取代电子。至于我们所了解的物理多氯联苯，未来甚至可能会发生变化。不需要物理介质来实现组件之间的连接，而是具有波浪技术的潜力。这将允许部件在不需要铜的情况下无线发送信号。

未来会怎样？  

没有人真正知道 PCB 设计未来的发展方向，甚至整个电子产品的发展方向。自我们的制造肌肉开始运转以来，已经过去了近 130 年。从那时起，随着汽车、电器、电脑、智能手机等主要产品的引入，世界永远发生了变化。我们所有的基本生计和生存都依赖煤炭、木材或石油的日子已经一去不复返了。现在我们拥有可以满足我们日常需求的电子产品。

但未来会怎样？这是一个很大的未知数。众所周知，我们面前的每一项发明都站在其前身的肩膀上。我们的祖先将 PCB 设计带到了今天的位置，而现在我们需要创新和彻底改变我们设计和与技术交互的方式。未来可以是任何东西。未来取决于你。
