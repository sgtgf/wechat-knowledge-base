# 北交唐涛教授等：基于二维结构熵的CBTC系统信息安全风险评估方法

原创 自动化学报 2019-04-18 17:30 北京

> 原文地址: [https://mp.weixin.qq.com/s/vlKoZyqBwjCuDVqeiWmuwQ](https://mp.weixin.qq.com/s/vlKoZyqBwjCuDVqeiWmuwQ)

基于通信的列车运行控制（CBTC）系统：采用基于IEEE802.11的无线局域网实现列车与地面设备实时、双向、连续的数据传输，控制列车的运行速度和方向，确保列车间保持安全的间隔，在保证行车安全的前提下提高轨道交通运行。
