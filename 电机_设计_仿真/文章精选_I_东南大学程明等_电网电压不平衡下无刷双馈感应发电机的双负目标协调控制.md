# 文章精选 I 东南大学程明等：电网电压不平衡下无刷双馈感应发电机的双负目标协调控制

原创 CES TEMS编辑部 CES电机与系统学报 2024-11-18 07:00 北京
...
Ming Cheng1; Zheng Cao1; Xiaoming Yan2
...
针对电网电压不平衡情况下无刷双馈感应发电机（BDFIG）风力发电系统，提出了一种双负目标协调控制策略。为了减轻转轴上的机械应力和冲击，设置了机侧变换器的负控制目标（NCO）来抑制电磁转矩的脉动。而电网侧变流器（GSC）的NCO则用于抑制BDFIG发电系统的总输出有功功率振荡或总输出电流不平衡程度。与传统的MSC或GSC单变流器控制方案相比，由于改进的背对背变流器协调控制系统的自由度增大，可以同时满足双NCO。通过双笼式转子BDFIG （DCR-BDFIG）样机的仿真和实验结果验证了所提控制策略的有效性。     
