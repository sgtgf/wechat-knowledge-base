...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_000_f244adb46f69.jpg)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_001_9ffe4837dd35.png)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_002_f7e4e599e38c.png)

                             图 3. 图腾柱PFC SiC MOSFET快管应用场景

![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_003_cafab763aa33.png)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_004_266c3d14ec57.png)

                图5. 400V 三相OBC DC/DC 系统中SiC MOSFET 应用场景  

![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_005_27e34a7b4f71.png)  
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_006_fb4315b88300.png)

                            图7. 800V OBC DC/DC SiC MOSFET 应用场景  

![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_007_772e0fc834a6.png)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_008_bbcafa9fec60.png)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_009_b26824989410.png)
...
                ![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_010_9ab99c70ce17.png)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_011_4cd6795b8d4d.png)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_012_3790bfb0db26.png)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_013_d1eac09bdc16.png)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_014_74051af7b1cd.png)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_015_d3ecc33458df.png)

  使用SiC和图腾柱PFC的高效OBC架构

对于6.6KW双向OBC，PFC中可采用两个60mΩ MOSFET并联或用一个25mΩ MOSFET，DCDC中可采用一个60mΩ或一个45mΩ MOSFET，下表总结了这种双向OBC设计的器件选择。

![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_016_5356dbadee73.jpg)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_017_1c06355c2434.png)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_018_8464a9c008f8.jpg)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_019_669851a97cec.png)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_020_5ae71c4021e4.jpg)
...
![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_021_e9043780fa92.png)

声明：此文来源网络，是出于传递更多信息之目的。若有来源标注错误或侵犯了您的合法权益，请与我们联系，我们将及时更正、删除，谢谢。

![](SiC_MOSFET在OBC_DC_DC_中的应用介绍和方案优势_images/img_022_b16bdd1364b4.png)