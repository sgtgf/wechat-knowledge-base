...
原创 硬件笔记本 2023-05-08 07:40 四川

> 原文地址: [https://mp.weixin.qq.com/s/2WeL9Ja-aa7TVTq4hhMsqA](https://mp.weixin.qq.com/s/2WeL9Ja-aa7TVTq4hhMsqA)
...
日本：KOA 兴亚、Kyocera 京瓷、muRata 村田、Panasonic 松下、ROHM 罗姆、susumu、TDK中国台湾： LIZ 丽智、PHYCOM 飞元、RALEC 旺诠、ROYALOHM 厚生、SUPEROHM 美隆、TA-I 大毅、TMTEC 泰铭、TOKEN德键、TYOHM 幸亚、UniOhm 厚声、VITROHM、VIKING 光颉、WALSIN 华新科、YAGEO 国巨
...
****************52**************示波器铭牌一般都会标识两个参数，比如泰克TDS1002B 示波器标识的60MHz 和1GS/s，请解释这两个参数的含义。**

60MHz 是指示波器的带宽，即正常可以测量60MHz 频率以下的信号。1GS/s 是指示波器的采样速率，每秒最多采样1G个点。

  

****************53**************当采样信号的频率低于被采样信号的最高频率时，采样所得的信号中混入了虚假的低频分量，这种现象叫做什么？**

这种现象叫做频率混叠。

  

**************54****************什么是基频晶体？****什么是泛音晶体？****为何基频晶体最大频率只可以做到45MHz 左右？****如何辨别基频晶体和泛音晶体？**
...
****************55**************如果一个门电路，输入高电平阈值是2.0V，输入低电平阈值是0.8V。那么如果输入一个1.2V 的电平，请问门电路工作在什么状态？**

状态不确定。

  

****************56**************请问为何手持便携电子产品，需要在众多输入输出接口加ESD 器件？您认为选择ESD 元件的时候需要注意哪些参数？如果一个时钟线加了ESD 器件之后接口工作不正常，把ESD 器件去掉之后却能正常工作，您认为是什么原因，应该如何重新选择ESD 器件？**
...
****************58**************将一个包含有32768 个基本存储单元的存储电路设计成8 位为一个字节的ROM，请问该ROM 有多少个地址，有多少根数据读出线？**

有4096 个地址，数据线是8 根。

  

****************59**************在函数L（A，B，C，D）= AB + CD 的真值表中，L=1 的状态有多少个？**
...
********************61********************电容的高频等效模型为等效电阻R，等效电感L 和等效电容C 的串联。请写出该电容在高频状态下的阻抗表达式。请问该电容的谐振频率fT 是多少？在什么频率下该电容呈容性？在什么频率下该电容呈感性？在滤波电路中应如何选择电容的谐振频率？

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdQLz5PPVmQWgpf5LkcD4nLKJJMRUuzHL88dUTv2BLt7uicibLKLYu8L0g/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

********************62********************数字电路中常采用0.1uF 贴片电容作为滤波电容，该电容的等效串联电感典型值是5nH。**请问该电容用于什么频率以下的杂讯的滤波？**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdPZD9nMibyOKMRib0sr2PDkwdg9BAx7szxpDQCJzQWdLMVcc7TIpUf7aw/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

********************63********************为何电源的滤波电路常常是大电容配合小电容滤波（比如220uF 电解电容配合0.1uF 贴片电容）？
...
![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdheenXtVctMplVnRF01NVttI69v940ne9yZ0chZBWAxdUPrian3q4ia7g/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

********************64********************某滤波器的传递函数为

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdbTlylbKc9PEkvK654MTZqRVTScZBg9aRLTZTicKywTPcshKeIBFV57A/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdVSjHlFw0dsoX7HrN8bdAIXpbPA9Ohc6LQ4Ev1r7hkbsIcG0QC5lWQQ/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

********************66********************下图是SN7407 逻辑芯片其中一个门的电路图，请写出A 和Y 的逻辑关系式。**请问这种逻辑门有什么用途？**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdCQEQOZicACHzbB6u3VfpU1jeic05SWxFh73aMibPicnDIEYJSvStwKiayYg/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdChsrx7wB21bNicQ6D9OHrMNLWLALjicuTVoQfdGFricvvtLP2MUehWxWw/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

Y=/A，这是CMOS 结构的非门。

  

******************68********************请问以下晶体振荡器电路中电阻R1 有什么作用？****请问C1、C2 和晶体Y1 是串联还是并联的？****如果C1=C2=30pF，晶体振荡回路上的其他杂散电容之和为Cs=5pF，请问这个晶体的负载电容CL 是多少？****C1、C2 应该比CL 大还是小？****又或者C1=C2=CL？**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdgLlv9L5CnvOaYjjcEoEufYJaqyibaLj6b0HqCReIVZ3ZYGFFxdP1r0A/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
********************69********************请写出下图中x1、x2、f 的真值表和逻辑关系式（三个场效应管均为NMOS 管）

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAd9icMdkxWTKm6D4YCzibdg0j7AACvqdBIaGlSs5e52CgyKMk7mKrfXVpQ/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAd3w1j5IDMNqBOxAr2LicWPRrcPNwib4sXCJcTiahniaefBC4iaErS0bLrCBg/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

********************70********************下图所示电路，已知Vcc=15V，β=100，UBE=0.7V。**请问：****（1）Rb=50KΩ 时，uo= ？****（2）若T 临界饱和，则Rb=?**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdjwbia0lAl3Rmea2UMDSCP3HS4CQ9hDWD0HONbwxRBDvAJTnLL43ZLmQ/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAd0Ud801nsLuaPIearmb8sajiceReUMZ6XLwU4aMiacVZOviaMzNhzYHUlQ/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
**********************72**********************电路如下图所示。**已知Us(t)=10\*√2\*cosωt（V）**

**求:** **(l) 频率ω 为何值时，电路发生谐振？****电路的品质因数Q 是多少？**

**(2)电路谐振时, UL 和UC 的有效值是多少？**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdhWrw9nsQ28Oe9oHVmbPKb9iaGZAn62ouGiaVaH37Bldn2xbGjMvlx0YA/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

**********************73**********************如果一个BGA 封装的CPU 芯片焊接到PCB 上后，因为焊接不良的原因导致某些信号开路，并且某些信号与旁边的信号短路，请问如何定位这两种故障，把开路和短路的信号找出来？
...
![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdET26HibXxTX7KPo2ibH9ia63XQUj3RwbAcjqmxmH2jVQ4zxdGNW5CicibfA/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdQDMOWkMqEW3DXxsbgn6J24dRDE4uXNJ5Wmtzicw9tNm9KtD4cm0wOQg/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdyCtqtGiaAUCQXaCfJBCOqhN8dfkpG3cgxzlICVeA2VxPePIgLicL4oDw/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
**********************77**********************请解释一下什么是Setup-Time 和Hold-Time，什么是Setup-Time 裕量和Hold-Time 裕量。
...
![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdzEDDricoLHuq1WELoo7Uibp3Y2ict3VGhUeUDtP6W75NchNuk36LJibP6g/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAd7CumfbxUPxib4Q60Ehwa5bEp6PAJh6hiaBW04HdAaFPVWpvkTsJZar2g/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

**********************79**********************下图是一个传输线串联匹配的模型，假设驱动端A 的输出阻抗R0 为10~20 欧姆（输出高电平和输出低电平时输出阻抗不一样），传输线特征阻抗Z0 等于50 欧姆，请问串联匹配电阻RTs 应该如何取值？

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAd7q3cnLcJpCyO7pFdibwqQbBb8KwkReVoW3ChiaOnRJf8PcDQsObwbbTw/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

RTs=Z0-R0，所以RTs 取30~40 欧姆，可以取标称值33 欧姆。

  

**********************80**********************请分析下图三极管单管放大电路中的二极管VD1 的作用。

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdsZgghNXvMUgHnMX0feytpiaZLNdjbCs3yHuzY37yf0IYz7LmGFzPVJw/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
************************81************************请问下图电路中二极管D1、D2 有什么作用？

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdL6RF8ErGmjcJQQ0ufe4QqA3LsqpQ69tJon3x71N3UV3jYX0AuwB00A/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

在Vi 输入电压接近于零时，D1、D2 给三极管T1、T2 提供偏置电压，使T1、T2 维持导通，以消除交越失真。

  

************************82************************请画出RC 微分电路和RC 积分电路。

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdBKyTRia0y6HV3MDUia1TSvMxBbFuFLicLnAhbtUG2z1GNDhuYqatGKxyw/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

************************83************************请画出交流降压和桥式整流电路。

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdSsJNPh5QKB9lLNDlwolYWFpdbTLAhMNCe75EcBZFE6hDqpJzDib3a9A/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

**********************84************************请画出一个晶体管级的差分放大电路。**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdtYlFOO9UPLLibqJTODap61Q7ypgT51cwXg9wjP391WAzVSJqricC12pA/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

************************85************************请画出一个220V 交流电源的EMI 滤波器的基本电路图。

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAd8EyMo2LDLoAptS07u109cW0jBx5k7W8J6cSDTia9W0mHBqy2tRFcHiaw/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

************************86************************下图是反激式开关电源的局部原理图，请给反激式变压器加上尖峰吸收电路。

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdEqymFX5fln3ChF7ULUWCjahha3Hdpq2awoD8tGLz9GdAdV6VsibUH8A/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

************************87************************如图所示为恒流源电路，已知稳压管工作在稳压状态，试求负载电阻中的电流IL。

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAd9gxJm3VOjibBDr4G7zIiakGvr4Hh4ibjLG4uBrPjDOZ8yaRu0yOKoyLPA/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdk1xSPId3y38GrSHfY9kSA5icYj2Svmcvt8CJ9fibBeXJ06Gibgn54ibmoQ/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAd9E7S2bFicUKAP5gY7dGN5OibU3ibghLgPuxq9uye4b1vmHDmeYuqg8wibw/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdvoTskehBK8cc3D4o7UhPoBibUjLfnNS67Q3uI39Rsp9suPC7ze8ec6g/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdcxbaknxmr1rNr6xDkwhxVz60eohah5Za0IyXd2FgXpQWqLblsbohXQ/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

************************89************************下图运放电路中的R1、R2 和C1 作用是什么？**电路的放大倍数是多少？**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdDgzx5vO06zfibiaAHUdlK6fUTDURgoBicUOnbsUse9RicrxHmyY1VPI4QA/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

R1、R2 和C1 的作用是提供1/2 的电源电压3V 作为参考电压。 电路的放大倍数是-2。

  

************************90************************由理想运算放大器组成的晶体管电流放大系数β 测试电路如图所示，设晶体管的UBE=0.7V。

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdtJwDKibsiczXmXZC0s4WN4eENbcUSn0ASbSgSsTH9RpJw3jqIh5U5mgw/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

**************************91**************************请画出您做过的一个四层以上PCB 的叠层结构。

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAd9anDic0Z0rHgTquQ4lcWuyDrLJWGialtjUOYcQ8YS2KoaWD8696KJbTQ/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

************************92**************************请用三极管、稳压二极管、电阻、电容粗略地画出一个简单的线性稳压电源原理图。**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdW9fdvsR0SRyibgXFyeT2qB0bqZjxSG9OpdAeIichFDuXd4NBiblIgBHbg/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

************************93**************************请画出DC-DC 电路的四种电路简图（Buck、Boost、Buck-Boost 和Inverter）。**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdU4eY59rTIWo0o3T9gMpo2FYxTMjtFG5hyxf6jh3kh9YEwQtIqOhQ6g/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

  

************************94**************************请问以下电路中的R1、R2 和C1 的作用是什么？**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdgic2Av16q1pnEhkH2o8QwRxSJy2fPFJLNtDEoO6ZCEdkk0uOv4Ryadw/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

R1、R2 用于调整输出电压。C1 是相位补偿电容，有加速稳定输出电压的作用。

  

************************95**************************下图为一个LCD 的背光驱动电路，请问这是升压电路还是降压电路？****这是恒压驱动型电路还是恒流驱动型电路？****如果需要调整背光的亮度，则需要调整哪个元件的参数？**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdOHic2iaZNFechq891HrVA09O6KZrZNRuT0gskIXZ0JlOGa5GnOGjaaXQ/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
************************96**************************分析下列时序电路，画出连续4 个CP 脉冲作用下，Q1，Q2，Z 的输出波形，说明是几进制计数器，有否自启动功能。**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdyyZYmL2p0DY6rnRDXHqhmycZicEbxibbvt9ibrrGicSoRMTvzq2csaFlsg/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

输出波形如下：

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdwbb9KAkjBV69xoRIAbzfTzolu0DFjdNHgiax2fZ6qaspWpVIhnZnC5A/640?wx_fmt=png&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)

该电路是三进制计数器，无自启动功能。  

  

************************97**************************下图是某直流电源的输入电路，请分析图中每个元器件的作用。****请问稳压管Z1 可以放在保险丝F1 之前吗？****为什么？**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdk6R3icrtHOk2oF3icIvZuaMouDHHcwJtkzrXFALmT1JOA9oklnqciaaFw/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
...
************************98**************************一块多层PCB 在TOP 层铺了一圈有开口的接地铜箔，左上角有三个接地孔，在左上角靠近铜箔的地方有一个22.894MHz 的辐射干扰源。****对这个PCB 做22MHz 电磁场强度扫描，测量结果是TOP 层的接地铜箔辐射超标。****请问这个PCB 的TOP 层接地有什么不妥的地方？****应该如何改正？**

![](https://mmbiz.qpic.cn/mmbiz_png/iayzTbicUDics6jh3tHKzAjUKjwqzn8OdAdNnWiaBchAEHUyIkVQFTaic4lS5KuJbaMHOkqOa4TzBaFEcwqP7Q4OpaQ/640?wx_fmt=jpeg&tp=wxpic&wxfrom=5&wx_lazy=1&wx_co=1)
