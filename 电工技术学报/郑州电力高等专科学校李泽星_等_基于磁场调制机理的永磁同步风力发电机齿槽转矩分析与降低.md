...
Zexing Li1; Chao Liu2; Yiwen Fan2; Zixuan Zhang3; Jiakuan Xia4
1. Zhengzhou Electric Power College, Zhengzhou, China
2. China Electric Power Research Institute, Beijing, China
3. State Grid Henan Energy Interconnection Power Design Institute Co., LTD, Zhengzhou, China
4. Shenyang University of Technology, Shenyang, China
**■**[在线‍阅读](https://ieeexplore.ieee.org/document/10770096)    ****■****[PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10770096)
...
**摘 要**
本文建立了一个考虑相位角影响的磁场调制模型，用于分析和削弱永磁同步风力发电机的齿槽转矩。与现有分析模型相比，新模型分析了磁场谐波和相位角对齿槽转矩分量的调制效应。首先，推导出具有相位角特性的磁通密度模型，并利用能量法分析了齿槽转矩与磁场谐波之间的关系。然后，基于磁场调制机理，分析了相位角和磁场谐波对齿槽转矩分量之间耦合关系的影响。所有齿槽转矩分量被分类为多个正负谐波分量的组合，并通过谐波组合和相位角特性确定各分量的贡献特征。基于有限元模型（FEM），验证了齿槽转矩的磁场调制模型。根据所得结论，进一步解释了转子阶梯偏斜抑制机制是正分量和负齿槽分量之间的相互补偿效应，并通过选择合适的段数和偏斜角度有效抵消主要谐波。最后，为了验证分析方法的有效性，测试了优化原型的空载反电动势和齿槽转矩，实验结果与有限元模型结果吻合良好。  
**Abstract**
...
**作者信息**
**李泽星**，工学博士，于2017年和2023年分别获得沈阳工业大学电气自动化专业学士学位和博士学位。现就职于郑州电力高等专科学校电气工程学院，研究领域是永磁电机振动噪声的分析和抑制。
**刘超**，于2006年和2009年在山东大学获得学士学位和硕士学位。现就职于中国电力科学研究院(北京)，主要研究领域包括碳评估、碳足迹、碳交易成本和可再生能源的产生和整合。
**范怡文** ，于2017年在东北电力大学获得学士学位，2019年在北京交通大学获得硕士学位，2023年获得中国电力科学研究院博士学位。现就职于中国电力科学研究院(北京)，主要研究领域包括中低压直流配电系统和风能系统。
**张子璇**，于2018年和2021年在沈阳工业大学电气自动化专业获得学士学位和硕士学位。目前就职于国网河南省能源互联网电力设计院郑州有限公司，主要研究领域是永磁电机振动噪声的分析和抑制。
**夏加宽** ，工学博士，教授。于2006年在沈阳工业大学电气工程专业获得博士学位。现为中国沈阳工业大学电气工程学院教授，主要研究方向包括现代运动控制、电力电子与动力传动、大型同步电机励磁系统的设计与研究、特种电机的设计与控制等。
★
