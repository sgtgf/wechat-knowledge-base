...
![](https://mmbiz.qpic.cn/sz_mmbiz_jpg/icVUVTFlBCVXicTEFLFDSXdHrr1q9XGBKGCJr6hmxUrDQt74sGPju2JfictdaItwQPvyYI9WLXFBTNvqfv4CUJ9gg/640?wx_fmt=jpeg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_png/icVUVTFlBCVUuOrdpo14aXpsE5qZY15mKR4HL4Pcn5Dmbrh2jz752FiaPaJ4VFX8T3Wbf39BuO6GxI0kIu6c9yTA/640?wx_fmt=other&from=appmsg&random=0.8632962821987089&tp=webp&wxfrom=5&wx_lazy=1&wx_co=1)

每个文件内部有两列数据，分别为节点坐标和节点值。例如：

![](https://mmbiz.qpic.cn/sz_mmbiz_png/icVUVTFlBCVXicTEFLFDSXdHrr1q9XGBKGbguh8V7pSEyWnuNHHkRiaEAvVZKC3jEkK3Hm6E0sv9sX9cBrvhcvJcA/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/sz_mmbiz_gif/icVUVTFlBCVXicTEFLFDSXdHrr1q9XGBKG7E1A71wsJ95sDrkGASKmPibjhY7gFYlTjB3SOMASTVY2w0Q3coK60xA/640?wx_fmt=gif&from=appmsg)

当`sigma = 0.5`时，计算结果是稳定的，但波形存在较大的扩散，随时间推移，波形与初始形状偏离严重。

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/icVUVTFlBCVXicTEFLFDSXdHrr1q9XGBKGmibtX6oIzfukiatAfjvH9o5dC7pWq51avH2kiadPG5UIGyjLHB2lbHGQA/640?wx_fmt=gif&from=appmsg)

当`sigma = 1`时，计算表现良好，波形保真度很高。

![](https://mmbiz.qpic.cn/sz_mmbiz_gif/icVUVTFlBCVXicTEFLFDSXdHrr1q9XGBKGhLludd5HSzdJ85F4Fbyu0nHyjW92O6879pGKD6GM6HFZKjOfvg7iaDA/640?wx_fmt=gif&from=appmsg)
