...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_000_1272edeae73e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_001_a861be4a36f6.png)

根据电压和电流的状态，SiC MOSFET 的关断过程分为 4 个阶段\[5\]，如图 3 所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_002_cd2f43f909fa.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_003_4335103c0d4f.png)

其中，Vgl 是驱动电压的低电平，栅极电流 ig 由式(2)计算得到。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_004_3c480eff6985.png)

**2.2. 关断延时阶段(t1~t2)**

在此阶段内，SiC MOSFET 的栅源极电压 Vgs 和漏极电流 id 保持不变，Vds 快速上升，直至达到 Vout。在此阶段，SiC MOSFET 完成线性区到饱和区的过渡。电压的变化率 dvds/dt 可由公式(3)计算得到。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_005_0b985d60217e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_006_a4e5f375c63e.png)

其中，gm 是 SiC MOSFET 的跨导。

由式(1)、(2)和(4)可得，漏极电流 id 的变化率和驱动电压 Vgl 的关系式为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_007_e6b37477f05e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_008_d17b4f755b6b.png)

其中，Lp 是回路中杂散电感的总和。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_009_d898b57b8616.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_010_5fa4f8c276fe.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_011_26819be98012.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_012_8931f49b1836.png)

通过实际应用发现，如图 5 在 SiC MOSFET 的栅极和漏极之间并接外部电容 Cgdext 的方式，增大 Cgd的值可有效降低 SiC MOSFET 的开关速度，同时不会产生过多的损耗。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_013_d92bc39b4a09.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_014_d04c5048a518.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_015_061ecc0e8b40.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_016_3dedfb324b6d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_017_555748aea182.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_018_19b5e45cecb7.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_019_ac10ee9f8396.jpg)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_020_b3635207547e.png)

**声明：此文来源网络，是出于传递更多信息之目的，文中观点仅供分享交流，不代表本公众号立场。转载请注明出处，若有来源标注错误或如涉及版权等问题，请与我们联系，我们将及时更正、删除，谢谢。**

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_021_3ade3c3d8599.jpg)![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的交错并联Boost变换器电压尖峰抑制方法_images\img_022_84aa944feb13.jpg)