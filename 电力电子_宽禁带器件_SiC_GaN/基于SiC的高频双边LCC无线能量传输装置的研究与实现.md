...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_000_b92d7a743bc5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_001_d6c2df1ef22f.png)

其输入功率为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_002_cb55a13a3875.png)

式中 k 为耦合系数。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_003_f15bb31432e7.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_004_3145ca43077b.png)

当只有输出电压 Uo作用时，如图 2(b)所示 Lf1和 Cf1构成并联谐振，L2和 C2、Cf2构成并联谐振。因此，此时流过 Lf2、L1的电流 If2,b、I1,b均为 0。流过 Lf1和 L2 的电流可由下式计算得到

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_005_70890986b761.png)

当同时考虑输入电压 Ui 和输出电压 Uo 的作用时，电路的响应为两种电压独立作用下响应之和，可得输入和输出电流为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_006_a49289c35276.png)

从式(7)可以看出，输出负载电流 If2 的大小与M、Ui、Lf1和 Lf2有关，与负载电阻 RL无关，因此双 LCC 补偿的 WPT 系统工作在谐振频率之下可以获得与负载无关的恒流输出。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_007_b8034a05b9a9.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_008_2c464a126fa3.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_009_5c2b53b85de2.png)

最终，得到输入阻抗 Zin为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_010_057c325a171a.png)

经拉氏变换得到输入阻抗的传递函数模型GZin(s)，其中 bm、an为谐振电路中电感电容计算得到的参数

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_011_f7d94f57b106.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_012_e99dffc924a1.png)

通过式(1)计算得到两端并联补偿电容 Cf1、Cf2的值

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_013_d7365684ba8d.png)

再计算两端串联补偿电容 C1、C2的值

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_014_a5e26d3f2ab1.png)

2\.  双 LCC 型 WPT 系统性能分析

2.1 双 LCC 型输入阻抗幅频与相频特性

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_015_0ba7f89e9b48.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_016_66ee90118e43.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_017_fe2ce38168e0.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_018_4c74c5b199ee.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_019_1835f4e56183.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_020_a8f508e953a7.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_021_a8f5badb1c6d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_022_8b7e34135d73.png)

图 11 为 48 V 供电时发射线圈 L1 的谐振电压UL1波形，其峰值电压约为 650 V，波形平滑接近于正弦波，具有良好的滤波效果且不受负载的影响。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_023_6f6d9e265176.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_024_e1acfa231986.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_025_41714a59059e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_026_318ead5d55de.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信：18126115420，并备注单位+姓名+研发方向。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_027_3ade3c3d8599.jpg)![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC的高频双边LCC无线能量传输装置的研究与实现_images\img_028_84aa944feb13.jpg)