...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_002_2ee4c49b4bf9.png)其中，f是信号的频率，单位为Hz；A是电流环路的面积，单位为m²；I是电流环中的电流幅值，单位为A；R是测量点距离环路的距离，单位为m。
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_003_b2e694d18a82.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_004_553ca104007a.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_005_be499432931a.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_006_1ff5b638cbcc.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_007_a1378b714b61.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_008_558fd65d7e8a.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_009_4843629754f2.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_010_87e6c11bdce6.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_011_d16000da288d.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_012_58a0e90a8ce4.png)

缓冲电阻Rs的作用是对寄生LC振荡电路的振荡过程施加足够的抑制能力，其取值取决于意欲施加的抑制强度和L、C寄生元件的参数，可由下式予以确定 ：

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_013_40c83e6ec26c.png)其中，ξ是抑制因子。通常，ξ的取值在0.5（轻微抑制）到1（重度抑制）之间。寄生参数Lp和Cp的值通常是未知的，但可通过下述方法进行测量 ：
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_014_375aa7b11992.png)RC缓冲电路中的串联电容Cs需要足够大，以便让抑制电阻能在电路谐振期间表现出稳定的谐振抑制效果。如果这个电容的值太大，它在每个开关周期中的充电和放电过程就会导致过大的功率消耗。所以，Cs的取值通常以电路寄生电容的值的3~4倍为宜。
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_015_c467601e792d.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_016_58b1d22297fa.png)

  

测试所用的板子有两个版本，一个具有完整的地铜箔层，一个没有。板上设置了多种可选配置，如LC输入滤波器，不同的输入电容放置位置，可选的Rboot、RC缓冲电路和输出端LC滤波器。具有这些不同选项的PCB设计显示在下图中。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_017_66ef23716de7.png)

  

测试设备的配置如下图所示。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_018_1fe28ca3e562.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_019_5360312d0d33.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_020_61bef8868e09.png)

  

我们首先通过测量输入线上的共模电流来对辐射噪声做一次常规的检查。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_021_ba86d9a1c86c.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_022_721585a457a8.jpg)

  

假如将同样的测试在背面为地线层的板子上进行，我们将看到这种拥有地线层的大型CIN回路带来的辐射要远低于单面板上的结果，开关切换所带来的振铃信号也要低一些。参见下图。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_023_811c38958947.jpg)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_024_b451bb2516d4.png)

开关切换过程中的过冲和振铃信号的幅度都降低了大约50%，辐射的强度下降了大约10dB，频带宽度扩展到了300MHz。

  

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_025_92285ca256d5.jpg)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_026_d952020ee5fb.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_027_3f0619591080.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_028_476d4085b6e9.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_029_e2a015d9e7e0.png)

采用了上述的方案以后，单面板上的开关切换波形上的过冲已经完全消失，经环形天线检测到的辐射噪声也很低，它在经过FFT运算后得到的波形几乎都在本底噪声水平上。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_030_2911d3dfffcc.png)

假如我们在这个时候再用高频电流探头对输入线上的共模电流进行测量，我们将可看到共模噪声已经下降很多。与第一次测量的结果相比，某些频率上的差异多于30dB，说明整个板子的辐射水平已经很低了。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_031_6af2996b0473.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_032_86a257c5741d.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_033_45fcb89ecb72.png)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_034_c73dc0c195f5.png)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_035_ee57d3c03ccf.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_036_91a891936b87.png)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_037_3ddfae4f9cf1.png)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_038_a1cd1897802b.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_039_6800b281cd52.png)

为了作为参照，首先在没有Rboot和RC缓冲抑制电路的情况下对输入线上的共模电流进行测试。

开关切换波形显示出5V的过冲，过冲信号的振荡频率为238MHz；输入线上的共模电流显示出明显的高频噪声。参考下图。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_040_85d1a517c9a0.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_041_7ad33c90f991.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_042_51d7b5675c3b.png)RS可由公式进行计算。我们选择ξ = 0.5，于是RS = 9.1Ω，我们选择其为8.2Ω。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_043_1211e0cde5d2.png)CS应为4xCP，所以是330pF。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_044_e2c1d9e86b1e.png)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_045_4062fed9cd8f.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_046_7fa51265b2c5.png)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_047_69dfb08470bb.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_048_7eee5b97ae55.png)

  

2.确定开关切换回路的VIN和GND节点位置，将不同尺寸的输入电容尽可能靠近这些节点，最小的电容靠节点的位置要最近。由于这个切换回路承载了很高的电流变化率dI/dt，因而需要尽可能地小。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_049_d3e50e7f5293.png)

  

3.将输出电容地放在不与输入电容切换路径发生重叠的地方，避免高频噪声串入输出电压中。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_050_1a3a1f883790.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_051_802de52b35bb.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_052_625c93f68ec8.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_053_ef616f5c6e9c.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_054_b01aa020f6b4.png)

现在将电缆穿过铁芯就可以对其中的高频电流进行测量了，电流变压器的输出可以接入频谱仪或是示波器（使用50Ω端口）。

为了将测试工具和测试对象隔离开，最好是在电缆上加一个共模线圈，这可通过将引入分析装置的电缆多次穿过一个扣合式的EMI铁芯来实现。

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_055_af9d6b705def.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_056_579ac7d171f9.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_057_fd0391914198.png)
...
![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_058_58147eba07eb.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_059_9b53a964efd5.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_060_75db8c1036fb.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_061_0b6ae33611dc.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_062_365c6cd9f8bb.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_063_2da1ccbac0ae.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_064_7446ffe5e3b8.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_065_d246b538f592.gif)

![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_066_3352ab08e99b.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_067_0f89804cd7eb.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_068_f506b795c6ac.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_069_97df29bd0f50.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_070_d7c6fe8cd645.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_071_19e2f7b6262a.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_072_08d092bef8a0.gif) ![](D:\电脑文件\公众号知识库\电磁兼容_EMC\EMC整改好难_理论_案例给你讲透了__images\img_073_50889e54acde.gif)
