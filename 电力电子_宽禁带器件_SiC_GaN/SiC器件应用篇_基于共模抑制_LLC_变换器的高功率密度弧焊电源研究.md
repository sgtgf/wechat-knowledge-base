...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_000_892737413984.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_001_04c5490be84f.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_002_b432617d171c.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_003_861e853e3ddf.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_004_a2656783400f.png)

该模型表明,共模电流的大小直接取决于原、副边端口对地电压变化率的差值。因此,若能实现所有端口对地电压的变化率保持一致,则共模电流在理论上便可被完全抵消。  

2.2传统 LLC变换器共模噪声分析

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_005_81b672a32691.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_006_7d46cb1a390a.png)

由于输出电压 Vo为常量,因此,在该区间内变压器各端口的电压变化率可表示为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_007_4ca2fd1668d5.png)

结合式(1)和式(3)计算可得,该区间内变压器产生的共模电流 ICM\=0。  

t1~t2区间:由于 Vdc向负载供电,变压器的等效电路模型未发生变化,因此该过程中变压器产生的共模电流与前一区间相同,即 ICM\=0。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_008_441d843f3c88.png)

t2~t3区间:该区间内的变压器的等效电路模型如图 6所示,此阶段原边开关管全部关断,谐振电流对开关管的寄生电容进行充放电。此时,变压器原边端口电压 VP1和 VP2不再是固定值,而是随谐振电感和电容上的电压变化。其关系可表示为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_009_8101dbcb6755.png)

而副边电压仍被钳位,变化率为零。因此,原边电压变化率不为零。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_010_0c28ca28ea60.png)

将式(5)代入式(1)计算,此阶段将产生显著的共模电流,即

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_011_9fda8c79eb1e.png)

这表明,传统 LLC变换器在该阶段内会产生严重的共模噪声。  

2.3所提变换器的共模噪声抵消机制

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_012_f3793e359bf6.png)

所提出的变换器中两个变压器采用串联连接,其电路结构可等效为图 7。  
  
t0~t2区间:其工作状态与传统 LLC变换器相同,变压器端口电压被钳位,电压变化率为零,因此ICM\=0。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_013_24832bdffd6b.png)

t2~t3区间:该区间内的变压器的等效电路模型如图 8所示。由于两个谐振腔参数完全对称,其两端电压满足

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_014_d5ae3a613db0.png)

这种对称性导致变压器原边两个端口对地电压被精确地钳位在固定的电位上,而与谐振过程无关。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_015_e597197c7623.png)

由于 Vo与 Vdc为常量,因此在整个开关周期内,变压器所有原、副边端口对地电压的变化率恒为零。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_016_6069ab0d59dd.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_017_82b832f657fb.png)

2.4仿真对比验证  

为验证上述理论分析,基于表 2的设计参数,对传统 LLC变换器与所提变换器进行了仿真对比。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_018_818cc8fba334.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_019_1be7172680db.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_020_3ec37771cfb3.png)

3.2电源样机搭建

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_021_892a25ac68c2.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_022_2490b6cd2151.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_023_f5c628515456.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_024_890851d3a391.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_025_c0340da312c1.png)

针对气体保护焊对电源恒压特性的要求,测试了电源在不同负载条件下的外特性曲线。如图 14所 示,当设定输出电压为 29、31.5、35.5V时,随着输出电流增大,输出电压均保持稳定,未出现明显跌落,符合恒压源的外特性要求,满足实际焊接工艺需求。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_026_c4e29dfa3be5.png)

图 15展示了电源在不同输出功率下的效率曲线。结果表明,当输出功率接近 2kW时,电源峰值效率达 96.3%,而随着输出功率增加,效率曲线呈现缓慢下 降趋势,直到满负载运行时效率为88.6%。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_027_26e260525122.png)
...
![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_028_d65fd5a71824.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请加微信：18126115420，并备注单位+姓名+研发方向。

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_029_d4a470c5eda2.jpg)

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_030_c1a7154d0067.jpg)

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_基于共模抑制_LLC_变换器的高功率密度弧焊电源研究_images\img_031_4473dae8d5b9.jpg)