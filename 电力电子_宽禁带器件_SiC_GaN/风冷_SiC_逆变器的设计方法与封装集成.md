...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_000_5e4b65abf350.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_001_5ee16872d645.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_002_f61f76a4b88f.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_003_ccd51b2c3a00.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_004_06c538c6f424.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_005_6c859c3d839d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_006_a5cfa43e7c40.png)

以市场上常用的EconoPACK 封装SiC 功率模块为例进行分析，模块的布局和结构如图 7 所示。功率模块内的电流场可以表示为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_007_39a1f0183f63.png)

式中：电场强度 U 是电势的梯度；J 为电流密度；为材料的电导率。

J 的梯度可以表示为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_008_b988954c8953.png)

由于功率模块的多层结构，各层材料的热膨胀系数难以一致，会导致功率模块内产生机械应力。总的应力由2部分组成：一部分，T由工作温度引起；另一部分，E由弹性张力引起，有：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_009_0893ac578e7f.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_010_3f6c42ce223f.png)

综上，在功率模块内部，电热力之间相互耦合，如图8 所示。在已知边界条件的基础上，根据式(1)—(11)，可以用有限元分析(finite elementanalysis，FEA)工具，研究功率模块内的电热力分布规律。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_011_06d43cd3afd4.png)

在本文的研究中，采用Hestia 的SiC MOSFET芯片H1M120N060和SiC SBD 芯片 H2S120N060，芯片参数如表 1 所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_012_cff2ea02d271.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_013_2c501252d48d.png)

采用FEA 分析方法，研究SiC 功率模块内的多物理场应力分布，功率回路的负荷电流设置为20A/50Hz 的交流电，每个SiC 芯片的损耗为10W。功率模块的基板底部固定。稳态情况下，功率模块的应力分布如图 9 所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_014_7c6516c898e4.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_015_fcb9a108037a.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_016_da2336a14acf.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_017_28949e57ae0c.png)![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_018_d901616821a0.png)

对于逆变器的应用，薄膜电容通常是性价比更高的解决方案。

根据上述公司的数据手册，电容的纹波电流耐受能力如图 11(b)所示。电容的纹波电流耐受能力Icrms 可以表示为容值 C 的二次函数，即

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_019_c6aa7e61b9fa.png)

式中 a1、a2和 a3 为常数，根据图 11(b)，可以得到这些参数的估计值，

如表 3 所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_020_bcce241d0189.png)

除额定电压外，电容的纹波电压和纹波电流都应满足逆变器直流侧的工作条件。

考虑逆变器的纹波电压，所需要的最小电容Cv 可以表示为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_021_a4691e6e0da2.png)

对于纹波电压，图12 给出vdc、fs、m 对直流母线电容优化选择的影响规律。可以发现，较高的开关频率 fs 和较低的调制度 m，可以显著降低逆变器对直流母线电容的需求。此外，通过使用具有高纹波电压耐受能力的电容，也可以减小直流母线电容。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_022_3759c23c77ba.png)

此外，直流母线电容还需要承受 SiC 器件开关引起的纹波电流。电容的最小纹波电流能力 Ipmin，可表示为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_023_42da1f3501ac.png)

根据表4 提供的SiC 逆变器参数，当Cdc10F时，线电压、相电流、纹波电压、纹波电流的仿真结果如图13 所示，纹波电压和纹波电流值分别为10V 和7.2A。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_024_0e70afebcfdf.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_025_3011388c9934.png)

对于纹波电流，图14 给出使用不同材质电容时所需的最小电容值。与电解电容相比，采用陶瓷电容和薄膜电容，直流母线电容的容值需求可以降低90%以上。薄膜电容和陶瓷电容具有良好的纹波电流特性，对于降低直流母线的复杂度非常有价值。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_026_069f658a39a4.png)

为了选择直流侧电容 Cdc，需要同时满足纹波电压和纹波电流的要求，有

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_027_af712175827b.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_028_617cf03f62ff.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_029_7752dcf90021.png)

**3.3 散热器的优化设计**

SiC 逆变器输出功率为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_030_1b2304335f45.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_031_8a2c10cbc83b.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_032_46df2d6024bd.png)

式中ton、toff和 trec分别为SiC 开通、关断和反向恢复的时间。

因此，可以得到SiC MOSFET 和 SiC SBD 在各个周期内的平均功率损耗：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_033_599473faf7b0.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_034_b769e1d99eb3.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_035_84aaedb5a08a.png)

在不同芯片尺寸条件下，不同散热器齿数、齿宽度、齿高度和材料对散热器热阻的影响如图18所示。可以发现，采用大的芯片尺寸有助于降低散热器的热阻。

根据仿真结果，在芯片尺寸为100%的情况下，建立散热器的热阻模型，具体表示如下：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_036_d77c7fa1b9b4.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_037_9603c932b4fb.png)

强制风冷散热器的换热系数 hc由风速 va确定，经验公式如式(24)所示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_038_bc1590b6326c.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_039_935771873cbe.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_040_2616efc49c35.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_041_309e4488ce57.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_042_24de5da81be9.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_043_b0765917364c.png)

**4.3 SIC 逆变器的实验结果**

对于所研制的风冷SiC 逆变器，图25 给出线电压和相电流的典型实验测试结果，测试条件为：直流母线电压 600V，输出线电压有效值320V，调制比为 0.9，开关频率为50kHz，阻感负载(电阻R10，电感 L1mH)。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_044_2f7894193799.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_045_b0036173950d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_046_04881ab85e41.png)

声明：此文来源网络，是出于传递更多信息之目的。若有来源标注错误或侵犯了您的合法权益，请与我们联系，我们将及时更正、删除，谢谢。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\风冷_SiC_逆变器的设计方法与封装集成_images\img_047_7e5f65a94641.png)