...
Mehrage Ghods1; Jawad Faiz1; Hamed Gorginpour2
...
**摘 要**
目前，学术界对提出用于电动汽车等领域的现代永磁电机结构有着很高的研究兴趣。为了提高永磁游标电机（PMVM）的功率因数、效率、转矩、转矩密度和更宽的恒转矩-速度区域等性能，介绍了几种在定子和转子中不同排列方式的永磁游标电机（PMVM）径向和轴向拓扑结构。与此同时，辐形PM布置比表面和V形布置具有更高的扭矩密度。相比之下，V形排列具有更大的正弦磁通和更小的齿槽转矩。本文设计了一个带有分数槽排列的620 W，12槽16极游标永磁电机。实验结果表明顺向K形磁极具有辐形和V形磁极的优点。基于以上分析，本文提出了顺极K型磁极排列结构，并引入了基于谐波分析方法的解析建模，以准确预测机器的性能，最后对所提出的结构进行了原型设计，并对实验结果进行了仿真和建模比较。  
**Abstract**
...
**作者信息**
**Mehrage Ghods**，于2017年在伊朗德黑兰的谢里夫理工大学（Sharif University）获得电气工程硕士学位。目前正在伊朗德黑兰大学（University of Tehran）攻读博士学位。研究兴趣包括电动汽车/混合动力汽车和低速风力发电机用新型永磁电机及其驱动系统的设计与控制，以及可再生能源系统。
**Jawad Faiz**，于1988年在英国纽卡斯尔大学（University of Newcastle upon Tyne）获得电气工程博士学位。目前是伊朗德黑兰大学（University of Tehran）的杰出教授，是伊朗科学院院士，欧洲地中海艺术与科学学院成员，IEEE高级会员。担任IEEE Transactions on Energy Conversion编辑。研究兴趣包括电机和变压器的设计、分析及故障诊断。在国际期刊上发表了320多篇论文。
**Hamed Gorginpour**，于2009年和2014年分别在伊朗德黑兰的谢里夫理工大学（Sharif University of Technology）获得电气工程硕士学位和博士学位。目前是伊朗布什尔波斯湾大学（Persian Gulf University）智能系统工程与数据科学系的副教授。研究兴趣包括电机设计与建模、有限元分析以及电力电子与驱动。
★
