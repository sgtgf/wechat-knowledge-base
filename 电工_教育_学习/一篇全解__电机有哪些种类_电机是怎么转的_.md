# 一篇全解: 电机有哪些种类？电机是怎么转的?

原创 电机新视界 2025-01-16 12:00 上海

> 原文地址: [https://mp.weixin.qq.com/s/\_DEii8QSuT05lQbgdBCXLg](https://mp.weixin.qq.com/s/_DEii8QSuT05lQbgdBCXLg)
...
在这种情况下，线圈采用Y形接法，使用半导体元件为线圈供给电流，根据旋转的磁体位置来控制电流的流入和流出。https://www.dgdqw.com在该示例中，使用霍尔元件来检测磁体的位置。霍尔元件配置在线圈和线圈之间，根据磁场强度检测产生的电压并用作位置信息。在前面给出的FDD主轴电机的图像中，也可以看到在线圈和线圈之间有用来检测位置的霍尔元件（线圈的上方）。
...
步进电机是线圈固定、永磁体旋转的结构。右侧的步进电机内部结构概念图是使用两相（两组）线圈的PM电机示例。https://www.dgdqw.com在步进电机基本结构示例中，线圈配置在外侧，永磁体配置在内侧。线圈除了两相外，还有三相和五相等相数较多的类型。
