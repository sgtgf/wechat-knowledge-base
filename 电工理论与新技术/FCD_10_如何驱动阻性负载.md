...
![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_000_12a2ef0073c1.png)
...
![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_001_d492f36facdc.png)
...
![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_002_9ec134d08f9e.png)

MCU输出调制PWM信号，控制高侧开关脉宽，以一定的速率开启和关闭设备，产生有效平均电流，根据占空比D在公式3中计算，当PWMing使能时，存在相关的功率损耗。

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_003_62fb8a2ad8e4.png)
...
![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_004_627dd7bc0688.png)

**_图10-1：分立电流测量的实现_**

智能高端开关在大多数设备上都具有非常高的电流检测精度，例如在负载≥1A时具有±3%的精度，它不仅减少了系统中所需的部件数量，误差也更小。

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_005_60a21dfeeba7.png)
...
![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_006_14f110af5bb7.png)

数据表中的RθJA（结与环境热阻）是根据JEDEC标准定义的特定板布局所测得的，热性能会因不同的电路板布局而变化，但可以作为很好的第一近似值。计算结温度TJ，取环境温度TA加上功率耗散乘以RθJA，如公式5所示：

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_007_68249c1888c7.png)
...
![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_008_bbf3f05c9de0.png)
...
![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_009_ad398ea86ac9.png)
...
![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_010_c8e22756943f.png)

这是一个通道的切换损耗，如果器件有一个以上的通道，则总损耗=开关损耗+FET导通损耗乘以通道数量：

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_011_d3086ef66416.png)

将总功耗使用方程5来计算结温度，以确认器件是否能够成功地驱动该负载，如果结温度低于热关闭阈值，则该器件可以向负载输送功率。

_____€5.计算实例_____

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_012_2b3c3df6c60c.png)
...
![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_013_6f16eb2045be.png)

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_014_c486a44940c1.png)

Step2：使用等式4计算每个通道在正常操作期间的开关功耗，Ron值来自TPS2HB16-Q1数据表中的“导通电阻Ron-温度”图，另外只要占空比不动态变化，通过开关的平均功耗将与用占空比计算的稳态电流相关。

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_015_8de1a97f1ea0.png)![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_016_719b91e50998.png)

Step3：计算开关损耗，在TPS2HB16-Q1数据表中，EON被定义为0.4mJ，EOFF也被定义为0.4mJ，使用方程6可以找到器件的开关损耗。

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_017_6d49b522c759.png)

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_018_4bf77cb4134f.png)

**_图10-5_**显示了RH1的切换，蓝色波形为使能信号，绿色为VBB，黄色为VOUT，紫色为IOUT，在**_图10-6_**中，白色为开关的VDS，红色波形是由此产生的功率耗散和开关损耗。

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_019_37e15845841d.png)

**_图10-5.测量的开关波形_**

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_020_fe4151b36b61.png)

**_图10-6.测量的开关损耗波形_**

Step4：把设备中的所有损耗加起来就得到了总功耗。

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_021_18f3dbb4c517.png)

确定了总功率耗散，可以使用等式5来计算结温度：

![](D:\电脑文件\公众号知识库\电工理论与新技术\FCD_10_如何驱动阻性负载_images\img_022_0711ddf931e9.png)
