...
![](基于动态建模与重构的列车轴承故障检测和定位_images/img_000_fc616940208a.png)

法国TGV高速列车

![](基于动态建模与重构的列车轴承故障检测和定位_images/img_001_a5dd8279322d.png)

德国ICE城际列车

![](基于动态建模与重构的列车轴承故障检测和定位_images/img_002_556fdd868ed1.png)
...
![](基于动态建模与重构的列车轴承故障检测和定位_images/img_003_510509b96f51.png)
...
![](基于动态建模与重构的列车轴承故障检测和定位_images/img_004_88327d406dab.png)

  

作者简介

![](基于动态建模与重构的列车轴承故障检测和定位_images/img_005_7dd838e5a6bf.png)

刘强, 东北大学教授. 主要研究方向为大数据建模、统计过程监控与故障诊断. 曾获辽宁省优秀博士学位论文奖, 中国自动化学会优秀博士学位论文提名奖等. 本文通信作者. 

E-mail: liuq@mail.neu.edu.cn

![](基于动态建模与重构的列车轴承故障检测和定位_images/img_006_e3bdd0acd612.png)

方彤, 东北大学硕士研究生. 主要研究方向为统计过程监控与故障诊断. 

E-mail: 1770520@stu.neu.edu.cn

![](基于动态建模与重构的列车轴承故障检测和定位_images/img_007_3522fca43262.png)
...
![](基于动态建模与重构的列车轴承故障检测和定位_images/img_008_1bc0dc4e3301.png)
...
![](基于动态建模与重构的列车轴承故障检测和定位_images/img_009_6b62842c89b7.png)

![](基于动态建模与重构的列车轴承故障检测和定位_images/img_010_63d3380f3132.jpg)

JAS《自动化学报》（英文版）

![](基于动态建模与重构的列车轴承故障检测和定位_images/img_011_6b62842c89b7.png)

![](基于动态建模与重构的列车轴承故障检测和定位_images/img_012_628ee1856220.jpg)

自动化学报服务号

![](基于动态建模与重构的列车轴承故障检测和定位_images/img_013_6b62842c89b7.png)

![](基于动态建模与重构的列车轴承故障检测和定位_images/img_014_8528ba88a704.jpg)
