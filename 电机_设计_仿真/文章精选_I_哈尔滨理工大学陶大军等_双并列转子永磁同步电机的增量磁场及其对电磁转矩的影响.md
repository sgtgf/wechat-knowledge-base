# 文章精选 I 哈尔滨理工大学陶大军等：双并列转子永磁同步电机的增量磁场及其对电磁转矩的影响

原创 CES TEMS编辑部 CES电机与系统学报 2025-07-14 07:00 北京
...
双并列转子连体定子永磁同步电机的耦合效应不仅影响耦合区内磁场，还会在隙中产生增量磁场，本文对增量磁场特性及其对电磁转矩的影响展开研究。简述电机的拓扑结构及参数，通过建立两种边界条件下的仿真模型，证明增量磁场的存在，并总结增量磁场的分布规律；对增量磁场特性进行分析，探明增量磁场的来源，建立其解析模型，探讨关键参数对增量磁场的影响；在此基础上，研究增量磁场对电机电磁转矩的影响，构建增量转矩解析表达式，分析其波动规律，提出增量磁场分离模型进行仿真验证；理论和仿真结果揭示和完善了通过优化占空角和耦合间距能够削弱电机转矩脉动的内在机理。最后，研制一台双并列转子连体定子永磁同步电机，搭建试验平台，验证所提理论的正确性和有限元模型的准确性。  
