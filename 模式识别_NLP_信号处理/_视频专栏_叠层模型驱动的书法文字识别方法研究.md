...
原创 自动化学报 自动化学报 2024-11-07 17:00 北京

> 原文地址: [https://mp.weixin.qq.com/s/3QFakcco71E1xBJk6aVsvg](https://mp.weixin.qq.com/s/3QFakcco71E1xBJk6aVsvg)

![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_000_f76a7fe84cb4.png)

点击上方**蓝字**关注我们

  

麻斯亮, 许勇. [叠层模型驱动的书法文字识别方法研究](http://www.aas.net.cn/cn/article/doi/10.16383/j.aas.c230460). 自动化学报, 2024, 50(5): 947−957

1

摘要

       基于二维图像的书法文字识别是指利用计算机视觉技术对书法文字单字图像进行识别, 在古籍研究和文化传播中具有重要应用. 目前书法文字识别技术已经取得了相当不错的进展, 但依旧面临很多挑战, 比如复杂多变的字形可能导致的识别误差, 汉字本身又存在较多形近字, 且汉字字符类别数与其他语言文字相比更多, 书法文字图像普遍存在类内差距大、类间差距小的问题. 为解决这些问题, 提出叠层模型驱动的书法文字识别方法(Stacked-model driven character recognition, SDCR), 通过使用数据预处理、节点分离策略和叠层模型对现有单一分类模型进行改进, 按照字体类别对同一类别不同字体风格的文字进行二次划分; 针对类间差距小的问题, 根据书法文字训练集图像识别置信度对形近字进行子集划分, 针对子集进行嵌套模型增强训练, 在测试阶段利用叠层模型对形近字进行二次识别, 提升形近字的识别准确率. 为了验证该方法的鲁棒性, 在自主生成的SCUT\_Calligraphy数据集和CASIA-HWDB 1.1, CASIA-AHCDB公开数据集上进行训练和测试, 实验结果表明该方法在上述数据集的识别准确率均有较大幅度提升, 在CASIA-HWDB 1.1、CASIA-AHCDB和自建数据集SCUT\_Calligraphy上测试准确率分别达到96.33%、99.51%和99.90%, 证明了该方法的有效性.
...
![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_001_42df95107fe9.jpg)
...
![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_002_00eb09b6bd43.jpg)
...
本文的主要贡献和创新点包括以下两方面: 一是基于文本标签及不同书法字体生成了包含3767类常用汉字的SCUT\_Calligraphy书法文字数据集, 其中训练集和测试集规模分别为251664和26106. SCUT\_Calligraphy数据集与现有数据集相比图像质量更高, 包含更多类型的字体和样式, 提供更准确的标注, 覆盖更多汉字类别. 二是提出了叠层模型驱动的书法文字识别方法, 对训练数据中同一类字中字形差异较大的图像数据进行节点分离, 在测试阶段进行节点合并, 有效解决了书法作品中一字多形导致的识别错误; 对形近字子集使用叠层模型进一步提取细粒度特征, 提升小类别范围内的识别准确率, 进而提高大类别场景的书法文字识别准确率, 并能够拓展应用到其他大类别数分类任务中. 综上所述, 本文从数据获取和模型设计的角度重新思考书法文字识别问题, 通过提升训练数据质量和改进模型构造方式来提升书法文字识别性能, 不再局限于单模型的性能优化, 充分提升了书法文字识别性能. 
...
![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_003_51820040135e.svg)
...
![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_004_51820040135e.svg)
...
[![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_005_1bb52a8adeef.jpg)](http://www.aas.net.cn/)

[![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_006_8059e67d1866.jpg)](http://www.ieee-jas.net/)

  

![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_007_409e145c41f9.gif)

![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_008_409e145c41f9.gif)

![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_009_e7e64a650744.jpg)

![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_010_409e145c41f9.gif)

![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_011_409e145c41f9.gif)

**长按二维码｜关注我们**

**IEEE/CAA Journal of Automatica Sinica (JAS)**

![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_012_409e145c41f9.gif)

![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_013_409e145c41f9.gif)

![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_014_d1e21947407a.jpg)

![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_015_409e145c41f9.gif)

![](_视频专栏_叠层模型驱动的书法文字识别方法研究_images/img_016_409e145c41f9.gif)
