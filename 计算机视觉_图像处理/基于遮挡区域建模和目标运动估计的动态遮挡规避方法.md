...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_000_a382f83c0897.png)
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_001_6db9bd3ebcef.png)
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_002_f6e9714928f5.png)
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_003_56eff6d86b63.png)

张世辉 燕山大学信息科学于工程学院教授。主要研究方向为视觉信息处理，模式识别，智能机器人。

E-mail: sshhzz@ysu.edu.com

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_004_ec5b9c3978a7.png)

何琦 燕山大学硕士研究生。主要研究方向为计算机视觉和模式识别。

E-mail: heqi0109@126.com

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_005_0431f907c21f.png)

懂利健 燕山大学硕士研究生。主要研究方向为计算机视觉和模式识别。 

E-mail: donglijian8087@163.com

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_006_ecb8348da6f8.png)
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_009_8b8f981afbf6.png)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_008_3c4b1a86086b.jpg)

JAS《自动化学报》（英文版）

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_007_8b8f981afbf6.png)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_010_975a6db8ea81.jpg)

自动化学报服务号

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_011_8b8f981afbf6.png)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于遮挡区域建模和目标运动估计的动态遮挡规避方法_images\img_012_37aa0212f777.jpg)
