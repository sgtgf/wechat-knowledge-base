...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_005_76a1b93e473f.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_009_76a1b93e473f.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_002_4904a22796d4.jpg)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_001_76a1b93e473f.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_008_76a1b93e473f.gif)
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_006_76a1b93e473f.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_014_76a1b93e473f.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_007_87dc169bbf64.jpg)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_013_76a1b93e473f.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_010_76a1b93e473f.gif)
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_003_76a1b93e473f.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_004_76a1b93e473f.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_012_4299d6fbd07a.jpg)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_000_76a1b93e473f.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_011_76a1b93e473f.gif)
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_015_8ca81e0d730d.jpg)

  

为了更清楚的对比几种实验方法的标注效果，表2提供了VOC 2007数据集中部分图像的标注示例。

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_016_3743ecf1a528.gif)

  

_**表2 图像标注示例**_

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_017_8222be60ef39.jpg)
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_018_3743ecf1a528.gif)

  

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_019_76a1b93e473f.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_022_76a1b93e473f.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_021_1639ba8bb7ce.jpg)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_020_76a1b93e473f.gif)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_023_76a1b93e473f.gif)
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_024_bb71ca4600ae.png)
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_025_aa194b386069.png)
...
![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_026_a7aa5f908ad9.png)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_027_df161c49419b.jpg)

**JAS《自动化学报》（英文版**）   

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_028_a7aa5f908ad9.png)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_029_85d6de73ce3a.jpg)

**《自动化学报》服务号** 

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_030_a7aa5f908ad9.png)

![](D:\电脑文件\公众号知识库\计算机视觉_图像处理\基于形式概念分析和语义关联规则的目标图像标注_images\img_031_8a192236970d.jpg)
