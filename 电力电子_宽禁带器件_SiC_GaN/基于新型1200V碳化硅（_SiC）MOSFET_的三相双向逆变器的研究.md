...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_000_e5c41447d5f3.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_001_ba29b0a3bdd9.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_002_5819310ff22b.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_003_bb808222f2f9.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_004_0076401e676d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_005_d4eb9e18ac40.png)

2.2 碳化硅 MOSFET 第 3 象限工作特性

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_006_1b9cbc028e2f.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_007_49df324a257f.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_008_f114f2d51efa.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_009_c0478000be8b.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_010_b7855e807b0e.png)

3.2 逆变器样机效率测试

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_011_c23467e06a2e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_012_ea80133b56be.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_013_0245ea0bfe00.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_014_88d2d6ec7f90.png)
...
![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_015_6f3582a6655d.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信：18126115420，并备注单位+姓名+研发方向。

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_016_3a454be1818c.jpg)

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于新型1200V碳化硅（_SiC）MOSFET_的三相双向逆变器的研究_images\img_017_7038903c64cb.png)