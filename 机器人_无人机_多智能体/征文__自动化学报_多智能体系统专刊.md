...
原创 自动化学报 自动化学报 2024-03-26 17:00 北京

> 原文地址: [https://mp.weixin.qq.com/s/Yrg1e1dPGSoWW8KmZEo57w](https://mp.weixin.qq.com/s/Yrg1e1dPGSoWW8KmZEo57w)

     多智能体系统由多个具有一定传感、计算、执行能力的个体组成，个体通过信息传递，相互合作协同完成复杂任务。每个智能体具有一定的独立性和自主性，能够自主学习、推理和规划并选择适当的策略解决子问题。通过多个具备简单智能的个体协作和交互实现复杂的智能，多智能体系统在降低单个智能体复杂程度的同时，有效提高了整个系统的鲁棒性、可靠性和灵活性。

  

近年来，随着通信、计算和网络技术的快速发展，多智能体系统在交通运输、工业生产等多个领域都有广泛和深入的应用。多智能体系统是人工智能和自动化等学科的前沿与热点研究领域，累积了大量研究成果。随着人工智能、大数据、工业互联网、移动通信、云计算和信息物理系统等领域的发展，越来越多的大规模复杂问题涌现，给多智能体的研究提出了新的挑战。

  

为促进多智能体系统相关理论方法、技术与应用研究的深入开展，及时反映相关领域具有创新性、突破性的研究成果，《自动化学报》特邀孙长银教授、孙健教授、杨涛教授、易新蕾研究员主持“多智能体系统”专刊。欢迎专家学者踊跃投稿。
...
孙长银（安徽大学）、孙健（北京理工大学）、杨涛（东北大学）、易新蕾（Massachusetts Institute of Technology）
...
1\. 请登陆《自动化学报》[在线投审稿系统](https://mc03.manuscriptcentral.com/aas-cn)，投稿时在专刊名称中选择“多智能体系统专刊”。

2\. 格式体例可参照《自动化学报》已出版论文，投稿注意事项请见《自动化学报》“[投稿须知](http://www.aas.net.cn/news/tgxz.htm)”。
