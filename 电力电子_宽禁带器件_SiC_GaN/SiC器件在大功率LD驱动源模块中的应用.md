...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件在大功率LD驱动源模块中的应用_images\img_000_3eeedba56d48.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件在大功率LD驱动源模块中的应用_images\img_001_6aafb76f9386.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件在大功率LD驱动源模块中的应用_images\img_002_2ad807fffcf0.png)

图 １为本文设计的高效可靠SiC MOSFET隔离驱动电路示意图，使用超快 MOSFET驱动芯片，其驱动峰值电流达到9A且有较强的驱动电容负载的能力。驱动电路用隔离电源模块和隔离通信芯片实现了驱动部分的全隔离，加强了驱动的抗干扰能力。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件在大功率LD驱动源模块中的应用_images\img_003_710ce386e586.png)

图２为驱动波形，驱动电压选择-3.3Ｖ/＋15Ｖ，驱动电阻RG为 6.2Ω；图 ２（ｂ）、２（ｃ）分别为驱动波形的上升沿和下降沿，驱动波形上升时间和下降时间均在80ns以下。

4 四路交错并联LD驱动模块

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件在大功率LD驱动源模块中的应用_images\img_004_b7e3613094d4.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件在大功率LD驱动源模块中的应用_images\img_005_7195eb661d15.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件在大功率LD驱动源模块中的应用_images\img_006_97dc2a0bbfaf.png)
...
![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件在大功率LD驱动源模块中的应用_images\img_007_6f3582a6655d.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信：18126115420，并备注单位+姓名+研发方向。

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件在大功率LD驱动源模块中的应用_images\img_008_ac96c142a2ce.jpg)

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件在大功率LD驱动源模块中的应用_images\img_009_7038903c64cb.png)