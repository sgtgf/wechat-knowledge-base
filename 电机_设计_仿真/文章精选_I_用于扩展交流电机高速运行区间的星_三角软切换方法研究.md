# 文章精选 I 用于扩展交流电机高速运行区间的星-三角软切换方法研究

原创 CES TEMS编辑部 CES电机与系统学报 2024-02-08 07:00 北京
...
**■**[在线阅读](https://ieeexplore.ieee.org/document/10272328)    ****■****[PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10272328)

Y. Shuai, D. Jiang, Z. Chen, Z. Liu, H. Sun and P. Li, "Study of Star-Delta Soft Switch to Extend AC Motor High Speed Operation Region," in CES Transactions on Electrical Machines and Systems, vol. 7, no. 3, pp. 248-255, September 2023, doi: 10.30941/CESTEMS.2023.00049.
...
在牵引应用中，电机的转速范围是电机驱动的一个重要指标。在交流电机控制中，传统的星型绕组三相逆变器的输出电压能力限制了电机的最大转速。在高速范围内将星形连接切换到三角洲连接可以扩展速度范围。许多文献提出的星-三角开关依靠机械继电器来扩展速度运行区域，需要几十毫秒的死区，严重影响转矩输出。另外，传统方法在开关暂态过程中会引起电流过冲，降低了器件的安全性和可靠性。针对星三角硬交换存在的缺陷，提出了一种星三角软交换方法。在不增加额外电力电子器件的情况下，利用直流母线电容提供暂态过程中的零轴电流通路，实现了暂态过程中转矩的平滑输出和零电流切换。通过实验验证了该方法的有效性。在电机驱动中，从星形连接到三角形连接的切换瞬态可以比硬切换方法稳定得多。  
