...
![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_000_a728da844190.gif)
...
![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_001_e4c18b4b0824.jpg)
...
![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_002_d5217e4d54d1.png)
...
![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_003_2f619efd18cc.png)

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_004_b933086381b0.png)

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_005_6014c050b8d7.jpg)

**最终的运动学方程**

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_006_58fe2d8b095f.png)
...
![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_007_8ced1aac8608.png)

图1 局部坐标系下的梁单元

自然坐标系与局部坐标系的关系为![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_008_dadd1fb91388.png) 为了推导自然坐标系下的四个形函数，我们可以将挠度写成![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_009_3e1c62049431.png)的三次多项式

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_010_80a779338b91.png)

写作矩阵的形式  

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_011_58e9f5292c76.png)

在小变形情况下，转角![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_012_2e6f09362845.png)可由挠度微分得到

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_013_45323f5e348d.png)

引入边界条件：

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_014_23b2e23b7980.png)

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_015_859b5c1104fc.png)

可得

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_016_5a0dfaf91068.png)

求解![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_017_31ca6fd698a4.jpg)之后可以得到

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_018_d0aa4601f946.png)

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_019_08b5bc2548a0.png)
...
![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_020_0f7336ee8bc4.png)

得到应变矩阵后，可以求出单元刚度矩阵

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_021_3aad53b1da28.png)

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_022_6e658551c23a.png)

扩展到三维空间梁单元，自由度按以下顺序排列：

首结点 1轴平动、2轴平动、3轴平动、绕1轴旋转、绕2轴旋转、绕3轴旋转；末结点 1轴平动、2轴平动、3轴平动、绕1轴旋转、绕2轴旋转、绕3轴旋转，共12个自由度。因此对应的刚度矩阵为

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_023_edaa2ee9f432.png)

**2、铁木辛柯梁有限元离散**

参考《Matlab有限元结构动力学分析与工程应用-徐斌》梁单元的介绍，Timoshenko 梁单元中，横向位移v和转角是独立的，可各自独立插值，有

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_024_d9bcf24f0d32.png)

式中，N1和N2为线性形函数

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_025_d0509eab1e3d.png)

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_026_cb8aaaf79d56.png)

根据1.1节的几何方程和物理方程，将上述位移表达式带入之后，可得

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_027_ec2b9791510b.png)

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_028_52c4f7060500.png)

因此梁的刚度矩阵为

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_029_e84b7bcad4fd.png)
...
![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_030_b8bdd37b8887.png)

（1）L=5000,H=700,B=300的梁的计算结果

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_031_15d7c6bc2d80.png)

（2）L=5000,H=2700,B=300的梁的计算结果

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_032_3cb36e8e0a6b.png)

（3）L=5000,H=7,B=300的梁的计算结果

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_033_227b3a197c61.png)
...
![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_034_89418b59a278.jpg)
...
![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_035_b95c1c9ad6df.gif)

![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_036_905b0b7bd178.jpg)
...
**喜欢****作者******，请点********赞********和在看******![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_037_ccb6b1d5c075.gif)**

**![](Matlab梁单元有限元编程_铁木辛柯梁VS欧拉梁讲解_images/img_038_3079cfee603e.gif)**