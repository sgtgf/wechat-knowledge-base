...
![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_000_c26d8e550ad4.png)

  

王磊, 乔俊飞, 杨翠丽, 朱心新. 基于灵敏度分析的模块化回声状态网络修剪算法. 自动化学报, 2019, 45(6): 1136-1145.

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_001_7e366538a768.png)
...
![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_002_55bbb69e06b0.png)
...
![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_003_fca1e5483269.png)

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_004_618807d20253.png)

图3 基于PMESN 和 OESN的含噪声的Lorenz时间序列预测结果

  

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_005_61f68e1ef7c9.png)

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_006_b355b1c9d1a8.png)

图4基于PMESN 和 OESN的含噪声的非线性系统辨识预测结果

  

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_007_d20380c3c34c.png)

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_008_7816117fbe0a.png)
...
![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_009_62d8b7a0a531.png)

王磊, 北京工业大学信息学部博士研究生, 主要研究方向为神经网络结构设计与优化.本文通信作者. 

E-mail: jade\_wanglei@163.com

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_010_74816674eda4.png)

乔俊飞, 北京工业大学信息学部教授.主要研究方向为污水处理过程智能控制,神经网络结构设计与优化. 

E-mail: junfeq@bjut.edu.cn

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_011_7ec49e6f018d.png)

杨翠丽, 北京工业大学信息学部讲师. 主要研究方向为神经网络和智能优化算法. 

E-mail: clyang5@bjut.edu.cn

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_012_7415a30059ea.png)
...
![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_013_87a3a3af77cc.png)

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_014_69a96c00c7e1.jpg)

JAS《自动化学报》（英文版）

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_015_87a3a3af77cc.png)

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_016_ad283d92a4b5.jpg)

自动化学报服务号

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_017_87a3a3af77cc.png)

![](北京工业大学乔俊飞教授等_基于灵敏度分析的模块化回声状态网络修剪算法_images/img_018_0b867c878f4a.jpg)
