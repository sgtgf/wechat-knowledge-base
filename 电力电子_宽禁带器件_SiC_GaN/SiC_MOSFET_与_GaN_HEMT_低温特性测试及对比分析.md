...
![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_000_ddeb0f341e58.png)
...
![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_001_28af8cc023bc.png)
...
![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_002_4455a2035076.png)
...
![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_003_9a80f975c330.png)

φst为 MOSFET 处于强反型时的表面势，也是此时的耗尽层压降，其值为 P 衬底费米势 φB 的两倍，可以通过式( 2) 计算:

![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_004_1627f30d0d50.png)

当 MOSFET 处于阈值条件时，氧化层压降 Vox可以通过式( 3) 计算：

![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_005_9b07d489eda3.png)

其中，εs 为半导体介电常数，NA 为受主掺杂浓度。MOSFET 的单位面积栅氧化层电容 Cox可以用式( 4) 计算，tox为栅氧化层厚度:

![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_006_fad1ccba6251.png)
...
![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_007_b436a829fd97.png)
...
![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_008_463375afb056.png)
...
![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_009_34a86323b855.png)

φb 为肖特基势垒高度，可以通过式( 9) 计算:

![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_010_c9a626ad4644.png)
...
![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_011_afeea6d930b9.png)

其中，εSiC为 SiC 介电常数，wD 为击穿发生时的耗尽层宽度，可以通过式( 11) 计算:

![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_012_374c53e1181e.png)

其中 A 和 n 为碰撞电离 Fulop 参数，温度依赖公式( 12) 分别为:

![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_013_c0ebc7bd9f9b.png)
...
![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_017_4cf4b877a5f3.png)
...
![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_018_1324cd826412.png)
...
![](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_019_76d2c79bbae0.png)
...
![图片](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_020_6e67a7a43c84.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信：18126115420，并备注单位+姓名+研发方向。

![图片](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_021_0fc2146c10d8.png)![图片](SiC_MOSFET_与_GaN_HEMT_低温特性测试及对比分析_images/img_022_3a3df320c8e4.png)