...
![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_000_06a022419e66.gif)

**点击蓝字 关注我们**

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_001_06a022419e66.gif)
...
![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_002_d6ce03845960.png)

图 7  基于CF-BLS, BLS, FBLS和HELM的虚拟机性能预测曲线

  

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_003_76a28b6a05c4.png)
...
![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_004_97f70cbcf672.png)
...
![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_005_65c93bb9ae25.png)
...
![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_006_86c7c61d34e2.png)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_007_192bc0b3c788.png)

  

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_008_835d5d8cae6e.gif)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_009_835d5d8cae6e.gif)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_010_d7fea77277ad.jpg)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_011_835d5d8cae6e.gif)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_012_835d5d8cae6e.gif)

**长按二维码｜关注我们**

**IEEE/CAA Journal of Automatica Sinica (JAS)**

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_013_835d5d8cae6e.gif)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_014_835d5d8cae6e.gif)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_015_554ca2ef86a1.jpg)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_016_835d5d8cae6e.gif)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_017_835d5d8cae6e.gif)

**长按二维码｜关注我们**

**《自动化学报》服务号**

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_018_835d5d8cae6e.gif)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_019_835d5d8cae6e.gif)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_020_6724f9e7fd99.jpg)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_021_835d5d8cae6e.gif)

![](基于压缩因子的宽度学习系统的虚拟机性能预测_images/img_022_835d5d8cae6e.gif)
