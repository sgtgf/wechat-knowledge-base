...
![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_000_ae3311934771.png)

![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_001_824e1c6bc98e.png)

![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_002_0497e904e515.png)

![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_003_12316f1d3c33.png)
...
![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_004_654e484cdfa9.png)
...
![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_005_9e2f148af5ef.png)

数值系统RMPILC跟踪曲线

![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_006_bc172dc0ec6b.png)

数值系统传统MPILC跟踪曲线

![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_007_f9ee954b3b25.png)

CSTR系统RMPILC跟踪曲线

![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_008_772d23032669.png)
...
![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_009_439d798634b5.png)

马乐乐, 华北电力大学控制与计算机工程学院博士研究生. 2016年获得华北电力大学自动化专业学士学位. 主要研究方向为预测控制及其应用. 

E-mail: 1172127008@ncepu.edu.cn

![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_010_62604af1a030.png)
...
![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_011_3ad727308b92.png)

![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_012_af0b10fd3b22.jpg)

JAS《自动化学报》（英文版）

![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_013_3ad727308b92.png)

![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_014_6a26923cf097.jpg)

自动化学报服务号

![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_015_3ad727308b92.png)

![](变参考轨迹下的鲁棒迭代学习模型预测控制_images/img_016_860e774b52ac.jpg)
