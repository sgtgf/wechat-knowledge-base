...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_000_991d1630d50a.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_001_5776a23474f5.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_002_f4b2a825b44c.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_003_07c5596c6c77.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_004_995665c2a8ba.png)

本文在LCL 逆变平台设计满足三种控制方式环路稳定的参数并进行实验验证。

1.3 SiC 器件发展现状

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_005_f936d06bf701.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_006_13924de0f4d0.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_007_c207ee27cce1.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_008_a6a73cf9e647.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_009_032ce1412bfc.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_010_51fdc254859c.png)

假设f1 为PWM 控制信号的频率，f2 为高频载波信号频率，理论上最大上升延迟时间和最大下降超前时间为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_011_1af982ca65d2.png)

如果PWM 信号占空比为50%，输出方波的占空比最大丢失程度为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_012_caed5321557b.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_013_07ae679db680.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_014_01446f672641.png)

在传统的去饱和检测短路保护方案中，器件开通后，恒流源Im将消隐电容Cbl充电到设定的阈值电压，充电时间即为消隐时间tbl：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_015_952af403204a.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_016_4461709ec141.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_017_85c0c82894dc.png)

消隐时间设置如图所示，生成的使能信号在高电平时检测故障信号。

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_018_be50644d786b.png)

消隐时间在数值上约为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_019_780415368c46.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_020_3ffea5c84615.png)

根据前文所述调制解调方案框图搭建样机，验证载波频率对延时的影响。表2\. 3 给出主要器件选型，在保证功能的同时也都满足高温需求。

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_021_dc0ee7a2d192.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_022_22792be7bdcb.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_023_74f5d829ab57.png)

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_024_a068bb2a50f9.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_025_c6131db47cfc.png)

2.3.2 短路保护方案论证

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_026_5954ba374dc7.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_027_36ac456f4426.png)

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_028_93f76c222876.png)

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_029_c6114e868f33.png)

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_030_b46e7f972fad.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_031_37406ccb9601.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_032_fb4134cad95b.png)

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_033_fa3a2bf8ff77.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_034_57873ebc9d0b.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_035_b27d39a27f40.png)

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_036_683a9f554d50.png)

调制波Vm 的频率远小于开关频率，所以在一个等效开关周期内认为调制波的幅值恒定， 由SPWM 调制示意图看出，驱动占空比为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_037_a4bd3873b320.png)

进而可以得到从SPWM 调制器输入到H6 逆变桥输出的的传递函数：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_038_d7987be78dd1.png)

3.1.3 H6 桥逆变器共模分析

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_039_9ec07e92f8cc.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_040_99fe8de1f605.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_041_c003eac62516.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_042_98f3c232e366.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_043_d8b2743a71ad.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_044_17e2ec472794.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_045_a3c6a0ef7821.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_046_910712bda84e.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_047_54244f24fbfc.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_048_fa10bdf2274f.png)

3.2.3 滤波电感设计

由于逆变输出被电网电压钳位，输出电压的幅值和频率为固定值，当调制比m 设计在0.8~0.9 范围内时能够最优化逆变器的效率。理想状态幅度调制比为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_049_9c847af94600.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_050_284aac530fef.png)

驱动占空比D(t)作为脉宽瞬时值，满足正弦变化规律。联立可得输出滤波电感的电流脉动：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_051_08cd4b075ad5.png)

波电感电流脉动最大：  

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_052_baa715e6af6a.png)

设计时一般让滤波电感电流纹波不超过输出电流有效值的20%：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_053_2bda6d01ff4a.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_054_0d0190956a2d.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_055_f5eabe8b816a.png)

本方案磁芯窗口利用率为0.487，如果窗口利用率过大需要重新选择磁芯设计。此时每匝线圈长度为80 mm，本文采用双环并绕，还需加上两倍的高度，lave 约为110 mm，计算线圈的总长度和内阻：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_056_ab631d19886a.png)

rwire 为AWG11 线圈的单位长度电阻4.13 mΩ，线圈的计算阻值为27 mΩ，实际测量约为40 mΩ，由此可计算单个电感满载下铜损约为7.348 W。

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_057_3763707c7afa.png)

计算电感的铁损需要计算每个开关周期内变化的磁通密度：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_058_6b3bf5b69697.png)

3.2.4 母线电容设计

母线电容不仅降低直流侧输出电压的纹波，还稳定逆变侧的直流输入电压，减小逆变输出的畸变。设Vo是输出电压有效值，Io是输出电流有效值：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_059_7015b6033b07.png)

功率平衡时，交流等效输出功率和前级直流功率相等，当母线电压处额定直流功率为3 kW， 则交流输出功率和直流功率差为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_060_649dcfa8c8a6.png)

母线电容需要吸收波动的功率，对上式积分，则能量波动和最大波动分别为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_061_fb228a3d7913.png)

上述可得，母线电容上除了直流分量Vdc，还包括一个以二倍频进行脉动的纹波电压，设ηv是直流侧电压的纹波系数，纹波电压为 ηvVdc。

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_062_0a80b89b0481.png)

母线电容需要满足：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_063_4fe605e74dc4.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_064_0dc41f729c68.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_065_1ea8a688afd9.png)

3.3 PCB布局与要点

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_066_adce528da983.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_067_7c5b139761fe.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC_MOSFET_高频驱动及在并网逆变器的应用_images\img_000_aef4e67b9019.png)

Costas PLL 结构图的输入端输出信号分别为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_069_28f70b2d28d7.png)

鉴相器乘以PLL 的输入和输出：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_070_163ed2b945ba.png)

对鉴相器的输出进行低通滤波滤除高频二次谐波分量：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_071_fc26080f96d3.png)

当压控震荡器的频率与输入信号频率一致并成功锁相时：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_072_23a42efb5cb0.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_073_07dcb885e08a.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_074_e91d46e56dd7.png)

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_075_7b7b13421ac3.png)

在环路稳态分析时，把三角运算看成增益为电网电压峰值，延迟为采样周期的环节，本方案中采样频率fs为20 kHz，采样周期Ts 为50 us。根据基于SOGI 的锁相环控制框图可以得到补偿后的开环传递函数：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_076_f9b4d01d3aee.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_077_cd53b822d493.png)

逆变器输出电压等于电感电压和电网电压的和，两个滤波电感感值和Linv为2 mH，两个滤波电感电阻约为80 mΩ，根据控制框图可以列出电感电流的传递函数：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_078_be7ff262a236.png)

环路中Hfb1 为输出电流反馈系数，程序里根据采样过程换算成1。电流环开环传递函数为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_079_a1279d09ffca.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_080_c1f85101aa4b.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_081_581400042378.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_082_f13e5356294b.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_083_4392a2bdad7d.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_084_d86df4273861.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_085_5b0898940d30.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_086_fe4db765d1d5.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_087_8ba765a870b6.png)

4.3.1 PI 控制

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_088_24b4fbcb4ee3.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_089_2ffaac49faa7.png)

列出 PI 控制环节开环传递函数进行稳定性分析：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_090_aee6bea0461a.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_091_7945ca99b62e.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_092_28bd70123b6a.png)

准比例谐振项可以看成带通滤波器，在谐振频率附近增益较高，其他频率处增益近似为0， 准比例谐振牺牲无穷大增益，提高控制器带宽，中心频率fcen和带宽频率fBW 为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_093_2c9dbdfb61be.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_094_c2037faf6af0.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_095_2978c84bb442.png)

重复控制基本环节为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_096_1fe5b4606842.png)

T0 是基波分量的周期时间，利用指数性质分解重复控制可得：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_097_ef80702fbaa4.png)

基于内模原理，理想重复控制器包含基波及其整数倍频率处谐波，能够实现对正弦基准信号的无静差跟踪，鲁棒性强且稳态精度高；从伯德图角度，在基波频率及其整数倍频率处均具有较高增益，能够同时抑制所有次谐波。

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_098_271780d938cf.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_099_2277c70b9fdb.png)

Zeq1Zeq2 为LCL 并网逆变器的Z 域等效模型，ZQPR 为QPR 环节的Z 域等效模型，N 为一个基波周期内的计算频率，则重复控制的Z 域闭环传递函数为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_100_9670a43962c8.png)

根据自动控制理论，离散域特征多项式的根都在单位圆内则系统稳定，但是含有N 阶项的传递函数计算量太大，采用控制理论中小增益原理分析系统稳定的充分条件。由小增益原理可得，当系统特征方程为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_101_c80216a9c46d.png)

系统稳定的充分条件为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_102_14fe1957e884.png)

根据小增益原理将RC 控制的Z 域闭环传递函数转化为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_103_b1a3c0c7ea88.png)

系统稳定需要满足的充分条件为：

(1)、1 ZQPRZeq1Zeq2的根在单位圆内；

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_104_a4b60a83bc4a.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_105_038314616870.png)

损耗的主要组成为二极管损耗、MOSFET 损耗、IGBT 损耗和输出滤波电感损耗。逆变器每个开关周期的调制比：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_106_889297811368.png)

5.1.1 二极管损耗

二极管损耗包括反向恢复损耗Prr\_D 和正向导通损耗Pcon\_D。反向恢复损耗Prr\_D 为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_107_1db001eb2930.png)

Qrr 为APT60DQ60BG 数据手册中的反向恢复电荷50nC。

二极管的导通压降根据数据手册中V-I 曲线拟合得到：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_108_054cc682c793.png)

在与驱动占空比互补的时间段里，滤波电感、电网、辅管和功率二极管构成续流回路，每个开关周期内都有一个功率二极管正向导通，损耗分析中驱动占空比可以用开关周期调制比等效，正向导通损耗Pcon\_D 为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_109_c381b67b9f1d.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_110_ab22633891d9.png)

开通时间ton\_M 近似密勒平台期间对门极电荷充电时间：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_111_02ce28b808b3.png)

同理，关断损耗和关断时间为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_112_fae2f82728e6.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_113_9a0d8367c276.png)

由于IGBT 工频动作，开关损耗较小，损耗分析时只考虑导通损耗，导通压降Vce根据数据 手册中V-I 曲线拟合得到：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_114_5d6ddfdd8b83.png)

IGBT 在整个开关周期持续开通，导通损耗Pcon\_I 为：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_115_92ccd62b9b59.png)

5.1.3 输出滤波电感损耗

输出滤波电感损耗包括铁损PFe 和铜损PCu。由第三章滤波电感设计分析可得：

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_116_d448786b9075.png)

5.1.4 理论损耗分布

![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_117_f5f929ee044b.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_118_39378725781a.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_119_a1f85578c154.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_120_26062e4d50c5.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_121_55a55f015a86.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_122_9684ed079b9a.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_123_809a6c554ee1.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_124_5c99ef10c91d.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_125_f243e4aca61e.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_126_9a0dacb3d8b5.png)
...
![](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_127_c0818990d91d.png)
...
![图片](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_128_6f3582a6655d.jpg)
...
![图片](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_129_3a454be1818c.jpg)

![图片](SiC_MOSFET_高频驱动及在并网逆变器的应用_images/img_130_7038903c64cb.png)