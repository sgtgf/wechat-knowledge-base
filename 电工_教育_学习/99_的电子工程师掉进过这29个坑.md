...
> 原文地址: [https://mp.weixin.qq.com/s/MYIuQ7OzQcLcYxoOrPxS5w](https://mp.weixin.qq.com/s/MYIuQ7OzQcLcYxoOrPxS5w)
...
![](https://mmbiz.qpic.cn/mmbiz_png/2vmCEf4iaGjiaGNQsqe7ice68pYZYLcLnmsCYeB0McOoiaUic5kF34h5GiaZn0qSWWF7tjBLsPH8RBzghVA58afehdfw/640?wx_fmt=png&from=appmsg)
...
正解：其实市场上不存在5K的阻值，最接近的是 4.99K（精度1%），其次是5.1K（精度5%），其成本价格分别比精度为20%的4.7K高4倍和2倍。20%精度的电阻阻值只有1、1.5、2.2、 3.3、4.7、6.8几个种类（含10的整数倍）；相应的，20%精度的电容也一样只有以上几种容值。对于电阻和电容来说，如果选了这几种之外的其它的值，就必须使用更高的精度，成本就翻了几倍，如果对精度的要求并不大，这样做是成本上的浪费。除此之外，电阻质量也非常重要，有时候一批劣质的电阻足以毁掉一个项目，建议大家在立创商城等正品自营商城购买。
...
![](https://mmbiz.qpic.cn/mmbiz_png/2vmCEf4iaGjiaGNQsqe7ice68pYZYLcLnmsPaZAebFDYIT61ljQ6XcVIiamjwm1paljCAUwLNnHkVLWrkSgmplYXtw/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/2vmCEf4iaGjiaGNQsqe7ice68pYZYLcLnmsJT24eymazBiac8pmUx1WaPs1ceDcZ5AlSbroULQpZ1gGEC3Ehv17Z0A/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/2vmCEf4iaGjiaGNQsqe7ice68pYZYLcLnmsvGSqKqYPhxehFv1Ne1UYkg7Z39bicxh3dshtQDMDDEL9W3EyZH285GQ/640?wx_fmt=png&from=appmsg)
...
![](https://mmbiz.qpic.cn/mmbiz_png/2vmCEf4iaGjiaGNQsqe7ice68pYZYLcLnms6NnH5ps01zH0tibMYaWD7kRYQJLaGI34o9to9ZjrchIAVCyvnMKLv9A/640?wx_fmt=png&from=appmsg)
