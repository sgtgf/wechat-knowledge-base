...
**■**[在线](https://ieeexplore.ieee.org/document/10946686)[‍](https://ieeexplore.ieee.org/document/10770095)[阅读](https://ieeexplore.ieee.org/document/10908519)    ****■****[PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10908519)
...
**摘 要**
本文研究了具有对称和非对称拓扑结构的辅助极低速高转矩密度辐条式永磁同步电机（ST-PMSM）的径向电磁力、振动和噪声现象。首先，推导出一种用于快速估算具有对称和非对称拓扑结构辅助极的 ST-PMSM 的径向电磁力（REMF）特性的解析表达式。应用二维傅里叶分解方法研究径向电磁力谐波（REMFHs）。其次，设计了用于电机结构分析的有限元（FE）模型。随后，对不同设计情况下的分析电机进行了 FE 模型和模态分析。最后，采用 FE 方法研究了具有对称和非对称辅助极拓扑结构的电机设计的振动和噪声行为。研究结果表明，非对称辅助极的存在导致了 REMFHs 的丰富度增加，同时 REMF 的基频和最低非零阶次降低。因此，在研究具有不对称辅助极拓扑结构的开关磁阻电机（ST-PMSMs）的振动和噪声响应时，必须充分考虑所引起的非零低阶谐波，并对其进行优化，以获得更好的振动和噪声性能。 
**Abstract**
...
图1 机器原型的设计案例 （a）对称辅助电杆设计案例。（b）非对称辅助杆设计案例。
**作者信息**
**Sayyed Haleem Shah**，出生于巴基斯坦伊斯兰堡。分别于2011年和2015年获得巴基斯坦白沙瓦工程技术大学和巴基斯坦伊斯兰堡航空大学的学士和硕士学位，并于2022年获得天津大学的电气工程博士学位。他目前是浙江大学电气工程系的博士后研究员。他的研究兴趣包括永磁同步电机、低速高扭矩密度电机和模块化电机的设计。
**王云冲(Member, IEEE)**，1987年出生于辽宁。他分别于2010年和2013年在浙江大学获得理学学士和理学硕士学位，并于2017年在香港理工大学获得博士学位，均为电气工程。自2020年以来，他一直担任浙江大学电气工程副教授。他撰写了30多篇技术论文。他的研究兴趣包括永磁电机的设计和控制、电动汽车的新型电动机、混合动力电动汽车和可再生能源转换系统。
**史丹(Member, IEEE)**，1986年出生于洛阳。分别于2009年和2012年获得浙江大学电气工程学士和硕士学位，于2016年获得瑞士洛桑联邦理工学院机器人控制和智能系统博士学位。目前是浙江大学电气工程系的博士后研究员。她的研究兴趣包括高速永磁电机的研究和应用。
**沈建新 (Senior Member, IEEE)** ，1969 年出生于湖州。1991 年和 1994 年分别在西安交通大学获得电气工程专业学士和硕士学位，1997 年在浙江大学获得电气工程博士学位。1997 年至 1999 年在新加坡南洋理工大学工作。1999 年至 2002 年在英国谢菲尔德大学工作。2002 年至 2004 年在英国 IMRA Europe SAS 研究中心工作。自 2004 年起，他一直在浙江大学担任电气工程教授。他已发表 340 多篇技术论文，拥有 50 多项专利。他的主要研究兴趣包括永磁电机和驱动器的拓扑结构、控制和应用以及可再生能源。沈博士曾获得 IEEE 行业应用学会优秀论文奖、16 个国际会议的最佳论文奖，以及 2019 年永磁电机领域的最高奖项——永井奖，以表彰他在高速电机方面的贡献。他是两个 IEEE 学会的杰出讲师，并曾担任三个 IEEE 赞助的国际会议的大会主席。
★
