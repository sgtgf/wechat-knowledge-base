...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_001_6970896248c5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_000_6970896248c5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_002_dcc708e0f406.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_003_8ebe28f2544b.png)

叠 层 母 排 运 用 邻 近 效 应 和 集 肤 效 应 ， 使 得 信号 电 流 和 镜 像 电 流 产 生 的 辐 射 磁 场 相 互 抵 消 ， 电流 回 路 面 积 最 小 ， 以 此 有 效 减 小 杂 散 电 感 。以 图 ４所 示 的 叠 层 母 排 为 例 ， 叠 层 母 排 结 构 尺 寸 ：长 ![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_008_cc0e8750c259.png),宽w， 铜 板 厚 度 t, 间 距 d, 其 等 效 电 感 为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_005_f6b373c9ec50.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_006_d4cba33c03ba.png)

当 只 有一块 长![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_007_cc0e8750c259.png)， 宽w， 铜 板 厚 度 ｔ 的 铜 排 时 ，其 电 感 为L 。比 较 一块 铜 排 和 两 块 铜 排 的 电 感 值 可 以 发 现 ， 由 于 另一个 电 流 方 向 相 反 且 平 行 的 铜 排 的 存 在 ，互 感 作 用 使 得 寄 生 电 感 减 小 。
...
式 （１） 表 明 ， 减 小 铜 排 的 长 度![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_004_cc0e8750c259.png)和两 铜 排 间 距d,增 大 宽 度w可 以 在一定 程 度 上 减小 回 路 分 布 电 感 值 。

**元 器 件 和 连 接 端 子 位 置** 

通 过 调 节 元 器 件 摆放 位 置 和 连 接 端 子 位 置 ， 改 变 电 流 路 径 ， 以 减 少 回 路 面 积 ， 从 而 降 低 寄 生 电 感 值 ， 如 图 ５ 所 示 。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_009_71de8054e578.png)
...
提 取 叠 层 母 排 的 杂 散 电 感 ，通 过 数 值 计 算 可以 得 到 高 压 交 流 模 块 的 叠 层 母 排 杂 散 电 感![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_010_820d53dcece7.png)734nH ， 低 压 直 流 模 块 的 叠 层 母 排 杂 散 电 感![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_011_bfa0ad9a7c71.png)＝175nH。同 时 ， 查 阅 数 据 手 册 可 知CAS300M12BM2型 号 的SiC MOSFET高 频 寄 生 电 感![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_012_4684698cfe9e.png)15nH，一个 二 极 管 高 频 寄 生 电 感![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_013_c209f8827b28.png)， 则 在 高 压交 流 模 块 和 低 压 直 流 模 块 中 ， 如 图 ３ 所 示 换 流 回路 的 杂 散 电 感 分 别 为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_014_e286a9852dac.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_015_3bc2b01e3bfd.png)

图 ６ 中 ，Ta为 环 境 温 度 ，Tｊ（ Ｍ０Ｓ ） 为 SiC MOSFET结 点 温 度 ， Tc 为 功 率 器 件 模 块 外 壳 温 度 ，Ts为 散 热器 表 面 温 度 。![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_016_bd52a27f6f72.png)为 SiC MOSFET的 管 芯 到 外壳 的 热 阻 ， ![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_017_a3251dae58ea.png)为 外 壳 到 散 热 器 的 热 阻 ， 以 上 参 数可 以 通 过 厂 家 数 据 手 册 获 取，![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_018_39ec0bb4ad5c.png)为 散 热 器 到 空气 的 热 阻 ，可 以 由 散 热 器 自 身 传 热 热 阻 以 及 散 热器 与 空 气 之 间 的 传 热 热 阻 相 加 计 算 。由 图 ６ 可 知 ，![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_019_72b5ba5b2759.png)与 串 联 ， 然 后 不 同 桥 臂 热 阻 并 联 后 ， 再与 ![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_020_39ec0bb4ad5c.png)串 联 ， 形 成 完 整 的 功 率 单 元 热 阻 。综 合 考虑 功 率 密 度 、 成 本 等 因 素 后 ，这 里 选 用 强 迫 风 冷 的散 热 方 式 。
...
高 压 交 流 模 块 中 强 迫 风 冷 散 热 器 的 总 热 阻![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_021_0e02986d8f70.png)， 低 压 直 流 模 块 的 散 热 器 总 热 阻![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_022_77b755aee0b3.png)。满 载 时 ，SiC MOSFET的 损 耗 约为150Ｗ ， 根 据 文 献 ［ ６ ］ 提 供 的 公 式 计 算 出 功 率 器件 最 大 容 许 热 阻 为 0.83![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_023_2bf1644d33d2.png)， 说 明 散 热 器 选 型 满足 散 热 需 求 。

在 仿 真 软 件 中 对一个 散 热 器 及 ４ 个SiC 模 块进 行 散 热 计 算 ， 要 求 功 率 器 件 最 大 温 升![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_024_9dbb4ff32ead.png)。为 了 简 化 分 析 ， 忽 略 热 辐 射 散 热 ， 得 到 不 同 入 口 风速 下 功 率 器 件 的 温 升 结 果 ， 如 表 １ 所 示。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_025_e5dabe6b2e2e.png)

可 知 ， 在 风 速 小 于![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_026_bfc447f4fe38.png)时 ， 功 率 器 件 的 最大 温 升 随 风 速 增 大 而 迅 速 下 降 ；风 速 大 于![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_027_7e9fe186f75a.png)时 ， 增 加 风 速 对 温 升 减 小 的 效 果 不 再 明 显 。风 速 为![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_028_7e9fe186f75a.png)时 ， 功 率 器 件 的 最 大 温 升 满 足 散 热 需 求 ，因 此 确 定 流 入 散 热 器 的 风 速 不 小 于![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_029_7e9fe186f75a.png)。图 ７为 散 热 器 和 功 率 器 件 的 温 度 分 布 图 。由 图 ７ 可 以看 出 ， 越 靠 近 风 扇 ， 功 率 器 件 温 度 越 低 ， 最 高 温 度出 现 在 风 冷 出 口 处 的 功 率 器 件 处 。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_030_657f184298b4.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_031_ce64b0f7d869.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_032_0e135d48da1d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_033_318ead5d55de.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信，并备注单位+姓名+研发方向。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_034_3ade3c3d8599.jpg)![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于SiC_MOSFET的储能功率单元设计与实证_images\img_035_84aa944feb13.jpg)