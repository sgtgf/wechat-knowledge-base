...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_000_d7e477b6e50b.jpg)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_001_ab041ef1ec57.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_002_bed166f2efa5.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_003_f7d9383c654b.png)

**2 双有源桥拓扑效率仿真模型的建立**

**2.1 效率仿真模型的建立**

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_004_936c9911a560.png)

搭建 DAB 拓扑仿真模型，如图 2 所示。 考虑到IPW 60R075CP 体二极管续流特性， 仿真时需在MOSFET 的 DS 极间额外并联肖特基二极管作为续流二极管。 规定拓扑工况见表 2。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_005_5cd98efc65c2.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_006_aebd321107b8.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_007_afff6c3e2127.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_008_068fd1bc1d7b.png)

式（3）右边第 1 项表示磁滞损耗成分，第 2 项表示涡流损耗成分， 最后 1 项表示附加损耗成分。传统模型中，一般认为 kh、ke、ka 为常数。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_009_4bd302a1b318.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_010_4de6b9966654.png)

可见随开关频率升高，变压器铁损减小。 法拉第电磁感应定律为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_011_03dea6072339.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_012_fb3041ec998e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_013_d68ef7d3250b.png)

由于输入输出电容的存在，流经输入输出电压源的电流均为直流量，且由于电压源特性和输入输出电容的稳压作用，输入输出两端电压稳定，则定义拓扑效率为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_014_6ac4c48dda00.png)

为输出电流在 1 个周期内有效值；Pin 为输入平均功率；Vin 为输入电压；Iin（AVG,cycle）为输入电流在 1 个周期内平均值。

**2.4 拓扑层面仿真模型验证**

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_015_0d67db59ce1c.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_016_3a4a5949854a.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_017_ff01fd55bd24.png)

由图 8 可见，同一开关频率下，随输出功率上升二者效率差逐渐减小；同一输出功率下，随开关频率上升二者效率差逐渐增大。 下面通过推导应用 2 种不同MOSFET 时拓扑效率表达式来解释该结果。

Si MOSFET 的拓扑效率为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_018_744be7778600.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_019_4e8a23928ef5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_020_223430db4e67.jpg)

**声明：此文来源网络，是出于传递更多信息之目的，文中观点仅供分享交流，不代表本公众号立场。转载请注明出处，若有来源标注错误或如涉及版权等问题，请与我们联系，我们将及时更正、删除，谢谢。**

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_021_7c22e3b9a287.png)![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\采用_SiC_MOSFET_与_Si_MOSFET_的双有源桥效率仿真分析对比_images\img_022_1241954b1b67.png)