...
Jinyang Han1; Hepeng Su1; Weichao Li1; Hao Yuan2
1. Naval University of Engineering, Wuhan, China
2. Southeast University, Nanjing, China
**■**[在线‍阅读](https://ieeexplore.ieee.org/document/10705031)    ****■****[PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10705031)
...
**摘 要**
矢量控制的交流电机驱动采用脉宽调制（PWM）来合成电压源逆变器（VSI）所需的输出电压。在空间矢量脉宽调制（SVPWM）技术中，根据伏秒平衡原理实现的空间矢量平均值会导致瞬时误差电压，从而产生高频转矩纹波。这可能会增加电机振动和噪声。本文提出了一种基于定子磁通纹波的高频转矩纹波预测模型，并设计了一种针对高频转矩纹波的可变开关频率PWM（VSFPWM）策略，以减少高频转矩纹波。根据预测的定子磁通纹波峰值动态调整开关频率，以减轻高频转矩纹波。与现有策略相比，本文所述策略直接抑制高频转矩纹波，因此不受电机参数不准确的影响。此外，由于引入了功率因数角，所提出的策略能够更好地适应电机在整个速度范围内的工作条件。通过详细的仿真和实验验证了该策略的有效性。  
**Abstract**
