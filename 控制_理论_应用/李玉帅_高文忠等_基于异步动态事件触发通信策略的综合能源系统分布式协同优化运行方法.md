...
![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_000_3e7360410077.jpg)

_图1  能源供需不匹配_

  

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_001_577751626ffd.jpg)
...
![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_002_4f98d2e93144.svg)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_003_749fe1ad7e63.jpg)
...
![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_004_c6ff24bd981a.svg)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_005_4f98d2e93144.svg)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_006_202e8b4d59c2.jpg)
...
![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_007_c6ff24bd981a.svg)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_008_4f98d2e93144.svg)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_009_f5e8bf6e2297.jpg)
...
![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_010_c6ff24bd981a.svg)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_011_4f98d2e93144.svg)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_012_82f688ee287b.jpg)
...
![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_013_c6ff24bd981a.svg)
...
![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_014_c08bc334a046.jpg)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_015_752c98713619.jpg)

  

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_016_0b9b071d37fd.gif)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_017_0b9b071d37fd.gif)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_018_00771b73a518.jpg)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_019_0b9b071d37fd.gif)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_020_0b9b071d37fd.gif)

**长按二维码｜关注我们**

**IEEE/CAA Journal of Automatica Sinica (JAS)**

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_021_0b9b071d37fd.gif)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_022_0b9b071d37fd.gif)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_023_b665d5f4da25.jpg)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_024_0b9b071d37fd.gif)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_025_0b9b071d37fd.gif)

**长按二维码｜关注我们**

**《自动化学报》服务号**

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_026_0b9b071d37fd.gif)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_027_0b9b071d37fd.gif)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_028_b09e9cd711ac.jpg)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_029_0b9b071d37fd.gif)

![](李玉帅_高文忠等_基于异步动态事件触发通信策略的综合能源系统分布式协同优化运行方法_images/img_030_0b9b071d37fd.gif)
