# 文章精选 I 山东科技大学张宗盛等：用于轨道运输的模块化内置式铁氧体磁通开关直线电机的设计

原创 CES TEMS编辑部 CES电机与系统学报 2024-11-11 07:00 北京
...
提出了一种用于轨道运输的模块化铁氧体磁通开关直线电机（FMFSLM）的新型拓扑结构，该结构可以使更多的铁氧体磁体插入初级铁芯。该电机在长距离直线驱动中具有显著的低成本优势。介绍了所提出的FMFSLM的结构和工作原理。进一步，建立了电机的推力表达式。研究了触发推力脉动的推力分量，并根据电感的傅里叶级数表达式得到了推力分量的表达式。结果清楚地揭示了推力谐波与自感和互感谐波之间的关系。基于这一关系，采用偏斜的二次面来减小推力脉动是可行的。在此基础上，研究了在FMFSLM中加入偏斜次元的影响，并确定了最佳偏斜跨距。通过有限元分析验证了理论分析的准确性。仿真结果表明，该策略抑制推力脉动的效果显著。同时，电机保持了良好的效率特性。样机实验结果与有限元分析结果吻合较好，进一步验证了所提出的模块化内置FMFSLM的实用性。      
