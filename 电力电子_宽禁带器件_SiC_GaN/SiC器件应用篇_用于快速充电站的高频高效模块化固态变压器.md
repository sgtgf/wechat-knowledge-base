...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_000_8324e49d1811.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_001_5352e6ef6e15.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_002_57e82bc6ba84.png)

Q2 和 Q3 既要在换流完成时间 Δtc 之后开通，但又要早于 Δtz 开通，才能实现 ZVS，因此 ZVS 条件可以表示为不等式约束，即

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_003_0b1bf221866d.png)

分别给出 Δtz 和 Δtc 的推导过程。 以 t1 时刻为新的时间起点，则谐振电流时域表达式为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_004_cf6aaf8629e5.png)

式中：Vo 为输出电压；Ro 为负载电阻；Lm 为励磁电感；fr 和 ωr 分别为谐振频率和角频率；n 为变压器匝比。

经过 Δtz 时间，谐振电流过零，即

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_005_2894349ad1b1.png)

整理后可得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_006_82e3301b647e.png)

对谐振电流式（2）进行积分，可得电荷量表达式为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_007_fa5e57b5a389.png)

在换流时间\[t1～t2\]内，有

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_008_e17836b6c920.png)

利用电荷平衡原则，则电荷为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_009_d6c7e50a8a7d.png)

式中，Ce1 为换流过程中对开关管寄生电容 CjQ 充放电时的等效电容，Ce1\=2CjQ。

将式（6）和式（7）代入式（8），整理得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_010_51a594b40243.png)

由式（3）得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_011_117aa36a87cb.png)

将式（10）代入式（9），整理得

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_012_cf7d3046db09.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_013_ec4ff0b7e6d2.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_014_c09b21c366b4.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_015_0d7b8410c96b.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_016_89ae4a915817.png)

式中：Vset为额定输出电压参考值；Vdci为第i个单元的 DC-link 电压；Vdc\_avg 为所有单元的 DC-link 电压平均值；Kd 为“上翘”斜率系数。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_017_076e469ee477.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_018_b0d3d039607a.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_019_27b961693851.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_020_47057e1ab67a.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_021_5349fb6ef64a.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_022_6b91df568700.png)

图 11 为 SST 系统效率测试结果。 可以看出，满载效率为 98.0%，半载时达到了峰值效率 98.4%，且在较宽的负载区间内效率超过了 98%，实现了高频高效的目标。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_023_ce4f2483e753.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_024_f40ef4aac6c8.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_025_e220c99c7095.png)

注明：此文来源网络，是出于传递更多信息之目的，文中观点仅供分享交流，不代表本公众号立场。转载请注明出处，若有来源标注错误或如涉及版权等问题，请与我们联系，我们将及时更正、删除，谢谢。

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_026_cfac0476b0b1.jpg)
...
![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_027_50dca2bd5690.jpg)

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC器件应用篇_用于快速充电站的高频高效模块化固态变压器_images\img_028_b5c001b861c6.png)