...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_000_9553235032b5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_001_b948e4349eab.png)

本文所设计的 SiC 功率单元包含 10 kV 高压交流模块和 750 V 低压直流模块，两个模块均基于隔离型H桥拓扑，如图2所示，相关参数见表1。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_002_eb6611f25689.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_003_43920efdb3ac.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_004_de50ba562711.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_005_5699955d03be.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_006_9bb8d50c9a51.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_007_6518f4e5b870.png)

**2\. 2　散热设计**

**2. 2. 1　功率器件热损耗分析**

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_008_08125e1da368.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_009_4abf24a0a994.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_010_f8acf75e4903.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_011_d0df7244b858.png)

为满足入口风速≥4 m/s，本文选用两只型号为PMD2406PMB1\-A（2）的风机，其单台风量 Q1 为56. 5 CFM，等效入口风速v为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_012_456436145fcd.png)

式中 S为风机入口的截面积，考虑到模块风机输出风量消纳、不同位置模块进风量不均衡性以及屏柜的密封等问题，屏风机风量Q2需大于模块风机风量总和Q1s。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_013_d00e899cba18.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_014_f6d507b1cdd8.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_015_5225ba45ea28.png)

由上述计算结果可知：k 的取值可满足预期设计要求。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_016_8e729d1a5d54.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_017_34593e779273.png)

高压交流功率单元的对拖实验回路如图 13（a）所示，电容充电电压为 720 V；低压直流功率单元的对拖实验回路如图 13（b）所示，电容充电电压为720 V。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_018_152d01433439.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_019_bbcf76422a50.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_020_d0bbfa1a7ae4.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_021_89dee3d46881.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_022_522df26b85e3.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_023_6e0d5c49a49c.png)

声明：此文来源网络，是出于传递更多信息之目的。若有来源标注错误或侵犯了您的合法权益，请与我们联系，我们将及时更正、删除，谢谢。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_SiC_MOSFET_的储能变流器功率单元关键技术_images\img_024_a070b6585631.png)