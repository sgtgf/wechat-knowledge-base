...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_000_a7be5a250134.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_001_357d0462f919.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_002_b4e19c6769b1.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_003_defbb806e7a5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_004_82680e6d6615.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_005_ca0edadd7fae.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_006_5ace525147bd.png)

单半桥工作模式下其基波等效分析的等效电路如图 10 所示，由 DLLC 工作模式的分析，同理可得出该工作状态下 FHA 归一化电压增益为

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_007_4dc700e3cf4d.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_008_3572ed396a90.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_009_f909d57be80a.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_010_8f29cd8877c6.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_011_896940f4cc88.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_012_ef1723ae97e0.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_013_2e1498255385.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_014_eab3bdd56c28.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_015_ee37b5c14d2a.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_016_84fcee50fae9.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_017_7dcd845db291.png)

图 15 给出了双半桥模式下，λ 取不同值时归一化增益与归一化开关频率的关系曲线，由图 15 可知，归一化增益范围随λ 增加而减少。本实验中取λ \=0.11，谐振电感 Lr=λLm，谐振电容根据式（10）求得。因此，实验样机理论参数见表 1。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_018_8dcb811a9fcd.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_019_c74866845222.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_020_aa2c886e7758.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_021_441a964e08e6.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_022_a3dc25d493d7.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_023_f36e932d7e94.png)

**4实验结果**

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_024_a1e703b52e86.png)

为了验证所提出的基于SiC 器件的隔离双向混合型 LLC 谐振变换器可行性，按照图 2 所示的电路拓扑结构，制作了一台双向运行的 800W 实验样机。具体实验样机参数见表 2。图 16 给出了该双向混合型 LLC 谐振变换器样机。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_025_b85d7f621895.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_026_08c91484849b.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_027_cc8d10b95fc2.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_028_1e9b7fe8edb7.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_029_920e87217c6d.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_030_9e521acca020.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_031_f0d906cf61e8.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_032_2bbd56f46ffb.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_033_ecce5de33065.jpg)

**声明：此文来源网络，是出于传递更多信息之目的，文中观点仅供分享交流，不代表本公众号立场。转载请注明出处，若有来源标注错误或如涉及版权等问题，请与我们联系，我们将及时更正、删除，谢谢。**

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_034_3ade3c3d8599.jpg)![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\南京航空航天大学_基于SiC_器件的隔离双向混合型LLC_谐振变换器_images\img_035_84aa944feb13.jpg)