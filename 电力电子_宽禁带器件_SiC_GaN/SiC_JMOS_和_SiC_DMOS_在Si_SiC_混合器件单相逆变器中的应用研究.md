...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_000_bc130e34310d.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_001_17b38e94b8e6.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_002_59fc7c46d07d.png)

2 种混合器件在门极驱动电压VGS=15V，结温Tj=25℃条件下的正向导通特性如图3 所示。其正向导通特性曲线基本重合，这是由于2 种SiC MOSFET 器件正向导电沟道结构相同，因此正向导通特性相同。

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_003_afa99f33413b.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_004_0cc98c6f282e.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_005_9d808f001754.png)

在开通延时Ton\_delay=0μs，混合器件的开通波形图如图7 所示。当Si/SiC 混合器件开通延时为 零时，混合器件内部两器件同步开通，此时器件具有较高的 di/dt，从而降低了换流时间，减小了开通损耗。

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_006_10f674cd78d7.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_007_1e9a8857390c.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_008_410b7278f5ed.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_009_a257f617b4e3.png)

Si/SiC 混合器件在单相逆变器一个基波周期各阶段的导通损耗分布如图10 所示。

逆变器输出电流可表示为

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_010_295ddf780b72.png)

式中：IF为瞬时电流值；Ipeak为输出电流峰值;θ为电流相角。当调制方式为双极性调制时，正弦波脉宽调制(sinusoidal pulse width modulation，SPWM)占空比可表示为：

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_011_af1020e25cdd.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_012_5bb195f1fdc0.png)

正向导通时，IGBT 开通临界电流为

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_013_d15931662510.png)

式中RDS为SiC MOSFET 的沟道导通电阻。当正向导通电流大于IGBT 开通临界电流Iknee，即θ处于\[σ, π-σ\]区间时，IGBT和SiC MOSFET 共同导通正向电流，其分流情况可表示为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images\img_000_8cf42b807368.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_015_089220a50aac.png)

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_016_7657180e7e9d.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_017_1b29347b9338.png)

反向导通时，SiC MOSFET 体二极管开通临界电流为

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_018_2e3e7164be70.png)

当反向导通电流大于体二极管开通临界电流Iknee\_D ，即θ处于\[π+σD，2π-σD\] 区间时，SiC MOSFET 导电沟道及体二极管共同导通，电流分流。分流情况可表示为：

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_019_68c2596c6dc1.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_020_68694a077ba3.png)

在变换器死区时间内，SiC MOSFET 导电沟道关闭，电流全部从SiC MOSFET 体二极管流过，以Tdead 表示死区时间，其死区内导通损耗功率计算公式可表示为

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_021_e5c5e8fc6881.png)

因此，混合器件工作于单相逆变器中的总导通损耗功率可表示为

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_022_6980200061e6.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_023_82fbe087ee16.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_024_47ab38635316.png)

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_025_6d3bb7cdc217.png)

IGBT零电压关断损耗与关断延时Toff\_delay密切相关，根据双脉冲测试实验数据分析，其典型函数依赖关系如图11所示。IGBT零电压关断过程损耗功率计算公式可表示为

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_026_5650c630f211.png)

式中：τ为函数的指数项系数；Eres为IGBT残余关断损耗，其值可从双脉冲数据拟合得到；Eoff\_hard\_IGBT为IGBT硬关断损耗，其损耗功率计算公式可表示为

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_027_a6e046d6f98d.png)

因此，混合器件工作于单相逆变器中的开关损耗功率可表示为

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_028_f6ec3e47810f.png)

综上，Si/SiC混合器件工作于单相逆变器中的总损耗功率可表示为

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_029_82656818ea1f.png)

2.3 损耗对比分析

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_030_8dc909553d45.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_031_3accf2c0f959.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_032_9e61c1a6e92d.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_033_8ae8a06919ab.png)

图15为4.5kW输出功率下，单相逆变器输出电压波形、电流波形及混合器件驱动信号。输出电压峰值310V，输出电流峰值29A。门极驱动信号延时分别为：开通延时Ton\_delay=0μs关断延时Toff\_delay=1μs。

![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_034_5a3f91509bf3.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_035_e6f5b5c281e9.png)
...
![](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_036_ea825a2113e4.png)
...
![图片](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_037_24def2a8f5ae.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信：18126115420，并备注单位+姓名+研发方向。

![图片](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_038_a7ecee98ead9.png)![图片](SiC_JMOS_和_SiC_DMOS_在Si_SiC_混合器件单相逆变器中的应用研究_images/img_039_9bbc7b9b15a2.png)