...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_000_6215c6926d07.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_001_b7dd4e172055.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_002_2f4e5cade09d.png)

式中：Um 为输出相电压的有效值。在实际应用中由于负载的随机性，系统可能会为单/三相或者不对称的混合负载供电。因此，每相会形成不同的交流电流，假设不平衡负载下三相不平衡电流为

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_003_c2ded9158539.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_004_9e1c22714904.png)

式中：Udc 为直流母线电压的直流分量； u%dc为电压上的交流分量。其交流分量越大分裂电容上电压振荡就会越大。图 3 中根据 KCL 定律可知

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_005_11a9e454d30c.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_006_5f8bcdd0a541.png)

  
因此分裂电容上的电压可表示为

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_007_ebc915753af6.png)

式中：UoC1 与 UoC2 均为分裂电容两端电压的直流分量。根据式(5)与式(6)电容 CN1 与 CN2 的电压振荡值为

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_008_05c0327dd842.png)

因此分裂电容电压的震荡幅值主要受中线电流的大小控制，其也影响到母线电压的震荡幅值。图 2 中根据 KCL 定律有：

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_009_3da3874aa085.png)

因此中线电流为

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_010_dfb626af0f6b.png)

当不使能中线桥臂时，流过中线电感上的电流iLN 可认为是 0。假设分裂电容参数完全相同，则任意时刻分裂电容 CN1 与 CN2 上的电压为

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_011_06b3f7fa6762.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_012_78c667d64c4a.png)

若所有电压均以中点 N 为参考点，则直流母线电压即中点电压平均电压可由式(1)表示。

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_013_31b465f0b476.png)

式中 VDC=V+  V-，Vave 的参考值为 0。同时根据 KCL与 KVL 可知：

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_014_332c30777081.png)

由式(11)与(12)可知：

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_015_6061a929fbb4.png)

在此定义新的电压变量：

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_016_8cc9dce1e2c1.png)

表示由于分裂电容不匹配以及 VDC 的可能变化而带来的扰动。则 ic 可表示为：

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_017_bbe3beb0f08c.png)

若在一个开关周期内定义

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_018_44b9f8fd6a7e.png)

且以 p 来表示 q 的平均值，则开关管 Sn1 的占空比为：

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_019_cd4c7610773d.png)

由于中线桥臂的开关管 Sn1与 Sn2工作在高频开关下，可假设在一个开关周期内 V和 V是恒定的，则 uN 的平均值为：

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_020_439fab54c2a5.png)

其可近似为：

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_021_127fb87a0796.png)

结合式(12)、(16)和(18)，中线桥臂的模型框图如图 4 所示。

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_022_e12482097ba1.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_023_b5e6be696f30.png)

图 5 中电阻 Rv 为虚拟电阻，实际中无电流流过。因此，根据 KCL 与 KVL 可知：

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_024_f7a7026a1ff1.png)

式中 uph 为单相滤波前电压，由式(19)可得其单相输出的模型框图如图 6 所示。

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_025_c49766e8412c.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_026_d0131e7dff78.png)

中线桥臂等效模型如图 7 所示，其中 Cequ=CN1+CN2 为等效电容，Ln 为中线电感，RN 为中线电感的串联等效内阻，其系统传输函数波特图如图 8所示。

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_027_a3b3e70edf3e.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_028_fb64e9937441.png)

2.2.1 电流控制器 Ki 设计

图 9 中，n 是假设 PWM 信号的更新是在 n 个开关周期后、PWM 的零阶保持器延时为 0.5 个开关周期。同时如图 7 所示，由于电阻 Rv 在实际中不存在，无实际电流经过此电阻。由此，电流 iN、iCN 及 iLN 可表示为

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_029_12dc6d3e86e7.png)

为了获取更多的电流信息，电流控制环应尽可能的需要拥有较高的带宽。由图 9 可知其开环电流传输函数如式(21)。

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_030_b5713c6cb515.png)

其相位角可表示为

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_031_280318c547b1.png)

式中：ΦmN 是为保证系统稳定的最小相位裕度；RN为电感的等效内阻，由于其阻值非常小； arctan(LNωCN/RN )可近似为π/2。因此，最大的带宽为

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_032_3fae01ecc1eb.png)

此时相对应的电流环的比例控制参数可表示为下式(24)。

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_033_222351ff7ff3.png)

2.2.2 电压控制器比例系数 Kv 的设计

电压控制器的目的最大可能的抑制中点电压的偏移。由此，需要以获取最大的电压控制环带宽为目的设计响应的电压控制参数。当以电压为控制量时，图 4 可简化为图 10 所示，其传输函数为

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_034_e5fce33dcce1.png)

为增强电流内环对电压控制的效果，内环的带宽通常设计为外环的 5 倍以上。本设计中电压外环的带宽设计为内环的 1/10，即：

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_035_a15c30e2fc80.png)

根据式(21)—(25)同理可知电压控制参数可表示为

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_036_a66db73e4852.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_037_2c0893571fbe.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_038_58af8880b751.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_039_db524210cbdf.png)

逆变器侧：

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_040_96c85557b0ab.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_041_98f631a90478.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_042_8c0c741a479c.png)

根据表 1 所示系统参数，在加入电流环时不同开关频率下中点电压偏移控制效果仿真如图 13 所示。

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_043_49c2268d98f6.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_044_d7c7f2217ce6.png)

由图 14 可知：当不平衡负载发生如不使能中点电压控制时，中点电压会有较大的偏移。其跟随着逆变器输出的交流电压同频率的出现震荡。且此震荡幅值将随着不平衡负载的增大而增大，即：iN越大，中点电压震荡幅值越大。其与式(10)所分析的结果相符合。

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_045_a67df3576ec3.png)

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_046_dafe1317b3ec.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_047_4290a36364e0.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_048_0b1278f0d617.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_049_240e00ec91bf.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_050_853782c64b75.png)

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_051_3f087c6cdbe7.png)

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_052_316575bec95b.png)

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_053_5f619325b218.png)

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_054_dd326d7e0726.png)

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_055_df49fef3e4c7.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_056_79dd469e25f7.png)

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_057_766551ebf956.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_058_1c36bac6c8b1.png)

![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_059_85cbb0c34acb.png)
...
![](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_060_043a25c95656.png)
...
![图片](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_061_6f3582a6655d.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信：18126115420，并备注单位+姓名+研发方向。

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images\img_000_ac96c142a2ce.jpg)

![图片](SiC_MOSFET_与_Si_IGBT_混合开关车载双向充电器中线桥臂设计及控制_images/img_063_7038903c64cb.png)