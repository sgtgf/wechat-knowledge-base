****Harmonics in the Squirrel Cage Induction Motor Analytic Calculation - Part I: Differential Leakage, Attenuation, Asynchronous Parasitic Torques****
G. Kovács
Ganz Electric Works, Budapest, Hungary
**■**[在线阅读](https://ieeexplore.ieee.org/document/10181100)    ****■****[PDF](https://ieeexplore.ieee.org/stamp/stamp.jsp?tp=&arnumber=10181100)
G. Kovács, "Harmonics in the Squirrel Cage Induction Motor Analytic Calculation - Part I: Differential Leakage, Attenuation, Asynchronous Parasitic Torques," in CES Transactions on Electrical Machines and Systems, vol. 7, no. 3, pp. 320-329, September 2023, doi: 10.30941/CESTEMS.2023.00034.
**摘 要**
长期以来，关于笼型异步电机气隙中产生的磁场和产生该磁场的磁动势的谐波，以及与之相关的差动漏电、衰减、异步寄生转矩等问题，文献中都有详细的讨论，但都是分开讨论的。然而，这一现象的系统化仍有待于研究。因此，有必要用一种新的方法，在单一的研究中总结这些现象的完整性，以揭示它们之间的关系。转子槽数的作用比以往强调得多。一个现有的，常用的，但仍然不切实际的基本图形被修改，以更清楚地显示转子对定子谐波的响应。论证了将差动泄漏、异步寄生转矩和衰减一起处理的必要性：推导了异步寄生转矩的新公式；为了给设计人员提供正确的设计指导，将长期以来分别使用的差动泄漏特性曲线和衰减特性曲线合并为一条正确的曲线。 
**Abstract**
