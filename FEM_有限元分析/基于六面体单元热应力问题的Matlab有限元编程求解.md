...
![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_000_17b9131b6739.jpg)
...
![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_001_10c0a8d5c551.gif)
...
![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_002_a9f255c45b9a.png)

**图1 两端固定约束的四棱柱受单位热应变作用下的应力**

假定通过传热分析我们可以得到，相对于原来状态温度升高了![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_003_8b118542886e.png)，对于各向同性材料，温度升高![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_004_41c32a1f42a5.png)会产生一个均匀的应变（通俗地讲，就是热胀冷缩原理，物体会发生膨胀），应变大小与材料的线膨胀系数![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_005_f43fe2bb7cbe.jpg)有关，![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_006_f43fe2bb7cbe.jpg)表示材料在单位温度升高所引起的长度的变化值，一般情况下，在一定范围内可以假定线膨胀系数为常数。若物体能够自由变形，则由温度变化引起的应变不会产生应力。温度应变一般被表示为初应变的形式

![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_007_9731632cba32.png)    （1）

对应的应力-应变关系为

![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_008_8c9c8c33d0f5.png)        （2）

接下来将公式（2）的应力应变关系代入到有限元分析列式中，利用虚功原理进行推导。其中虚应力和虚应变场函数的有限元列式如下式

![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_009_dba91e4f5b90.png)           （3）

将公式（2）利用虚功原理，可得到下述虚功方程

![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_010_c9d6e65c80b1.png)      （4）

将公式（3）代入公式（4）所示的虚功方程中，并对其进行简化处理，可以得到

![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_011_30ca0652bfc8.png)    （5）

因为虚位移存在任意性，因此可以除掉公式（5）中的虚位移，进而得到

![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_012_aeec87d8de5f.png)     （6）

其中Ke为刚度矩阵，表达式为

![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_013_c7fae57bc809.png)       （7）

![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_014_d1e503da9c99.jpg)为单元节点载荷，表达式为

![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_015_6db27a743242.png)      （8）

为等效温度载荷，是由热应力引起的节点处等效温度载荷，表达式为

![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_016_44a271e697da.png)        （9）

因此，对于温度应力问题，核心就是求解等效温度载荷。因为公式中包含了B矩阵，即应变矩阵，对于六面体单元应变矩阵的推导过程如下图所示。

![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_017_457e9f533001.png)
...
![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_018_196c4df7a23e.png)
...
**喜欢****作者******，请点********赞********和在看******![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_022_ccb6b1d5c075.gif)**

**![](基于六面体单元热应力问题的Matlab有限元编程求解_images/img_023_3079cfee603e.gif)**