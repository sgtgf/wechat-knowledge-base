# 3300V的SiC MOSFET的产品优势及应用领域


> 原文地址: [https://mp.weixin.qq.com/s/ry2jXXatZkFt7CbZVSmcDQ](https://mp.weixin.qq.com/s/ry2jXXatZkFt7CbZVSmcDQ)

**‌‌SiC MOSFET器件的优势**

SiC MOSFET器件的优势主要包括低导通损耗、高温下的稳定性、快速开关性能、以及适用于高压和高频应用。‌这些优势使得SiC MOSFET在多个领域中得到广泛应用，包括电动汽车、光伏储能、充电桩、工业电源、新能源汽车等领域。

 ‌低导通损耗和高温稳定性‌：SiC MOSFET与传统的IGBT不同，不存在开启电压，因此在从小电流到大电流的宽电流范围内都能实现低导通损耗。此外，SiC MOSFET在高温下的导通电阻也保持较低，这有助于提高设备的热设计效率，确保设备在高温环境下的稳定运行‌。  

 ‌快速开关性能‌：SiC MOSFET的Turn-on速度与Si IGBT和Si MOSFET相当，但在感性负载开关的情况下，由于其体二极管的快速恢复性能，可以减少Turn-on损耗好几成。这有助于提高设备的效率和可靠性‌。

 ‌适用于高压和高频应用‌：对于高压开关电源应用，SiC MOSFET相比传统硅MOSFET和IGBT具有显著优势。它能够像IGBT一样进行高压开关，同时开关频率等于或高于低压硅MOSFET的开关频率，非常适合高压、高频的应用场景‌。

 ‌广泛应用‌：由于上述优势，SiC MOSFET在电动汽车的牵引逆变器、车载充电器(OBC)和DC-DC转换器等子系统中得到应用，使得电动汽车能够行驶更远的距离并实现快速充电。此外，它还在光伏储能、充电桩、工业电源、新能源汽车等领域中发挥重要作用，提高了这些领域的效率和性能‌。

综上所述，SiC MOSFET通过其独特的物理和电气特性，为多个行业提供了高效、可靠的解决方案，是现代电力电子系统中的关键组件‌。
...
相较于硅基IGBT，爱仕特3300V碳化硅MOSFET可以构建更小型、更轻量、更经济的设计，能够更有效地转换能量，并且支持各种终端应用。
...
SiC MOSFET的应用领域‌主要包括新能源汽车、光伏逆变器、储能电源、轨道交通、牵引变频器和大功率特种电源等领域。
...
采用全碳化硅的逆变器将彻底改变电力传输、可再生能源整合和能源储存。基于传统硅的半导体具有固有的局限性，使其不适用于大规模公用事业应用。然而，通过采用碳化硅，电力电子应用包括静态转换开关、动态电压恢复器、静态无功补偿器、高压直流输电和灵活交流传输系统都变得经济可行。采用碳化硅，中压（MV）逆变器制造商可以在100千瓦到1兆瓦范围内实现> 97.8％的效率，从而使更紧凑的逆变器能够在住宅和工业领域的大规模应用中部署。
