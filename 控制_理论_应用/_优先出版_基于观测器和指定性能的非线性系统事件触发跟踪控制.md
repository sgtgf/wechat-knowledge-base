...
![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_000_fef7e37cf1fc.png)
...
![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_001_a92b115c7919.png)

_图2_  不同方法下的跟踪误差

  

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_002_a488d50e5060.png)
...
![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_000_1730f7a4c156.jpg)
...
![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_004_2101d7bb56ba.jpg)
...
![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_005_df1e7474e4a8.jpg)
...
![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_006_0bfe663a84fe.jpg)
...
![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_007_e72374888c1a.jpg)
...
![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_008_63e77bb7d460.jpg)
...
![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_009_694b58b9da02.png)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_010_cf77270762fc.png)

  

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_011_ef8c3ef2427b.gif)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_012_ef8c3ef2427b.gif)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_013_dee309d98504.jpg)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_014_ef8c3ef2427b.gif)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_015_ef8c3ef2427b.gif)

**长按二维码｜关注我们**

**IEEE/CAA Journal of Automatica Sinica (JAS)**

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_016_ef8c3ef2427b.gif)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_017_ef8c3ef2427b.gif)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_018_da6e17908cb8.jpg)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_019_ef8c3ef2427b.gif)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_020_ef8c3ef2427b.gif)

**长按二维码｜关注我们**

**《自动化学报》服务号**

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_021_ef8c3ef2427b.gif)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_022_ef8c3ef2427b.gif)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_023_059f2e512b97.jpg)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_024_ef8c3ef2427b.gif)

![](_优先出版_基于观测器和指定性能的非线性系统事件触发跟踪控制_images/img_025_ef8c3ef2427b.gif)
