# SiC和GaN器件在三相PFC整流器及PWM逆变器系统中的应用

原创 Johann W. Kolar SiC碳化硅MOS管及功率模块的应用 2025-02-01 11:58 河南

> 原文地址: [https://mp.weixin.qq.com/s/ZKBKXX3o7SCMxZooMsTYaA](https://mp.weixin.qq.com/s/ZKBKXX3o7SCMxZooMsTYaA)
