...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_000_e8ba88c9b012.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_001_6febfe43d64a.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_002_3f097220f0b0.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_003_423a6bacc622.png)

因此，当负载电流 IF 大于 Iknee 时，SiC FET与Si IGBT产生的导通损耗分别表示为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_004_756cabf2fac0.png)

综合上述分析，HY\_F的总导通损耗 Ec\_total 为：

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_005_b98c9b159894.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_006_f354bd25ff34.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_007_2678a2d2300e.png)

式中：IFET和IIGBT——流经SiC MOSFET和 Si IGBT 的负载电流；IF——流经混合器件的负载电流；UF——混合器件的两端压降。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_008_c501d833c9f6.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_009_72b0a8dcda59.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_010_2bc7a998b188.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_011_29261fe0c83e.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_012_bac834d627f9.png)

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_013_cd9d0c8cc91d.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_014_a537f9924cf7.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_015_6cfe34fdf822.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_016_f27aca5bd3d5.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_017_7fe7608a13c9.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_018_f579d89d6088.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_019_17b8d12d89d9.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_020_b65c07a196bd.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_021_c9f66cf5420a.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_022_2814227e9db2.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_023_a38d293db114.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_024_4e5c6dc1636b.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_025_b4b5702018e8.png)

两种混合器件HY\_F 与 HY\_M 在开关频率 20 kHz、占空比 0.5 以及额定电流40A条件下的总损耗对比分析如表 4所示。可知，HY\_F 的总损耗低于HY\_M，与 3节仿真结论一致，验证了仿真结论的正确性。

![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_026_4b96a531b009.png)
...
![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_027_24def2a8f5ae.jpg)

    专注碳化硅器件的研发与应用。分享碳化硅器件的设计@研发@应用等行业资料。

  加交流微信群，请添加个人微信：18126115420，并备注单位+姓名+研发方向。

![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_028_a7ecee98ead9.png)![图片](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\基于_Si_IGBT与_SiC_MOSFET并联的新型混合器件特性解析及对比研究_images\img_029_9bbc7b9b15a2.png)