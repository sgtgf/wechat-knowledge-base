...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_000_d85df0cef683.png)
...
![](D:\电脑文件\公众号知识库\电力电子_宽禁带器件_SiC_GaN\SiC_MOSFET驱动特性及器件国产化后的影响分析_images\img_000_7ea7387fa51c.png)
...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_002_9d153e3bb4ed.png)
...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_003_3db8564191a8.png)

![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_004_66f37c54ee3e.png)
...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_005_5aeae8002fbe.png)
...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_006_9d55b3bac4e6.png)

实验得到的双脉冲波形如图 3 所示。

![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_007_37c341d41ae1.png)

![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_008_c21dd471abc5.png)
...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_009_3a5fcbc1c2e3.png)
...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_010_99c1beb96f7f.png)
...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_011_d6c0b352cc43.png)

由表 1 进口功率管和 4 种典型国产功率管的输入电容参数对比可以看出，4 种典型国产 SiC MOSFET 器件的输入电容 Ciss 均大于进口 SiC MOSFET 器件，由此可见国产 SiC MOSFET 器件导通所需时间较长。

![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_012_2553b17e1b11.png)
...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_013_3587fa15d367.png)
...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_014_c62b77b37e71.png)

![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_015_e8205617f6b3.png)
...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_016_698fbdd03218.png)

由式（11）可知，当 Qg 增大后，在相同驱动电压Vdri 和开关频率 fsmax 下，驱动损耗增大 1 倍。

![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_017_cfd2d275f7c8.png)
...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_018_3175f2d723d3.png)
...
![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_019_ecce5de33065.jpg)

**声明：此文来源网络，是出于传递更多信息之目的，文中观点仅供分享交流，不代表本公众号立场。转载请注明出处，若有来源标注错误或如涉及版权等问题，请与我们联系，我们将及时更正、删除，谢谢。**

![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_020_3ade3c3d8599.jpg)![](SiC_MOSFET驱动特性及器件国产化后的影响分析_images/img_021_84aa944feb13.jpg)